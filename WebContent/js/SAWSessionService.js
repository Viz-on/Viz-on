...
//
function SAWSOAP_TemplateInfoInstance_getInstanceName() {
	return this._instanceName;
}

SAWSOAP_TemplateInfoInstance.prototype.getInstanceName = SAWSOAP_TemplateInfoInstance_getInstanceName;

function SAWSOAP_TemplateInfoInstance_setInstanceName(value) {
...
//
function SAWSOAP_TemplateInfoInstance_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._nameValues != null) {
			for (var ax = 0; ax < this._nameValues.length; ax++) {
				if (this._nameValues[ax] == null) {
					...
					xml = xml
							+ this._nameValues[ax].serialize(cxfjsutils,
									'jns0:nameValues', null);
				}
			}
		}
	}
...
function SAWSOAP_TemplateInfoInstance_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'nameValues')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
			if (!cxfjsutils.isElementNil(curElement)) {
				arrayItem = SAWSOAP_NameValuePair_deserialize(cxfjsutils,
						curElement);
			}
			item.push(arrayItem);
			curElement = cxfjsutils.getNextElementSibling(curElement);
...
//
function SAWSOAP_TemplateInfo_getTemplateForEach() {
	return this._templateForEach;
}

SAWSOAP_TemplateInfo.prototype.getTemplateForEach = SAWSOAP_TemplateInfo_getTemplateForEach;

function SAWSOAP_TemplateInfo_setTemplateForEach(value) {
	this._templateForEach = value;
}
...
//
function SAWSOAP_TemplateInfo_getInstance() {
	return this._instance;
}

SAWSOAP_TemplateInfo.prototype.getInstance = SAWSOAP_TemplateInfo_getInstance;

function SAWSOAP_TemplateInfo_setInstance(value) {
...
//
function SAWSOAP_TemplateInfo_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._instance != null) {
			for (var ax = 0; ax < this._instance.length; ax++) {
				if (this._instance[ax] == null) {
					...
					xml = xml
							+ this._instance[ax].serialize(cxfjsutils,
									'jns0:instance', null);
				}
			}
		}
...
function SAWSOAP_TemplateInfo_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'instance')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
			if (!cxfjsutils.isElementNil(curElement)) {
				arrayItem = SAWSOAP_TemplateInfoInstance_deserialize(
...
// {urn://oracle.bi.webservices/v6}SessionEnvironment
//
...
//
function SAWSOAP_SessionEnvironment_getUserName() {
	return this._userName;
}

SAWSOAP_SessionEnvironment.prototype.getUserName = SAWSOAP_SessionEnvironment_getUserName;

function SAWSOAP_SessionEnvironment_setUserName(value) {
...
//
function SAWSOAP_SessionEnvironment_getHomeDirectory() {
	return this._homeDirectory;
}

SAWSOAP_SessionEnvironment.prototype.getHomeDirectory = SAWSOAP_SessionEnvironment_getHomeDirectory;

function SAWSOAP_SessionEnvironment_setHomeDirectory(value) {
...
// SAWSOAP_SessionEnvironment.prototype.setSharedDirectories
//
function SAWSOAP_SessionEnvironment_getSharedDirectories() {
	return this._sharedDirectories;
}

SAWSOAP_SessionEnvironment.prototype.getSharedDirectories = SAWSOAP_SessionEnvironment_getSharedDirectories;

function SAWSOAP_SessionEnvironment_setSharedDirectories(value) {
	this._sharedDirectories = value;
}
...
//
function SAWSOAP_SessionEnvironment_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
	...
	{
		xml = xml
				+ this._homeDirectory.serialize(cxfjsutils,
						'jns0:homeDirectory', null);
	}
	// block for local variables
	{
		if (this._sharedDirectories != null) {
			for (var ax = 0; ax < this._sharedDirectories.length; ax++) {
				if (this._sharedDirectories[ax] == null) {
					...
					xml = xml
							+ this._sharedDirectories[ax].serialize(cxfjsutils,
									'jns0:sharedDirectories', null);
				}
			}
		}
	}
...
function SAWSOAP_SessionEnvironment_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'sharedDirectories')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}UpdateACLParams
//
...
//
function SAWSOAP_UpdateACLParams_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}NameValueArrayPair
//
...
//
function SAWSOAP_NameValueArrayPair_getName() {
	return this._name;
}

SAWSOAP_NameValueArrayPair.prototype.getName = SAWSOAP_NameValueArrayPair_getName;

function SAWSOAP_NameValueArrayPair_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_NameValueArrayPair_getValues() {
	return this._values;
}

SAWSOAP_NameValueArrayPair.prototype.getValues = SAWSOAP_NameValueArrayPair_getValues;

function SAWSOAP_NameValueArrayPair_setValues(value) {
	this._values = value;
}
...
//
function SAWSOAP_NameValueArrayPair_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
function SAWSOAP_NameValueArrayPair_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'values')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_Privilege_getName() {
	return this._name;
}

SAWSOAP_Privilege.prototype.getName = SAWSOAP_Privilege_getName;

function SAWSOAP_Privilege_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_Privilege_getDescription() {
	return this._description;
}

SAWSOAP_Privilege.prototype.getDescription = SAWSOAP_Privilege_getDescription;

function SAWSOAP_Privilege_setDescription(value) {
...
//
function SAWSOAP_SATable_getName() {
	return this._name;
}

SAWSOAP_SATable.prototype.getName = SAWSOAP_SATable_getName;

function SAWSOAP_SATable_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_SATable_getDisplayName() {
	return this._displayName;
}

SAWSOAP_SATable.prototype.getDisplayName = SAWSOAP_SATable_getDisplayName;

function SAWSOAP_SATable_setDisplayName(value) {
...
//
function SAWSOAP_SATable_getDescription() {
	return this._description;
}

SAWSOAP_SATable.prototype.getDescription = SAWSOAP_SATable_getDescription;

function SAWSOAP_SATable_setDescription(value) {
	this._description = value;
}
...
//
function SAWSOAP_SATable_getColumns() {
	return this._columns;
}

SAWSOAP_SATable.prototype.getColumns = SAWSOAP_SATable_getColumns;

function SAWSOAP_SATable_setColumns(value) {
	this._columns = value;
}
		...
		if (this._columns != null) {
			for (var ax = 0; ax < this._columns.length; ax++) {
				if (this._columns[ax] == null) {
					...
					xml = xml
							+ this._columns[ax].serialize(cxfjsutils,
									'jns0:columns', null);
				}
			}
		}
...
function SAWSOAP_SATable_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'columns')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_NameValuePair_getName() {
	return this._name;
}

SAWSOAP_NameValuePair.prototype.getName = SAWSOAP_NameValuePair_getName;

function SAWSOAP_NameValuePair_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_NameValuePair_getValue() {
	return this._value;
}

SAWSOAP_NameValuePair.prototype.getValue = SAWSOAP_NameValuePair_getValue;

function SAWSOAP_NameValuePair_setValue(value) {
	this._value = value;
}
...
//
function SAWSOAP_NameValuePair_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}AccessControlToken
//
...
//
function SAWSOAP_AccessControlToken_getAccount() {
	return this._account;
}

SAWSOAP_AccessControlToken.prototype.getAccount = SAWSOAP_AccessControlToken_getAccount;

function SAWSOAP_AccessControlToken_setAccount(value) {
	this._account = value;
}
...
//
function SAWSOAP_AccessControlToken_getPermissionMask() {
	return this._permissionMask;
}

SAWSOAP_AccessControlToken.prototype.getPermissionMask = SAWSOAP_AccessControlToken_getPermissionMask;

function SAWSOAP_AccessControlToken_setPermissionMask(value) {
	this._permissionMask = value;
}
...
//
function SAWSOAP_AccessControlToken_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
// {urn://oracle.bi.webservices/v6}XMLQueryOutputFormat
//
// - SAWRowsetData
// - SAWRowsetSchema
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}XMLQueryExecutionOptions
//
...
//
function SAWSOAP_XMLQueryExecutionOptions_getAsync() {
	return this._async;
}

SAWSOAP_XMLQueryExecutionOptions.prototype.getAsync = SAWSOAP_XMLQueryExecutionOptions_getAsync;

function SAWSOAP_XMLQueryExecutionOptions_setAsync(value) {
	this._async = value;
}
...
// setter function is is
// SAWSOAP_XMLQueryExecutionOptions.prototype.setMaxRowsPerPage
//
function SAWSOAP_XMLQueryExecutionOptions_getMaxRowsPerPage() {
...
function SAWSOAP_XMLQueryExecutionOptions_setMaxRowsPerPage(value) {
	this._maxRowsPerPage = value;
}
...
//
function SAWSOAP_XMLQueryExecutionOptions_getRefresh() {
	return this._refresh;
}

SAWSOAP_XMLQueryExecutionOptions.prototype.getRefresh = SAWSOAP_XMLQueryExecutionOptions_getRefresh;

function SAWSOAP_XMLQueryExecutionOptions_setRefresh(value) {
	this._refresh = value;
}
...
// setter function is is
// SAWSOAP_XMLQueryExecutionOptions.prototype.setPresentationInfo
//
function SAWSOAP_XMLQueryExecutionOptions_getPresentationInfo() {
...
function SAWSOAP_XMLQueryExecutionOptions_setPresentationInfo(value) {
	this._presentationInfo = value;
}
...
//
function SAWSOAP_XMLQueryExecutionOptions_getType() {
	return this._type;
}

SAWSOAP_XMLQueryExecutionOptions.prototype.getType = SAWSOAP_XMLQueryExecutionOptions_getType;

function SAWSOAP_XMLQueryExecutionOptions_setType(value) {
	this._type = value;
}
...
//
function SAWSOAP_XMLQueryExecutionOptions_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}GetSubItemsParams
//
...
//
function SAWSOAP_GetSubItemsParams_getFilter() {
	return this._filter;
}

SAWSOAP_GetSubItemsParams.prototype.getFilter = SAWSOAP_GetSubItemsParams_getFilter;

function SAWSOAP_GetSubItemsParams_setFilter(value) {
	this._filter = value;
}
...
//
function SAWSOAP_GetSubItemsParams_getIncludeACL() {
	return this._includeACL;
}

SAWSOAP_GetSubItemsParams.prototype.getIncludeACL = SAWSOAP_GetSubItemsParams_getIncludeACL;

function SAWSOAP_GetSubItemsParams_setIncludeACL(value) {
...
//
function SAWSOAP_GetSubItemsParams_getWithPermission() {
	return this._withPermission;
}

SAWSOAP_GetSubItemsParams.prototype.getWithPermission = SAWSOAP_GetSubItemsParams_getWithPermission;

function SAWSOAP_GetSubItemsParams_setWithPermission(value) {
	this._withPermission = value;
}
...
// setter function is is
// SAWSOAP_GetSubItemsParams.prototype.setWithPermissionMask
//
function SAWSOAP_GetSubItemsParams_getWithPermissionMask() {
	return this._withPermissionMask;
}

SAWSOAP_GetSubItemsParams.prototype.getWithPermissionMask = SAWSOAP_GetSubItemsParams_getWithPermissionMask;

function SAWSOAP_GetSubItemsParams_setWithPermissionMask(value) {
	this._withPermissionMask = value;
}
...
//
function SAWSOAP_GetSubItemsParams_getWithAttributes() {
...
function SAWSOAP_GetSubItemsParams_setWithAttributes(value) {
...
// setter function is is
// SAWSOAP_GetSubItemsParams.prototype.setWithAttributesMask
//
function SAWSOAP_GetSubItemsParams_getWithAttributesMask() {
	return this._withAttributesMask;
}

SAWSOAP_GetSubItemsParams.prototype.getWithAttributesMask = SAWSOAP_GetSubItemsParams_getWithAttributesMask;

function SAWSOAP_GetSubItemsParams_setWithAttributesMask(value) {
	this._withAttributesMask = value;
}
...
//
function SAWSOAP_GetSubItemsParams_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_SAWException_getMessage() {
	return this._message;
}

SAWSOAP_SAWException.prototype.getMessage = SAWSOAP_SAWException_getMessage;

function SAWSOAP_SAWException_setMessage(value) {
	this._message = value;
}
...
//
function SAWSOAP_SAWException_getException() {
	return this._exception;
}

SAWSOAP_SAWException.prototype.getException = SAWSOAP_SAWException_getException;

function SAWSOAP_SAWException_setException(value) {
...
//
function SAWSOAP_SAWException_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._exception != null) {
			for (var ax = 0; ax < this._exception.length; ax++) {
				if (this._exception[ax] == null) {
					...
					xml = xml
							+ this._exception[ax].serialize(cxfjsutils,
									'jns0:exception', null);
				}
			}
		}
...
function SAWSOAP_SAWException_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'exception')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
			if (!cxfjsutils.isElementNil(curElement)) {
				arrayItem = SAWSOAP_SAWException_deserialize(cxfjsutils,
						curElement);
			}
			item.push(arrayItem);
			curElement = cxfjsutils.getNextElementSibling(curElement);
...
//
function SAWSOAP_ACL_getDummy() {
	return this._dummy;
}

SAWSOAP_ACL.prototype.getDummy = SAWSOAP_ACL_getDummy;

function SAWSOAP_ACL_setDummy(value) {
	this._dummy = value;
}
...
//
function SAWSOAP_ACL_getAccessControlTokens() {
	return this._accessControlTokens;
}

SAWSOAP_ACL.prototype.getAccessControlTokens = SAWSOAP_ACL_getAccessControlTokens;

function SAWSOAP_ACL_setAccessControlTokens(value) {
	this._accessControlTokens = value;
}
		...
		if (this._accessControlTokens != null) {
			for (var ax = 0; ax < this._accessControlTokens.length; ax++) {
				if (this._accessControlTokens[ax] == null) {
					...
					xml = xml
							+ this._accessControlTokens[ax].serialize(
									cxfjsutils, 'jns0:accessControlTokens',
									null);
				}
			}
		}
...
function SAWSOAP_ACL_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'dummy')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'accessControlTokens')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
			if (!cxfjsutils.isElementNil(curElement)) {
				arrayItem = SAWSOAP_AccessControlToken_deserialize(cxfjsutils,
						curElement);
			}
			item.push(arrayItem);
			curElement = cxfjsutils.getNextElementSibling(curElement);
...
//
function SAWSOAP_ReportParams_getFilterExpressions() {
	return this._filterExpressions;
}

SAWSOAP_ReportParams.prototype.getFilterExpressions = SAWSOAP_ReportParams_getFilterExpressions;

function SAWSOAP_ReportParams_setFilterExpressions(value) {
...
//
function SAWSOAP_ReportParams_getVariables() {
	return this._variables;
}

SAWSOAP_ReportParams.prototype.getVariables = SAWSOAP_ReportParams_getVariables;

function SAWSOAP_ReportParams_setVariables(value) {
...
//
function SAWSOAP_ReportParams_getNameValues() {
	return this._nameValues;
}

SAWSOAP_ReportParams.prototype.getNameValues = SAWSOAP_ReportParams_getNameValues;

function SAWSOAP_ReportParams_setNameValues(value) {
	this._nameValues = value;
}
...
//
function SAWSOAP_ReportParams_getTemplateInfos() {
	return this._templateInfos;
}

SAWSOAP_ReportParams.prototype.getTemplateInfos = SAWSOAP_ReportParams_getTemplateInfos;

function SAWSOAP_ReportParams_setTemplateInfos(value) {
	this._templateInfos = value;
}
...
//
function SAWSOAP_ReportParams_getViewName() {
	return this._viewName;
}

SAWSOAP_ReportParams.prototype.getViewName = SAWSOAP_ReportParams_getViewName;

function SAWSOAP_ReportParams_setViewName(value) {
...
//
function SAWSOAP_ReportParams_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._filterExpressions != null) {
			for (var ax = 0; ax < this._filterExpressions.length; ax++) {
				if (this._filterExpressions[ax] == null) {
					...
					xml = xml
							+ cxfjsutils
									.escapeXmlEntities(this._filterExpressions[ax]);
					xml = xml + '</jns0:filterExpressions>';
				}
			}
		}
		...
		if (this._variables != null) {
			for (var ax = 0; ax < this._variables.length; ax++) {
				if (this._variables[ax] == null) {
					...
					xml = xml
							+ this._variables[ax].serialize(cxfjsutils,
									'jns0:variables', null);
				}
			}
		}
		...
		if (this._templateInfos != null) {
			for (var ax = 0; ax < this._templateInfos.length; ax++) {
				if (this._templateInfos[ax] == null) {
					...
					xml = xml
							+ this._templateInfos[ax].serialize(cxfjsutils,
									'jns0:templateInfos', null);
				}
			}
		}
	}
...
function SAWSOAP_ReportParams_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'filterExpressions')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'variables')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'templateInfos')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
			if (!cxfjsutils.isElementNil(curElement)) {
				arrayItem = SAWSOAP_TemplateInfo_deserialize(cxfjsutils,
						curElement);
			}
			item.push(arrayItem);
			curElement = cxfjsutils.getNextElementSibling(curElement);
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'viewName')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
...
//
function SAWSOAP_QueryResults_getRowset() {
	return this._rowset;
}

SAWSOAP_QueryResults.prototype.getRowset = SAWSOAP_QueryResults_getRowset;

function SAWSOAP_QueryResults_setRowset(value) {
	this._rowset = value;
}
...
//
function SAWSOAP_QueryResults_getQueryID() {
	return this._queryID;
}

SAWSOAP_QueryResults.prototype.getQueryID = SAWSOAP_QueryResults_getQueryID;

function SAWSOAP_QueryResults_setQueryID(value) {
	this._queryID = value;
}
...
//
function SAWSOAP_QueryResults_getFinished() {
	return this._finished;
}

SAWSOAP_QueryResults.prototype.getFinished = SAWSOAP_QueryResults_getFinished;

function SAWSOAP_QueryResults_setFinished(value) {
...
//
function SAWSOAP_QueryResults_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_JobStats_getJobID() {
	return this._jobID;
}

SAWSOAP_JobStats.prototype.getJobID = SAWSOAP_JobStats_getJobID;

function SAWSOAP_JobStats_setJobID(value) {
	this._jobID = value;
}
...
//
function SAWSOAP_JobStats_getJobType() {
	return this._jobType;
}

SAWSOAP_JobStats.prototype.getJobType = SAWSOAP_JobStats_getJobType;

function SAWSOAP_JobStats_setJobType(value) {
	this._jobType = value;
}
...
//
function SAWSOAP_JobStats_getJobTotalMilliSec() {
	return this._jobTotalMilliSec;
}

SAWSOAP_JobStats.prototype.getJobTotalMilliSec = SAWSOAP_JobStats_getJobTotalMilliSec;

function SAWSOAP_JobStats_setJobTotalMilliSec(value) {
	this._jobTotalMilliSec = value;
}
...
//
function SAWSOAP_JobStats_getJobStartedTime() {
	return this._jobStartedTime;
}

SAWSOAP_JobStats.prototype.getJobStartedTime = SAWSOAP_JobStats_getJobStartedTime;

function SAWSOAP_JobStats_setJobStartedTime(value) {
	this._jobStartedTime = value;
}
...
//
function SAWSOAP_JobStats_getJobFinishedTime() {
	return this._jobFinishedTime;
}

SAWSOAP_JobStats.prototype.getJobFinishedTime = SAWSOAP_JobStats_getJobFinishedTime;

function SAWSOAP_JobStats_setJobFinishedTime(value) {
	this._jobFinishedTime = value;
}
...
//
function SAWSOAP_JobStats_getJobIsCancelling() {
	return this._jobIsCancelling;
}

SAWSOAP_JobStats.prototype.getJobIsCancelling = SAWSOAP_JobStats_getJobIsCancelling;

function SAWSOAP_JobStats_setJobIsCancelling(value) {
	this._jobIsCancelling = value;
}
...
//
function SAWSOAP_JobStats_getException() {
	return this._exception;
}

SAWSOAP_JobStats.prototype.getException = SAWSOAP_JobStats_getException;

function SAWSOAP_JobStats_setException(value) {
	this._exception = value;
}
...
function SAWSOAP_JobStats_serialize(cxfjsutils, elementName, extraNamespaces) {
	...
	// block for local variables
	{
		if (this._exception != null) {
			xml = xml
					+ this._exception.serialize(cxfjsutils, 'jns0:exception',
							null);
		}
	}
	if (elementName !== null) {
...
function SAWSOAP_JobStats_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'jobFinishedTime')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}GetSubItemsFilter
//
...
//
function SAWSOAP_GetSubItemsFilter_getItemInfoFilters() {
	return this._itemInfoFilters;
}

SAWSOAP_GetSubItemsFilter.prototype.getItemInfoFilters = SAWSOAP_GetSubItemsFilter_getItemInfoFilters;

function SAWSOAP_GetSubItemsFilter_setItemInfoFilters(value) {
	this._itemInfoFilters = value;
}
...
//
function SAWSOAP_GetSubItemsFilter_getDummy() {
	return this._dummy;
}

SAWSOAP_GetSubItemsFilter.prototype.getDummy = SAWSOAP_GetSubItemsFilter_getDummy;

function SAWSOAP_GetSubItemsFilter_setDummy(value) {
	this._dummy = value;
}
...
//
function SAWSOAP_GetSubItemsFilter_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._itemInfoFilters != null) {
			for (var ax = 0; ax < this._itemInfoFilters.length; ax++) {
				if (this._itemInfoFilters[ax] == null) {
					...
					xml = xml
							+ this._itemInfoFilters[ax].serialize(cxfjsutils,
									'jns0:itemInfoFilters', null);
				}
			}
		}
	}
...
function SAWSOAP_GetSubItemsFilter_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'itemInfoFilters')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_PathMap_getPathMapEntries() {
	return this._pathMapEntries;
}

SAWSOAP_PathMap.prototype.getPathMapEntries = SAWSOAP_PathMap_getPathMapEntries;

function SAWSOAP_PathMap_setPathMapEntries(value) {
	this._pathMapEntries = value;
}
		...
		if (this._pathMapEntries != null) {
			for (var ax = 0; ax < this._pathMapEntries.length; ax++) {
				if (this._pathMapEntries[ax] == null) {
					...
					xml = xml
							+ this._pathMapEntries[ax].serialize(cxfjsutils,
									'jns0:pathMapEntries', null);
				}
			}
		}
	}
...
function SAWSOAP_PathMap_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'pathMapEntries')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
			if (!cxfjsutils.isElementNil(curElement)) {
				arrayItem = SAWSOAP_PathMapEntry_deserialize(cxfjsutils,
						curElement);
			}
			item.push(arrayItem);
			curElement = cxfjsutils.getNextElementSibling(curElement);
...
//
function SAWSOAP_SAColumn_getName() {
	return this._name;
}

SAWSOAP_SAColumn.prototype.getName = SAWSOAP_SAColumn_getName;

function SAWSOAP_SAColumn_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_SAColumn_getDisplayName() {
	return this._displayName;
}

SAWSOAP_SAColumn.prototype.getDisplayName = SAWSOAP_SAColumn_getDisplayName;

function SAWSOAP_SAColumn_setDisplayName(value) {
	this._displayName = value;
}
...
//
function SAWSOAP_SAColumn_getDescription() {
	return this._description;
}

SAWSOAP_SAColumn.prototype.getDescription = SAWSOAP_SAColumn_getDescription;

function SAWSOAP_SAColumn_setDescription(value) {
	this._description = value;
}
...
//
function SAWSOAP_SAColumn_getNullable() {
	return this._nullable;
}

SAWSOAP_SAColumn.prototype.getNullable = SAWSOAP_SAColumn_getNullable;

function SAWSOAP_SAColumn_setNullable(value) {
...
//
function SAWSOAP_SAColumn_getDataType() {
	return this._dataType;
}

SAWSOAP_SAColumn.prototype.getDataType = SAWSOAP_SAColumn_getDataType;

function SAWSOAP_SAColumn_setDataType(value) {
...
//
function SAWSOAP_SAColumn_getAggregatable() {
	return this._aggregatable;
}

SAWSOAP_SAColumn.prototype.getAggregatable = SAWSOAP_SAColumn_getAggregatable;

function SAWSOAP_SAColumn_setAggregatable(value) {
	this._aggregatable = value;
}
...
//
function SAWSOAP_SAColumn_getAggrRule() {
	return this._aggrRule;
}

SAWSOAP_SAColumn.prototype.getAggrRule = SAWSOAP_SAColumn_getAggrRule;

function SAWSOAP_SAColumn_setAggrRule(value) {
	this._aggrRule = value;
}
...
//
function SAWSOAP_TreeNodePath_getTreeNode() {
	return this._treeNode;
}

SAWSOAP_TreeNodePath.prototype.getTreeNode = SAWSOAP_TreeNodePath_getTreeNode;

function SAWSOAP_TreeNodePath_setTreeNode(value) {
...
//
function SAWSOAP_TreeNodePath_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_Variable_getName() {
	return this._name;
}

SAWSOAP_Variable.prototype.getName = SAWSOAP_Variable_getName;

function SAWSOAP_Variable_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_Variable_getValue() {
	return this._value;
}

SAWSOAP_Variable.prototype.getValue = SAWSOAP_Variable_getValue;

function SAWSOAP_Variable_setValue(value) {
	this._value = value;
}
		...
		if (this._value == null) {
			...
			if (anyHolder != null) {
				...
				if (anyHolder.xsiType) {
					var typePrefix = 'cxfjst24';
					var typeAttr = 'xmlns:' + typePrefix + '=\''
							+ anyHolder.namespaceURI + '\'';
					typeAttr = typeAttr + ' xsi:type=\'' + typePrefix + ':'
							+ anyHolder.localName + '\'';
				}
				if (anySerializer) {
					xml = xml
							+ this._value.serialize(cxfjsutils, 'jns0:value',
									typeAttr);
				} else {
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}SegmentationOptions
//
...
// setter function is is
// SAWSOAP_SegmentationOptions.prototype.setRemoveCacheHits
//
function SAWSOAP_SegmentationOptions_getRemoveCacheHits() {
	return this._removeCacheHits;
}

SAWSOAP_SegmentationOptions.prototype.getRemoveCacheHits = SAWSOAP_SegmentationOptions_getRemoveCacheHits;

function SAWSOAP_SegmentationOptions_setRemoveCacheHits(value) {
	this._removeCacheHits = value;
}
...
//
function SAWSOAP_SegmentationOptions_getCountOverride() {
...
function SAWSOAP_SegmentationOptions_setCountOverride(value) {
...
//
function SAWSOAP_SegmentationOptions_getCacheOverride() {
...
function SAWSOAP_SegmentationOptions_setCacheOverride(value) {
...
//
function SAWSOAP_SegmentationOptions_getSamplingFactor() {
...
function SAWSOAP_SegmentationOptions_setSamplingFactor(value) {
	this._samplingFactor = value;
}
...
//
function SAWSOAP_SegmentationOptions_getGovRules() {
	return this._govRules;
}

SAWSOAP_SegmentationOptions.prototype.getGovRules = SAWSOAP_SegmentationOptions_getGovRules;

function SAWSOAP_SegmentationOptions_setGovRules(value) {
	this._govRules = value;
}
...
//
function SAWSOAP_SegmentationOptions_getPrompts() {
	return this._prompts;
}

SAWSOAP_SegmentationOptions.prototype.getPrompts = SAWSOAP_SegmentationOptions_getPrompts;

function SAWSOAP_SegmentationOptions_setPrompts(value) {
	this._prompts = value;
}
...
//
function SAWSOAP_SegmentationOptions_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._govRules != null) {
			for (var ax = 0; ax < this._govRules.length; ax++) {
				if (this._govRules[ax] == null) {
					...
					xml = xml
							+ this._govRules[ax].serialize(cxfjsutils,
									'jns0:govRules', null);
				}
			}
		}
		...
		if (this._prompts != null) {
			for (var ax = 0; ax < this._prompts.length; ax++) {
				if (this._prompts[ax] == null) {
					...
					xml = xml
							+ this._prompts[ax].serialize(cxfjsutils,
									'jns0:prompts', null);
				}
			}
		}
...
function SAWSOAP_SegmentationOptions_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'removeCacheHits')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = (value == 'true');
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'countOverride')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'cacheOverride')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'samplingFactor')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'govRules')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'prompts')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}CatalogItemsFilter
//
...
//
function SAWSOAP_CatalogItemsFilter_getItems() {
	return this._items;
}

SAWSOAP_CatalogItemsFilter.prototype.getItems = SAWSOAP_CatalogItemsFilter_getItems;

function SAWSOAP_CatalogItemsFilter_setItems(value) {
	this._items = value;
}
...
//
function SAWSOAP_CatalogItemsFilter_getFrom() {
	return this._from;
}

SAWSOAP_CatalogItemsFilter.prototype.getFrom = SAWSOAP_CatalogItemsFilter_getFrom;

function SAWSOAP_CatalogItemsFilter_setFrom(value) {
	this._from = value;
}
...
//
function SAWSOAP_CatalogItemsFilter_getTo() {
	return this._to;
}

SAWSOAP_CatalogItemsFilter.prototype.getTo = SAWSOAP_CatalogItemsFilter_getTo;

function SAWSOAP_CatalogItemsFilter_setTo(value) {
	this._to = value;
}
...
//
function SAWSOAP_CatalogItemsFilter_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
function SAWSOAP_CatalogItemsFilter_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'items')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_ImportError_getItem() {
	return this._item;
}

SAWSOAP_ImportError.prototype.getItem = SAWSOAP_ImportError_getItem;

function SAWSOAP_ImportError_setItem(value) {
	this._item = value;
}
...
//
function SAWSOAP_ImportError_getOperation() {
	return this._operation;
}

SAWSOAP_ImportError.prototype.getOperation = SAWSOAP_ImportError_getOperation;

function SAWSOAP_ImportError_setOperation(value) {
...
//
function SAWSOAP_ImportError_getFile() {
	return this._file;
}

SAWSOAP_ImportError.prototype.getFile = SAWSOAP_ImportError_getFile;

function SAWSOAP_ImportError_setFile(value) {
	this._file = value;
}
...
//
function SAWSOAP_ImportError_getLine() {
	return this._line;
}

SAWSOAP_ImportError.prototype.getLine = SAWSOAP_ImportError_getLine;

function SAWSOAP_ImportError_setLine(value) {
	this._line = value;
}
...
//
function SAWSOAP_ImportError_getCatalogError() {
	return this._catalogError;
}

SAWSOAP_ImportError.prototype.getCatalogError = SAWSOAP_ImportError_getCatalogError;

function SAWSOAP_ImportError_setCatalogError(value) {
	this._catalogError = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}UpdateCatalogItemACLParams
//
...
// element set for updateFlag
// setter function is is
// SAWSOAP_UpdateCatalogItemACLParams.prototype.setUpdateFlag
//
function SAWSOAP_UpdateCatalogItemACLParams_getUpdateFlag() {
	return this._updateFlag;
}

SAWSOAP_UpdateCatalogItemACLParams.prototype.getUpdateFlag = SAWSOAP_UpdateCatalogItemACLParams_getUpdateFlag;

function SAWSOAP_UpdateCatalogItemACLParams_setUpdateFlag(value) {
	this._updateFlag = value;
}
...
// setter function is is
// SAWSOAP_UpdateCatalogItemACLParams.prototype.setRecursive
//
function SAWSOAP_UpdateCatalogItemACLParams_getRecursive() {
	return this._recursive;
}

SAWSOAP_UpdateCatalogItemACLParams.prototype.getRecursive = SAWSOAP_UpdateCatalogItemACLParams_getRecursive;

function SAWSOAP_UpdateCatalogItemACLParams_setRecursive(value) {
...
//
function SAWSOAP_UpdateCatalogItemACLParams_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}StartPageParams
//
...
//
function SAWSOAP_StartPageParams_getIdsPrefix() {
	return this._idsPrefix;
}

SAWSOAP_StartPageParams.prototype.getIdsPrefix = SAWSOAP_StartPageParams_getIdsPrefix;

function SAWSOAP_StartPageParams_setIdsPrefix(value) {
	this._idsPrefix = value;
}
...
//
function SAWSOAP_StartPageParams_getDontUseHttpCookies() {
	return this._dontUseHttpCookies;
}

SAWSOAP_StartPageParams.prototype.getDontUseHttpCookies = SAWSOAP_StartPageParams_getDontUseHttpCookies;

function SAWSOAP_StartPageParams_setDontUseHttpCookies(value) {
	this._dontUseHttpCookies = value;
}
...
//
function SAWSOAP_StartPageParams_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Simple type (enumeration)
// {urn://oracle.bi.webservices/v6}ReadObjectsReturnOptions
//
// - NoObject
// - ObjectAsString
// - ObjectAsBinary
...
//
// Simple type (enumeration)
// {urn://oracle.bi.webservices/v6}SASubjectAreaDetails
//
// - Minimum
// - IncludeTables
...
//
function SAWSOAP_ErrorInfo_getCode() {
	return this._code;
}

SAWSOAP_ErrorInfo.prototype.getCode = SAWSOAP_ErrorInfo_getCode;

function SAWSOAP_ErrorInfo_setCode(value) {
	this._code = value;
}
...
//
function SAWSOAP_ErrorInfo_getContext() {
	return this._context;
}

SAWSOAP_ErrorInfo.prototype.getContext = SAWSOAP_ErrorInfo_getContext;

function SAWSOAP_ErrorInfo_setContext(value) {
	this._context = value;
}
...
//
function SAWSOAP_ErrorInfo_getMessage() {
	return this._message;
}

SAWSOAP_ErrorInfo.prototype.getMessage = SAWSOAP_ErrorInfo_getMessage;

function SAWSOAP_ErrorInfo_setMessage(value) {
	this._message = value;
}
...
//
function SAWSOAP_ErrorInfo_getDetails() {
	return this._details;
}

SAWSOAP_ErrorInfo.prototype.getDetails = SAWSOAP_ErrorInfo_getDetails;

function SAWSOAP_ErrorInfo_setDetails(value) {
	this._details = value;
}
...
function SAWSOAP_ErrorInfo_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'code')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'context')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'message')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'details')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
...
//
function SAWSOAP_SASubjectArea_getName() {
	return this._name;
}

SAWSOAP_SASubjectArea.prototype.getName = SAWSOAP_SASubjectArea_getName;

function SAWSOAP_SASubjectArea_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_SASubjectArea_getDisplayName() {
	return this._displayName;
}

SAWSOAP_SASubjectArea.prototype.getDisplayName = SAWSOAP_SASubjectArea_getDisplayName;

function SAWSOAP_SASubjectArea_setDisplayName(value) {
	this._displayName = value;
}
...
//
function SAWSOAP_SASubjectArea_getDescription() {
	return this._description;
}

SAWSOAP_SASubjectArea.prototype.getDescription = SAWSOAP_SASubjectArea_getDescription;

function SAWSOAP_SASubjectArea_setDescription(value) {
	this._description = value;
}
...
//
function SAWSOAP_SASubjectArea_getTables() {
	return this._tables;
}

SAWSOAP_SASubjectArea.prototype.getTables = SAWSOAP_SASubjectArea_getTables;

function SAWSOAP_SASubjectArea_setTables(value) {
	this._tables = value;
}
...
//
function SAWSOAP_SASubjectArea_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._tables != null) {
			for (var ax = 0; ax < this._tables.length; ax++) {
				if (this._tables[ax] == null) {
					...
					xml = xml
							+ this._tables[ax].serialize(cxfjsutils,
									'jns0:tables', null);
				}
			}
		}
...
function SAWSOAP_SASubjectArea_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'tables')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_AuthResult_getSessionID() {
	return this._sessionID;
}

SAWSOAP_AuthResult.prototype.getSessionID = SAWSOAP_AuthResult_getSessionID;

function SAWSOAP_AuthResult_setSessionID(value) {
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}LogonParameter
//
...
//
function SAWSOAP_LogonParameter_getName() {
	return this._name;
}

SAWSOAP_LogonParameter.prototype.getName = SAWSOAP_LogonParameter_getName;

function SAWSOAP_LogonParameter_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_LogonParameter_getValue() {
	return this._value;
}

SAWSOAP_LogonParameter.prototype.getValue = SAWSOAP_LogonParameter_getValue;

function SAWSOAP_LogonParameter_setValue(value) {
	this._value = value;
}
...
//
function SAWSOAP_LogonParameter_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}PromptedColumnInfo
//
...
//
function SAWSOAP_PromptedColumnInfo_getColumns() {
	return this._Columns;
}

SAWSOAP_PromptedColumnInfo.prototype.getColumns = SAWSOAP_PromptedColumnInfo_getColumns;

function SAWSOAP_PromptedColumnInfo_setColumns(value) {
	this._Columns = value;
}
...
//
function SAWSOAP_PromptedColumnInfo_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}ReportHTMLOptions
//
...
// setter function is is
// SAWSOAP_ReportHTMLOptions.prototype.setEnableDelayLoading
//
function SAWSOAP_ReportHTMLOptions_getEnableDelayLoading() {
	return this._enableDelayLoading;
}

SAWSOAP_ReportHTMLOptions.prototype.getEnableDelayLoading = SAWSOAP_ReportHTMLOptions_getEnableDelayLoading;

function SAWSOAP_ReportHTMLOptions_setEnableDelayLoading(value) {
	this._enableDelayLoading = value;
}
...
//
function SAWSOAP_ReportHTMLOptions_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_FileInfo_getFilepath() {
	return this._filepath;
}

SAWSOAP_FileInfo.prototype.getFilepath = SAWSOAP_FileInfo_getFilepath;

function SAWSOAP_FileInfo_setFilepath(value) {
...
//
function SAWSOAP_FileInfo_getStartTime() {
	return this._startTime;
}

SAWSOAP_FileInfo.prototype.getStartTime = SAWSOAP_FileInfo_getStartTime;

function SAWSOAP_FileInfo_setStartTime(value) {
...
//
function SAWSOAP_FileInfo_getEndTime() {
	return this._endTime;
}

SAWSOAP_FileInfo.prototype.getEndTime = SAWSOAP_FileInfo_getEndTime;

function SAWSOAP_FileInfo_setEndTime(value) {
	this._endTime = value;
}
...
//
function SAWSOAP_FileInfo_getFilesize() {
	return this._filesize;
}

SAWSOAP_FileInfo.prototype.getFilesize = SAWSOAP_FileInfo_getFilesize;

function SAWSOAP_FileInfo_setFilesize(value) {
...
//
function SAWSOAP_FileInfo_getFileAttribs() {
	return this._fileAttribs;
}

SAWSOAP_FileInfo.prototype.getFileAttribs = SAWSOAP_FileInfo_getFileAttribs;

function SAWSOAP_FileInfo_setFileAttribs(value) {
	this._fileAttribs = value;
}
		...
		if (this._fileAttribs != null) {
			for (var ax = 0; ax < this._fileAttribs.length; ax++) {
				if (this._fileAttribs[ax] == null) {
					...
					xml = xml
							+ this._fileAttribs[ax].serialize(cxfjsutils,
									'jns0:fileAttribs', null);
				}
			}
		}
	}
...
function SAWSOAP_FileInfo_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'fileAttribs')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
			if (!cxfjsutils.isElementNil(curElement)) {
				arrayItem = SAWSOAP_NameValueArrayPair_deserialize(cxfjsutils,
						curElement);
			}
			item.push(arrayItem);
			curElement = cxfjsutils.getNextElementSibling(curElement);
...
//
function SAWSOAP_JobInfo_getJobStats() {
	return this._jobStats;
}

SAWSOAP_JobInfo.prototype.getJobStats = SAWSOAP_JobInfo_getJobStats;

function SAWSOAP_JobInfo_setJobStats(value) {
	this._jobStats = value;
}
...
//
function SAWSOAP_JobInfo_getFileInfo() {
	return this._fileInfo;
}

SAWSOAP_JobInfo.prototype.getFileInfo = SAWSOAP_JobInfo_getFileInfo;

function SAWSOAP_JobInfo_setFileInfo(value) {
...
function SAWSOAP_JobInfo_serialize(cxfjsutils, elementName, extraNamespaces) {
		...
		if (this._fileInfo != null) {
			for (var ax = 0; ax < this._fileInfo.length; ax++) {
				if (this._fileInfo[ax] == null) {
					...
					xml = xml
							+ this._fileInfo[ax].serialize(cxfjsutils,
									'jns0:fileInfo', null);
				}
			}
		}
	...
	// block for local variables
	{
		if (this._detailedInfo != null) {
			xml = xml
					+ this._detailedInfo.serialize(cxfjsutils,
							'jns0:detailedInfo', null);
		}
	}
	if (elementName !== null) {
		xml = xml + '</';
...
function SAWSOAP_JobInfo_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'fileInfo')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'detailedInfo')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
...
//
function SAWSOAP_SAWLocale_getLanguage() {
	return this._language;
}

SAWSOAP_SAWLocale.prototype.getLanguage = SAWSOAP_SAWLocale_getLanguage;

function SAWSOAP_SAWLocale_setLanguage(value) {
...
//
function SAWSOAP_SAWLocale_getCountry() {
	return this._country;
}

SAWSOAP_SAWLocale.prototype.getCountry = SAWSOAP_SAWLocale_getCountry;

function SAWSOAP_SAWLocale_setCountry(value) {
	this._country = value;
}
...
//
function SAWSOAP_arrayOfGUIDs_getGUID() {
	return this._GUID;
}

SAWSOAP_arrayOfGUIDs.prototype.getGUID = SAWSOAP_arrayOfGUIDs_getGUID;

function SAWSOAP_arrayOfGUIDs_setGUID(value) {
	this._GUID = value;
}
...
//
function SAWSOAP_arrayOfGUIDs_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
function SAWSOAP_arrayOfGUIDs_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'GUID')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_Account_getName() {
	return this._name;
}

SAWSOAP_Account.prototype.getName = SAWSOAP_Account_getName;

function SAWSOAP_Account_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_Account_getAccountType() {
	return this._accountType;
}

SAWSOAP_Account.prototype.getAccountType = SAWSOAP_Account_getAccountType;

function SAWSOAP_Account_setAccountType(value) {
...
//
function SAWSOAP_Account_getGuid() {
	return this._guid;
}

SAWSOAP_Account.prototype.getGuid = SAWSOAP_Account_getGuid;

function SAWSOAP_Account_setGuid(value) {
	this._guid = value;
}
...
function SAWSOAP_Account_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'name')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}SAWSessionParameters
//
...
//
function SAWSOAP_SAWSessionParameters_getLocale() {
	return this._locale;
}

SAWSOAP_SAWSessionParameters.prototype.getLocale = SAWSOAP_SAWSessionParameters_getLocale;

function SAWSOAP_SAWSessionParameters_setLocale(value) {
	this._locale = value;
}
...
//
function SAWSOAP_SAWSessionParameters_getUserAgent() {
	return this._userAgent;
}

SAWSOAP_SAWSessionParameters.prototype.getUserAgent = SAWSOAP_SAWSessionParameters_getUserAgent;

function SAWSOAP_SAWSessionParameters_setUserAgent(value) {
...
//
function SAWSOAP_SAWSessionParameters_getAsyncLogon() {
	return this._asyncLogon;
}

SAWSOAP_SAWSessionParameters.prototype.getAsyncLogon = SAWSOAP_SAWSessionParameters_getAsyncLogon;

function SAWSOAP_SAWSessionParameters_setAsyncLogon(value) {
	this._asyncLogon = value;
}
...
//
function SAWSOAP_SAWSessionParameters_getLogonParams() {
	return this._logonParams;
}

SAWSOAP_SAWSessionParameters.prototype.getLogonParams = SAWSOAP_SAWSessionParameters_getLogonParams;

function SAWSOAP_SAWSessionParameters_setLogonParams(value) {
	this._logonParams = value;
}
...
//
function SAWSOAP_SAWSessionParameters_getSessionID() {
	return this._sessionID;
}

SAWSOAP_SAWSessionParameters.prototype.getSessionID = SAWSOAP_SAWSessionParameters_getSessionID;

function SAWSOAP_SAWSessionParameters_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_SAWSessionParameters_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._logonParams != null) {
			for (var ax = 0; ax < this._logonParams.length; ax++) {
				if (this._logonParams[ax] == null) {
					...
					xml = xml
							+ this._logonParams[ax].serialize(cxfjsutils,
									'jns0:logonParams', null);
				}
			}
		}
	}
...
function SAWSOAP_SAWSessionParameters_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'logonParams')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
			if (!cxfjsutils.isElementNil(curElement)) {
				arrayItem = SAWSOAP_LogonParameter_deserialize(cxfjsutils,
						curElement);
			}
			item.push(arrayItem);
			curElement = cxfjsutils.getNextElementSibling(curElement);
...
//
function SAWSOAP_ItemInfo_getPath() {
	return this._path;
}

SAWSOAP_ItemInfo.prototype.getPath = SAWSOAP_ItemInfo_getPath;

function SAWSOAP_ItemInfo_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_ItemInfo_getType() {
	return this._type;
}

SAWSOAP_ItemInfo.prototype.getType = SAWSOAP_ItemInfo_getType;

function SAWSOAP_ItemInfo_setType(value) {
	this._type = value;
}
...
//
function SAWSOAP_ItemInfo_getCaption() {
	return this._caption;
}

SAWSOAP_ItemInfo.prototype.getCaption = SAWSOAP_ItemInfo_getCaption;

function SAWSOAP_ItemInfo_setCaption(value) {
	this._caption = value;
}
...
//
function SAWSOAP_ItemInfo_getAttributes() {
	return this._attributes;
}

SAWSOAP_ItemInfo.prototype.getAttributes = SAWSOAP_ItemInfo_getAttributes;

function SAWSOAP_ItemInfo_setAttributes(value) {
...
//
function SAWSOAP_ItemInfo_getLastModified() {
	return this._lastModified;
}

SAWSOAP_ItemInfo.prototype.getLastModified = SAWSOAP_ItemInfo_getLastModified;

function SAWSOAP_ItemInfo_setLastModified(value) {
...
//
function SAWSOAP_ItemInfo_getCreated() {
	return this._created;
}

SAWSOAP_ItemInfo.prototype.getCreated = SAWSOAP_ItemInfo_getCreated;

function SAWSOAP_ItemInfo_setCreated(value) {
	this._created = value;
}
...
//
function SAWSOAP_ItemInfo_getAccessed() {
	return this._accessed;
}

SAWSOAP_ItemInfo.prototype.getAccessed = SAWSOAP_ItemInfo_getAccessed;

function SAWSOAP_ItemInfo_setAccessed(value) {
...
//
function SAWSOAP_ItemInfo_getCreator() {
	return this._creator;
}

SAWSOAP_ItemInfo.prototype.getCreator = SAWSOAP_ItemInfo_getCreator;

function SAWSOAP_ItemInfo_setCreator(value) {
	this._creator = value;
}
...
//
function SAWSOAP_ItemInfo_getSignature() {
	return this._signature;
}

SAWSOAP_ItemInfo.prototype.getSignature = SAWSOAP_ItemInfo_getSignature;

function SAWSOAP_ItemInfo_setSignature(value) {
...
//
function SAWSOAP_ItemInfo_getTargetPath() {
	return this._targetPath;
}

SAWSOAP_ItemInfo.prototype.getTargetPath = SAWSOAP_ItemInfo_getTargetPath;

function SAWSOAP_ItemInfo_setTargetPath(value) {
...
//
function SAWSOAP_ItemInfo_getAcl() {
	return this._acl;
}

SAWSOAP_ItemInfo.prototype.getAcl = SAWSOAP_ItemInfo_getAcl;

function SAWSOAP_ItemInfo_setAcl(value) {
	this._acl = value;
}
...
//
function SAWSOAP_ItemInfo_getOwner() {
	return this._owner;
}

SAWSOAP_ItemInfo.prototype.getOwner = SAWSOAP_ItemInfo_getOwner;

function SAWSOAP_ItemInfo_setOwner(value) {
	this._owner = value;
}
...
function SAWSOAP_ItemInfo_serialize(cxfjsutils, elementName, extraNamespaces) {
	...
	// block for local variables
	{
		if (this._creator != null) {
			xml = xml
					+ this._creator.serialize(cxfjsutils, 'jns0:creator', null);
		}
	}
	// block for local variables
	{
		if (this._lastModifier != null) {
			xml = xml
					+ this._lastModifier.serialize(cxfjsutils,
							'jns0:lastModifier', null);
		}
	}
	// block for local variables
	{
		...
		if (this._itemProperties != null) {
			for (var ax = 0; ax < this._itemProperties.length; ax++) {
				if (this._itemProperties[ax] == null) {
					...
					xml = xml
							+ this._itemProperties[ax].serialize(cxfjsutils,
									'jns0:itemProperties', null);
				}
			}
		}
	}
...
function SAWSOAP_ItemInfo_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'caption')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'attributes')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = parseInt(value);
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'lastModified')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'created')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'accessed')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'creator')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			item = SAWSOAP_Account_deserialize(cxfjsutils, curElement);
		}
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'lastModifier')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			item = SAWSOAP_Account_deserialize(cxfjsutils, curElement);
		}
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'signature')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'targetPath')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'acl')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'owner')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			item = SAWSOAP_Account_deserialize(cxfjsutils, curElement);
		}
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'itemProperties')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_PathMapEntry_getSource() {
	return this._source;
}

SAWSOAP_PathMapEntry.prototype.getSource = SAWSOAP_PathMapEntry_getSource;

function SAWSOAP_PathMapEntry_setSource(value) {
	this._source = value;
}
...
//
function SAWSOAP_PathMapEntry_getDestination() {
	return this._destination;
}

SAWSOAP_PathMapEntry.prototype.getDestination = SAWSOAP_PathMapEntry_getDestination;

function SAWSOAP_PathMapEntry_setDestination(value) {
...
//
function SAWSOAP_PathMapEntry_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_CatalogObject_getCatalogObject() {
	return this._catalogObject;
}

SAWSOAP_CatalogObject.prototype.getCatalogObject = SAWSOAP_CatalogObject_getCatalogObject;

function SAWSOAP_CatalogObject_setCatalogObject(value) {
	this._catalogObject = value;
}
...
//
function SAWSOAP_CatalogObject_getCatalogObjectBytes() {
	return this._catalogObjectBytes;
}

SAWSOAP_CatalogObject.prototype.getCatalogObjectBytes = SAWSOAP_CatalogObject_getCatalogObjectBytes;

function SAWSOAP_CatalogObject_setCatalogObjectBytes(value) {
	this._catalogObjectBytes = value;
}
...
//
function SAWSOAP_CatalogObject_getItemInfo() {
	return this._itemInfo;
}

SAWSOAP_CatalogObject.prototype.getItemInfo = SAWSOAP_CatalogObject_getItemInfo;

function SAWSOAP_CatalogObject_setItemInfo(value) {
...
//
function SAWSOAP_CatalogObject_getErrorInfo() {
	return this._errorInfo;
}

SAWSOAP_CatalogObject.prototype.getErrorInfo = SAWSOAP_CatalogObject_getErrorInfo;

function SAWSOAP_CatalogObject_setErrorInfo(value) {
...
//
function SAWSOAP_CatalogObject_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
	...
	// block for local variables
	{
		if (this._itemInfo != null) {
			xml = xml
					+ this._itemInfo.serialize(cxfjsutils, 'jns0:itemInfo',
							null);
		}
	}
	// block for local variables
	{
		if (this._errorInfo != null) {
			xml = xml
					+ this._errorInfo.serialize(cxfjsutils, 'jns0:errorInfo',
							null);
		}
	}
	if (elementName !== null) {
...
function SAWSOAP_CatalogObject_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'catalogObject')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'catalogObjectBytes')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'itemInfo')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			item = SAWSOAP_ItemInfo_deserialize(cxfjsutils, curElement);
		}
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'errorInfo')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}upgradeXMLResult
//
...
//
function SAWSOAP_upgradeXMLResult_getReturn() {
	return this._return;
}

SAWSOAP_upgradeXMLResult.prototype.getReturn = SAWSOAP_upgradeXMLResult_getReturn;

function SAWSOAP_upgradeXMLResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_upgradeXMLResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_importResult_getError() {
	return this._error;
}

SAWSOAP_importResult.prototype.getError = SAWSOAP_importResult_getError;

function SAWSOAP_importResult_setError(value) {
	this._error = value;
}
...
//
function SAWSOAP_importResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._error != null) {
			for (var ax = 0; ax < this._error.length; ax++) {
				if (this._error[ax] == null) {
					...
					xml = xml
							+ this._error[ax].serialize(cxfjsutils,
									'jns0:error', null);
				}
			}
		}
...
function SAWSOAP_importResult_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'error')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
			if (!cxfjsutils.isElementNil(curElement)) {
				arrayItem = SAWSOAP_ImportError_deserialize(cxfjsutils,
						curElement);
			}
			item.push(arrayItem);
			curElement = cxfjsutils.getNextElementSibling(curElement);
...
//
function SAWSOAP_setBridge_getBridge() {
	return this._bridge;
}

SAWSOAP_setBridge.prototype.getBridge = SAWSOAP_setBridge_getBridge;

function SAWSOAP_setBridge_setBridge(value) {
	this._bridge = value;
}
...
//
function SAWSOAP_setBridge_getSessionID() {
	return this._sessionID;
}

SAWSOAP_setBridge.prototype.getSessionID = SAWSOAP_setBridge_getSessionID;

function SAWSOAP_setBridge_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_deleteItem_getPath() {
	return this._path;
}

SAWSOAP_deleteItem.prototype.getPath = SAWSOAP_deleteItem_getPath;

function SAWSOAP_deleteItem_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_deleteItem_getSessionID() {
	return this._sessionID;
}

SAWSOAP_deleteItem.prototype.getSessionID = SAWSOAP_deleteItem_getSessionID;

function SAWSOAP_deleteItem_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}cancelQueryResult
//
...
//
function SAWSOAP_cancelQueryResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getSubjectAreasResult
//
...
//
function SAWSOAP_getSubjectAreasResult_getSubjectArea() {
...
function SAWSOAP_getSubjectAreasResult_setSubjectArea(value) {
...
//
function SAWSOAP_getSubjectAreasResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._subjectArea != null) {
			for (var ax = 0; ax < this._subjectArea.length; ax++) {
				if (this._subjectArea[ax] == null) {
					...
					xml = xml
							+ this._subjectArea[ax].serialize(cxfjsutils,
									'jns0:subjectArea', null);
				}
			}
		}
	}
...
function SAWSOAP_getSubjectAreasResult_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'subjectArea')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
			if (!cxfjsutils.isElementNil(curElement)) {
				arrayItem = SAWSOAP_SASubjectArea_deserialize(cxfjsutils,
						curElement);
			}
			item.push(arrayItem);
			curElement = cxfjsutils.getNextElementSibling(curElement);
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}renameAccountsResult
//
...
//
function SAWSOAP_renameAccountsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_logonex_getName() {
	return this._name;
}

SAWSOAP_logonex.prototype.getName = SAWSOAP_logonex_getName;

function SAWSOAP_logonex_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_logonex_getPassword() {
	return this._password;
}

SAWSOAP_logonex.prototype.getPassword = SAWSOAP_logonex_getPassword;

function SAWSOAP_logonex_setPassword(value) {
...
function SAWSOAP_logonex_serialize(cxfjsutils, elementName, extraNamespaces) {
	...
	// block for local variables
	{
		if (this._sessionparams == null) {
			...
			xml = xml
					+ this._sessionparams.serialize(cxfjsutils,
							'jns0:sessionparams', null);
		}
	}
	if (elementName !== null) {
		xml = xml + '</';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}executeXMLQueryResult
//
...
//
function SAWSOAP_executeXMLQueryResult_getReturn() {
	return this._return;
}

SAWSOAP_executeXMLQueryResult.prototype.getReturn = SAWSOAP_executeXMLQueryResult_getReturn;

function SAWSOAP_executeXMLQueryResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_executeXMLQueryResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}executeIBotNowResult
//
...
//
function SAWSOAP_executeIBotNowResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getSessionVariables
//
...
//
function SAWSOAP_getSessionVariables_getNames() {
	return this._names;
}

SAWSOAP_getSessionVariables.prototype.getNames = SAWSOAP_getSessionVariables_getNames;

function SAWSOAP_getSessionVariables_setNames(value) {
	this._names = value;
}
...
//
function SAWSOAP_getSessionVariables_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getSessionVariables.prototype.getSessionID = SAWSOAP_getSessionVariables_getSessionID;

function SAWSOAP_getSessionVariables_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getSessionVariables_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
function SAWSOAP_getSessionVariables_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'names')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}writeListFilesResult
//
...
//
function SAWSOAP_writeListFilesResult_getJobInfo() {
	return this._jobInfo;
}

SAWSOAP_writeListFilesResult.prototype.getJobInfo = SAWSOAP_writeListFilesResult_getJobInfo;

function SAWSOAP_writeListFilesResult_setJobInfo(value) {
	this._jobInfo = value;
}
...
//
function SAWSOAP_writeListFilesResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_keepAlive_getSessionID() {
	return this._sessionID;
}

SAWSOAP_keepAlive.prototype.getSessionID = SAWSOAP_keepAlive_getSessionID;

function SAWSOAP_keepAlive_setSessionID(value) {
	this._sessionID = value;
}
		...
		if (this._sessionID != null) {
			for (var ax = 0; ax < this._sessionID.length; ax++) {
				if (this._sessionID[ax] == null) {
					...
					xml = xml + '<jns0:sessionID>';
					xml = xml
							+ cxfjsutils.escapeXmlEntities(this._sessionID[ax]);
					xml = xml + '</jns0:sessionID>';
				}
			}
		}
...
function SAWSOAP_keepAlive_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'sessionID')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}evaluateInlineConditionResult
//
...
//
// accessor is
// SAWSOAP_evaluateInlineConditionResult.prototype.getConditionIsTrue
...
// setter function is is
// SAWSOAP_evaluateInlineConditionResult.prototype.setConditionIsTrue
//
function SAWSOAP_evaluateInlineConditionResult_getConditionIsTrue() {
	return this._conditionIsTrue;
}
...
function SAWSOAP_evaluateInlineConditionResult_setConditionIsTrue(value) {
	this._conditionIsTrue = value;
}
...
//
function SAWSOAP_evaluateInlineConditionResult_serialize(cxfjsutils,
...
//
function SAWSOAP_getCounts_getTreePath() {
	return this._treePath;
}

SAWSOAP_getCounts.prototype.getTreePath = SAWSOAP_getCounts_getTreePath;

function SAWSOAP_getCounts_setTreePath(value) {
	this._treePath = value;
}
...
//
function SAWSOAP_getCounts_getSegmentationOptions() {
	return this._segmentationOptions;
}

SAWSOAP_getCounts.prototype.getSegmentationOptions = SAWSOAP_getCounts_getSegmentationOptions;

function SAWSOAP_getCounts_setSegmentationOptions(value) {
	this._segmentationOptions = value;
}
...
//
function SAWSOAP_getCounts_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getCounts.prototype.getSessionID = SAWSOAP_getCounts_getSessionID;

function SAWSOAP_getCounts_setSessionID(value) {
	this._sessionID = value;
}
...
function SAWSOAP_getCounts_serialize(cxfjsutils, elementName, extraNamespaces) {
	...
	// block for local variables
	{
		if (this._segmentationOptions != null) {
			xml = xml
					+ this._segmentationOptions.serialize(cxfjsutils,
							'jns0:segmentationOptions', null);
		}
	}
	// block for local variables
	{
...
function SAWSOAP_getCounts_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'segmentPath')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'treePath')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
		...
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			item = SAWSOAP_SegmentationOptions_deserialize(cxfjsutils,
					curElement);
		}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getSubjectAreas
//
...
//
function SAWSOAP_getSubjectAreas_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getSubjectAreas.prototype.getSessionID = SAWSOAP_getSubjectAreas_getSessionID;

function SAWSOAP_getSubjectAreas_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getSubjectAreas_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getHtmlForReportResult
//
...
//
function SAWSOAP_getHtmlForReportResult_getReturn() {
	return this._return;
}

SAWSOAP_getHtmlForReportResult.prototype.getReturn = SAWSOAP_getHtmlForReportResult_getReturn;

function SAWSOAP_getHtmlForReportResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_getHtmlForReportResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}deleteResultSetResult
//
...
//
function SAWSOAP_deleteResultSetResult_getJobInfo() {
	return this._jobInfo;
}

SAWSOAP_deleteResultSetResult.prototype.getJobInfo = SAWSOAP_deleteResultSetResult_getJobInfo;

function SAWSOAP_deleteResultSetResult_setJobInfo(value) {
	this._jobInfo = value;
}
...
//
function SAWSOAP_deleteResultSetResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}removeFolderResult
//
...
//
function SAWSOAP_removeFolderResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_getSubItems_getPath() {
	return this._path;
}

SAWSOAP_getSubItems.prototype.getPath = SAWSOAP_getSubItems_getPath;

function SAWSOAP_getSubItems_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_getSubItems_getMask() {
	return this._mask;
}

SAWSOAP_getSubItems.prototype.getMask = SAWSOAP_getSubItems_getMask;

function SAWSOAP_getSubItems_setMask(value) {
	this._mask = value;
}
...
//
function SAWSOAP_getSubItems_getResolveLinks() {
	return this._resolveLinks;
}

SAWSOAP_getSubItems.prototype.getResolveLinks = SAWSOAP_getSubItems_getResolveLinks;

function SAWSOAP_getSubItems_setResolveLinks(value) {
	this._resolveLinks = value;
}
...
//
function SAWSOAP_getSubItems_getOptions() {
	return this._options;
}

SAWSOAP_getSubItems.prototype.getOptions = SAWSOAP_getSubItems_getOptions;

function SAWSOAP_getSubItems_setOptions(value) {
	this._options = value;
}
...
//
function SAWSOAP_getSubItems_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getSubItems.prototype.getSessionID = SAWSOAP_getSubItems_getSessionID;

function SAWSOAP_getSubItems_setSessionID(value) {
	this._sessionID = value;
}
...
function SAWSOAP_getSubItems_serialize(cxfjsutils, elementName, extraNamespaces) {
	...
	// block for local variables
	{
		if (this._options == null) {
			...
			xml = xml
					+ this._options.serialize(cxfjsutils, 'jns0:options', null);
		}
	}
	// block for local variables
	{
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getHeadersHtmlResult
//
...
//
function SAWSOAP_getHeadersHtmlResult_getReturn() {
	return this._return;
}

SAWSOAP_getHeadersHtmlResult.prototype.getReturn = SAWSOAP_getHeadersHtmlResult_getReturn;

function SAWSOAP_getHeadersHtmlResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_getHeadersHtmlResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getPromptedFilters
//
...
//
function SAWSOAP_getPromptedFilters_getReport() {
	return this._report;
}

SAWSOAP_getPromptedFilters.prototype.getReport = SAWSOAP_getPromptedFilters_getReport;

function SAWSOAP_getPromptedFilters_setReport(value) {
	this._report = value;
}
...
//
function SAWSOAP_getPromptedFilters_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getPromptedFilters.prototype.getSessionID = SAWSOAP_getPromptedFilters_getSessionID;

function SAWSOAP_getPromptedFilters_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getPromptedFilters_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_sendMessage_getRecipient() {
	return this._recipient;
}

SAWSOAP_sendMessage.prototype.getRecipient = SAWSOAP_sendMessage_getRecipient;

function SAWSOAP_sendMessage_setRecipient(value) {
...
//
function SAWSOAP_sendMessage_getGroup() {
	return this._group;
}

SAWSOAP_sendMessage.prototype.getGroup = SAWSOAP_sendMessage_getGroup;

function SAWSOAP_sendMessage_setGroup(value) {
	this._group = value;
}
...
//
function SAWSOAP_sendMessage_getSubject() {
	return this._subject;
}

SAWSOAP_sendMessage.prototype.getSubject = SAWSOAP_sendMessage_getSubject;

function SAWSOAP_sendMessage_setSubject(value) {
	this._subject = value;
}
...
//
function SAWSOAP_sendMessage_getBody() {
	return this._body;
}

SAWSOAP_sendMessage.prototype.getBody = SAWSOAP_sendMessage_getBody;

function SAWSOAP_sendMessage_setBody(value) {
	this._body = value;
}
...
//
function SAWSOAP_sendMessage_getPriority() {
	return this._priority;
}

SAWSOAP_sendMessage.prototype.getPriority = SAWSOAP_sendMessage_getPriority;

function SAWSOAP_sendMessage_setPriority(value) {
...
//
function SAWSOAP_sendMessage_getSessionID() {
	return this._sessionID;
}

SAWSOAP_sendMessage.prototype.getSessionID = SAWSOAP_sendMessage_getSessionID;

function SAWSOAP_sendMessage_setSessionID(value) {
	this._sessionID = value;
}
		...
		if (this._recipient != null) {
			for (var ax = 0; ax < this._recipient.length; ax++) {
				if (this._recipient[ax] == null) {
					...
					xml = xml + '<jns0:recipient>';
					xml = xml
							+ cxfjsutils.escapeXmlEntities(this._recipient[ax]);
					xml = xml + '</jns0:recipient>';
				}
			}
		}
...
function SAWSOAP_sendMessage_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'recipient')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'group')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}forgetAccountsResult
//
...
//
function SAWSOAP_forgetAccountsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}renameAccounts
//
...
//
function SAWSOAP_renameAccounts_getFrom() {
	return this._from;
}

SAWSOAP_renameAccounts.prototype.getFrom = SAWSOAP_renameAccounts_getFrom;

function SAWSOAP_renameAccounts_setFrom(value) {
	this._from = value;
}
...
//
function SAWSOAP_renameAccounts_getTo() {
	return this._to;
}

SAWSOAP_renameAccounts.prototype.getTo = SAWSOAP_renameAccounts_getTo;

function SAWSOAP_renameAccounts_setTo(value) {
	this._to = value;
}
...
//
function SAWSOAP_renameAccounts_getSessionID() {
	return this._sessionID;
}

SAWSOAP_renameAccounts.prototype.getSessionID = SAWSOAP_renameAccounts_getSessionID;

function SAWSOAP_renameAccounts_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_renameAccounts_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._from != null) {
			for (var ax = 0; ax < this._from.length; ax++) {
				if (this._from[ax] == null) {
					...
					xml = xml
							+ this._from[ax].serialize(cxfjsutils, 'jns0:from',
									null);
				}
			}
		}
		...
		if (this._to != null) {
			for (var ax = 0; ax < this._to.length; ax++) {
				if (this._to[ax] == null) {
					...
					xml = xml
							+ this._to[ax].serialize(cxfjsutils, 'jns0:to',
									null);
				}
			}
		}
...
function SAWSOAP_renameAccounts_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'from')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'to')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getHeadersHtml
//
...
//
function SAWSOAP_getHeadersHtml_getPageID() {
	return this._pageID;
}

SAWSOAP_getHeadersHtml.prototype.getPageID = SAWSOAP_getHeadersHtml_getPageID;

function SAWSOAP_getHeadersHtml_setPageID(value) {
	this._pageID = value;
}
...
//
function SAWSOAP_getHeadersHtml_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getHeadersHtml.prototype.getSessionID = SAWSOAP_getHeadersHtml_getSessionID;

function SAWSOAP_getHeadersHtml_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getHeadersHtml_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}unsubscribeResult
//
...
//
function SAWSOAP_unsubscribeResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getConditionCustomizableReportElements
//
...
// element set for path
// setter function is is
// SAWSOAP_getConditionCustomizableReportElements.prototype.setPath
//
function SAWSOAP_getConditionCustomizableReportElements_getPath() {
	return this._path;
}

SAWSOAP_getConditionCustomizableReportElements.prototype.getPath = SAWSOAP_getConditionCustomizableReportElements_getPath;

function SAWSOAP_getConditionCustomizableReportElements_setPath(value) {
	this._path = value;
}
...
//
// accessor is
// SAWSOAP_getConditionCustomizableReportElements.prototype.getSessionID
// element get for sessionID
// - element type is {http://www.w3.org/2001/XMLSchema}string
// - required element
// - nillable
...
// element set for sessionID
// setter function is is
// SAWSOAP_getConditionCustomizableReportElements.prototype.setSessionID
//
function SAWSOAP_getConditionCustomizableReportElements_getSessionID() {
	return this._sessionID;
}
...
function SAWSOAP_getConditionCustomizableReportElements_setSessionID(value) {
	this._sessionID = value;
}
...
// {urn://oracle.bi.webservices/v6}getConditionCustomizableReportElements
//
function SAWSOAP_getConditionCustomizableReportElements_serialize(cxfjsutils,
		elementName, extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
function SAWSOAP_getConditionCustomizableReportElements_deserialize(cxfjsutils,
		element) {
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}sendMessageResult
//
...
//
function SAWSOAP_sendMessageResult_getStatus() {
	return this._status;
}

SAWSOAP_sendMessageResult.prototype.getStatus = SAWSOAP_sendMessageResult_getStatus;

function SAWSOAP_sendMessageResult_setStatus(value) {
	this._status = value;
}
...
//
function SAWSOAP_sendMessageResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}impersonateResult
//
...
//
function SAWSOAP_impersonateResult_getSessionID() {
	return this._sessionID;
}

SAWSOAP_impersonateResult.prototype.getSessionID = SAWSOAP_impersonateResult_getSessionID;

function SAWSOAP_impersonateResult_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_impersonateResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}executeIBotNow
//
...
//
function SAWSOAP_executeIBotNow_getPath() {
	return this._path;
}

SAWSOAP_executeIBotNow.prototype.getPath = SAWSOAP_executeIBotNow_getPath;

function SAWSOAP_executeIBotNow_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_executeIBotNow_getSessionID() {
	return this._sessionID;
}

SAWSOAP_executeIBotNow.prototype.getSessionID = SAWSOAP_executeIBotNow_getSessionID;

function SAWSOAP_executeIBotNow_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_executeIBotNow_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}generateReportSQL
//
...
//
function SAWSOAP_generateReportSQL_getReportRef() {
	return this._reportRef;
}

SAWSOAP_generateReportSQL.prototype.getReportRef = SAWSOAP_generateReportSQL_getReportRef;

function SAWSOAP_generateReportSQL_setReportRef(value) {
	this._reportRef = value;
}
...
//
function SAWSOAP_generateReportSQL_getReportParams() {
	return this._reportParams;
}

SAWSOAP_generateReportSQL.prototype.getReportParams = SAWSOAP_generateReportSQL_getReportParams;

function SAWSOAP_generateReportSQL_setReportParams(value) {
	this._reportParams = value;
}
...
//
function SAWSOAP_generateReportSQL_getSessionID() {
	return this._sessionID;
}

SAWSOAP_generateReportSQL.prototype.getSessionID = SAWSOAP_generateReportSQL_getSessionID;

function SAWSOAP_generateReportSQL_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_generateReportSQL_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
	...
	{
		xml = xml
				+ this._reportRef.serialize(cxfjsutils, 'jns0:reportRef', null);
	}
	// block for local variables
	{
		if (this._reportParams == null) {
			...
			xml = xml
					+ this._reportParams.serialize(cxfjsutils,
							'jns0:reportParams', null);
		}
	}
	// block for local variables
	{
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}createLinkResult
//
...
//
function SAWSOAP_createLinkResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}purgeLogResult
//
...
//
function SAWSOAP_purgeLogResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}evaluateCondition
//
...
//
function SAWSOAP_evaluateCondition_getPath() {
	return this._path;
}

SAWSOAP_evaluateCondition.prototype.getPath = SAWSOAP_evaluateCondition_getPath;

function SAWSOAP_evaluateCondition_setPath(value) {
	this._path = value;
}
...
//
// accessor is
// SAWSOAP_evaluateCondition.prototype.getReportCustomizationParameters
...
// setter function is is
// SAWSOAP_evaluateCondition.prototype.setReportCustomizationParameters
//
function SAWSOAP_evaluateCondition_getReportCustomizationParameters() {
	return this._reportCustomizationParameters;
}
...
function SAWSOAP_evaluateCondition_setReportCustomizationParameters(value) {
	this._reportCustomizationParameters = value;
}
...
//
function SAWSOAP_evaluateCondition_getSessionID() {
	return this._sessionID;
}

SAWSOAP_evaluateCondition.prototype.getSessionID = SAWSOAP_evaluateCondition_getSessionID;

function SAWSOAP_evaluateCondition_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_evaluateCondition_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._reportCustomizationParameters != null) {
			for (var ax = 0; ax < this._reportCustomizationParameters.length; ax++) {
				if (this._reportCustomizationParameters[ax] == null) {
					...
					xml = xml
							+ cxfjsutils
									.escapeXmlEntities(this._reportCustomizationParameters[ax]);
					xml = xml + '</jns0:reportCustomizationParameters>';
				}
			}
		}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}writeObjectsResult
//
...
//
function SAWSOAP_writeObjectsResult_getErrorInfo() {
	return this._errorInfo;
}

SAWSOAP_writeObjectsResult.prototype.getErrorInfo = SAWSOAP_writeObjectsResult_getErrorInfo;

function SAWSOAP_writeObjectsResult_setErrorInfo(value) {
	this._errorInfo = value;
}
...
//
function SAWSOAP_writeObjectsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._errorInfo != null) {
			for (var ax = 0; ax < this._errorInfo.length; ax++) {
				if (this._errorInfo[ax] == null) {
					...
					xml = xml
							+ this._errorInfo[ax].serialize(cxfjsutils,
									'jns0:errorInfo', null);
				}
			}
		}
...
function SAWSOAP_writeObjectsResult_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
		...
		do {
			...
			var value = null;
			if (!cxfjsutils.isElementNil(curElement)) {
				arrayItem = SAWSOAP_ErrorInfo_deserialize(cxfjsutils,
						curElement);
			}
			item.push(arrayItem);
			curElement = cxfjsutils.getNextElementSibling(curElement);
...
//
function SAWSOAP_moveItem_getPathSrc() {
	return this._pathSrc;
}

SAWSOAP_moveItem.prototype.getPathSrc = SAWSOAP_moveItem_getPathSrc;

function SAWSOAP_moveItem_setPathSrc(value) {
	this._pathSrc = value;
}
...
//
function SAWSOAP_moveItem_getPathDest() {
	return this._pathDest;
}

SAWSOAP_moveItem.prototype.getPathDest = SAWSOAP_moveItem_getPathDest;

function SAWSOAP_moveItem_setPathDest(value) {
	this._pathDest = value;
}
...
//
function SAWSOAP_moveItem_getFlagACL() {
	return this._flagACL;
}

SAWSOAP_moveItem.prototype.getFlagACL = SAWSOAP_moveItem_getFlagACL;

function SAWSOAP_moveItem_setFlagACL(value) {
	this._flagACL = value;
}
...
//
function SAWSOAP_moveItem_getSessionID() {
	return this._sessionID;
}

SAWSOAP_moveItem.prototype.getSessionID = SAWSOAP_moveItem_getSessionID;

function SAWSOAP_moveItem_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_describeTable_getSubjectAreaName() {
	return this._subjectAreaName;
}

SAWSOAP_describeTable.prototype.getSubjectAreaName = SAWSOAP_describeTable_getSubjectAreaName;

function SAWSOAP_describeTable_setSubjectAreaName(value) {
	this._subjectAreaName = value;
}
...
//
function SAWSOAP_describeTable_getTableName() {
	return this._tableName;
}

SAWSOAP_describeTable.prototype.getTableName = SAWSOAP_describeTable_getTableName;

function SAWSOAP_describeTable_setTableName(value) {
...
//
function SAWSOAP_describeTable_getDetailsLevel() {
	return this._detailsLevel;
}

SAWSOAP_describeTable.prototype.getDetailsLevel = SAWSOAP_describeTable_getDetailsLevel;

function SAWSOAP_describeTable_setDetailsLevel(value) {
	this._detailsLevel = value;
}
...
//
function SAWSOAP_describeTable_getSessionID() {
	return this._sessionID;
}

SAWSOAP_describeTable.prototype.getSessionID = SAWSOAP_describeTable_getSessionID;

function SAWSOAP_describeTable_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_describeTable_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}maintenanceModeResult
//
...
//
function SAWSOAP_maintenanceModeResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}purgeCacheResult
//
...
//
function SAWSOAP_purgeCacheResult_getJobInfo() {
	return this._jobInfo;
}

SAWSOAP_purgeCacheResult.prototype.getJobInfo = SAWSOAP_purgeCacheResult_getJobInfo;

function SAWSOAP_purgeCacheResult_setJobInfo(value) {
	this._jobInfo = value;
}
...
//
function SAWSOAP_purgeCacheResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}setItemPropertyResult
//
...
//
function SAWSOAP_setItemPropertyResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}leaveGroupsResult
//
...
//
function SAWSOAP_leaveGroupsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}generateReportSQLResult
//
...
//
function SAWSOAP_generateReportSQLResult_getReturn() {
	return this._return;
}

SAWSOAP_generateReportSQLResult.prototype.getReturn = SAWSOAP_generateReportSQLResult_getReturn;

function SAWSOAP_generateReportSQLResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_generateReportSQLResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getCurUserResult
//
...
//
function SAWSOAP_getCurUserResult_getReturn() {
	return this._return;
}

SAWSOAP_getCurUserResult.prototype.getReturn = SAWSOAP_getCurUserResult_getReturn;

function SAWSOAP_getCurUserResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_getCurUserResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}forgetAccounts
//
...
//
function SAWSOAP_forgetAccounts_getAccount() {
	return this._account;
}

SAWSOAP_forgetAccounts.prototype.getAccount = SAWSOAP_forgetAccounts_getAccount;

function SAWSOAP_forgetAccounts_setAccount(value) {
	this._account = value;
}
...
//
function SAWSOAP_forgetAccounts_getCleanuplevel() {
	return this._cleanuplevel;
}

SAWSOAP_forgetAccounts.prototype.getCleanuplevel = SAWSOAP_forgetAccounts_getCleanuplevel;

function SAWSOAP_forgetAccounts_setCleanuplevel(value) {
	this._cleanuplevel = value;
}
...
//
function SAWSOAP_forgetAccounts_getSessionID() {
	return this._sessionID;
}

SAWSOAP_forgetAccounts.prototype.getSessionID = SAWSOAP_forgetAccounts_getSessionID;

function SAWSOAP_forgetAccounts_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_forgetAccounts_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._account != null) {
			for (var ax = 0; ax < this._account.length; ax++) {
				if (this._account[ax] == null) {
					...
					xml = xml
							+ this._account[ax].serialize(cxfjsutils,
									'jns0:account', null);
				}
			}
		}
...
function SAWSOAP_forgetAccounts_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'account')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_prepareCache_getSegmentPath() {
	return this._segmentPath;
}

SAWSOAP_prepareCache.prototype.getSegmentPath = SAWSOAP_prepareCache_getSegmentPath;

function SAWSOAP_prepareCache_setSegmentPath(value) {
	this._segmentPath = value;
}
...
//
function SAWSOAP_prepareCache_getTreePath() {
	return this._treePath;
}

SAWSOAP_prepareCache.prototype.getTreePath = SAWSOAP_prepareCache_getTreePath;

function SAWSOAP_prepareCache_setTreePath(value) {
	this._treePath = value;
}
...
//
function SAWSOAP_prepareCache_getRefresh() {
	return this._refresh;
}

SAWSOAP_prepareCache.prototype.getRefresh = SAWSOAP_prepareCache_getRefresh;

function SAWSOAP_prepareCache_setRefresh(value) {
	this._refresh = value;
}
...
//
function SAWSOAP_prepareCache_getSessionID() {
	return this._sessionID;
}

SAWSOAP_prepareCache.prototype.getSessionID = SAWSOAP_prepareCache_getSessionID;

function SAWSOAP_prepareCache_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_prepareCache_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
function SAWSOAP_prepareCache_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'refresh')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = (value == 'true');
...
//
function SAWSOAP_logoff_getSessionID() {
	return this._sessionID;
}

SAWSOAP_logoff.prototype.getSessionID = SAWSOAP_logoff_getSessionID;

function SAWSOAP_logoff_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}applyReportDefaults
//
...
//
function SAWSOAP_applyReportDefaults_getReportRefs() {
	return this._reportRefs;
}

SAWSOAP_applyReportDefaults.prototype.getReportRefs = SAWSOAP_applyReportDefaults_getReportRefs;

function SAWSOAP_applyReportDefaults_setReportRefs(value) {
	this._reportRefs = value;
}
...
//
function SAWSOAP_applyReportDefaults_getSessionID() {
	return this._sessionID;
}

SAWSOAP_applyReportDefaults.prototype.getSessionID = SAWSOAP_applyReportDefaults_getSessionID;

function SAWSOAP_applyReportDefaults_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_applyReportDefaults_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
	...
	{
		xml = xml
				+ this._reportRefs.serialize(cxfjsutils, 'jns0:reportRefs',
						null);
	}
	// block for local variables
	{
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}createFolderResult
//
...
//
function SAWSOAP_createFolderResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getGlobalPrivileges
//
...
//
function SAWSOAP_getGlobalPrivileges_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getGlobalPrivileges.prototype.getSessionID = SAWSOAP_getGlobalPrivileges_getSessionID;

function SAWSOAP_getGlobalPrivileges_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getGlobalPrivileges_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getGlobalPrivilegeACLResult
//
...
//
function SAWSOAP_getGlobalPrivilegeACLResult_getAcl() {
	return this._acl;
}

SAWSOAP_getGlobalPrivilegeACLResult.prototype.getAcl = SAWSOAP_getGlobalPrivilegeACLResult_getAcl;

function SAWSOAP_getGlobalPrivilegeACLResult_setAcl(value) {
	this._acl = value;
}
...
//
function SAWSOAP_getGlobalPrivilegeACLResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getCommonBodyHtmlResult
//
...
//
function SAWSOAP_getCommonBodyHtmlResult_getReturn() {
	return this._return;
}

SAWSOAP_getCommonBodyHtmlResult.prototype.getReturn = SAWSOAP_getCommonBodyHtmlResult_getReturn;

function SAWSOAP_getCommonBodyHtmlResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_getCommonBodyHtmlResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getHtmlForReport
//
...
//
function SAWSOAP_getHtmlForReport_getPageID() {
	return this._pageID;
}

SAWSOAP_getHtmlForReport.prototype.getPageID = SAWSOAP_getHtmlForReport_getPageID;

function SAWSOAP_getHtmlForReport_setPageID(value) {
	this._pageID = value;
}
...
//
function SAWSOAP_getHtmlForReport_getPageReportID() {
	return this._pageReportID;
}

SAWSOAP_getHtmlForReport.prototype.getPageReportID = SAWSOAP_getHtmlForReport_getPageReportID;

function SAWSOAP_getHtmlForReport_setPageReportID(value) {
	this._pageReportID = value;
}
...
//
function SAWSOAP_getHtmlForReport_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getHtmlForReport.prototype.getSessionID = SAWSOAP_getHtmlForReport_getSessionID;

function SAWSOAP_getHtmlForReport_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getHtmlForReport_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}executeXMLQuery
//
...
//
function SAWSOAP_executeXMLQuery_getReport() {
	return this._report;
}

SAWSOAP_executeXMLQuery.prototype.getReport = SAWSOAP_executeXMLQuery_getReport;

function SAWSOAP_executeXMLQuery_setReport(value) {
	this._report = value;
}
...
//
function SAWSOAP_executeXMLQuery_getOutputFormat() {
	return this._outputFormat;
}

SAWSOAP_executeXMLQuery.prototype.getOutputFormat = SAWSOAP_executeXMLQuery_getOutputFormat;

function SAWSOAP_executeXMLQuery_setOutputFormat(value) {
...
//
function SAWSOAP_executeXMLQuery_getExecutionOptions() {
...
function SAWSOAP_executeXMLQuery_setExecutionOptions(value) {
	this._executionOptions = value;
}
...
//
function SAWSOAP_executeXMLQuery_getReportParams() {
	return this._reportParams;
}

SAWSOAP_executeXMLQuery.prototype.getReportParams = SAWSOAP_executeXMLQuery_getReportParams;

function SAWSOAP_executeXMLQuery_setReportParams(value) {
	this._reportParams = value;
}
...
//
function SAWSOAP_executeXMLQuery_getSessionID() {
	return this._sessionID;
}

SAWSOAP_executeXMLQuery.prototype.getSessionID = SAWSOAP_executeXMLQuery_getSessionID;

function SAWSOAP_executeXMLQuery_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_executeXMLQuery_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
	...
	// block for local variables
	{
		if (this._executionOptions == null) {
			...
			xml = xml
					+ this._executionOptions.serialize(cxfjsutils,
							'jns0:executionOptions', null);
		}
	}
	// block for local variables
	{
...
function SAWSOAP_executeXMLQuery_deserialize(cxfjsutils, element) {
	...
	var value = null;
	if (!cxfjsutils.isElementNil(curElement)) {
		item = SAWSOAP_XMLQueryExecutionOptions_deserialize(cxfjsutils,
				curElement);
	}
...
//
function SAWSOAP_writeIBot_getObj() {
	return this._obj;
}

SAWSOAP_writeIBot.prototype.getObj = SAWSOAP_writeIBot_getObj;

function SAWSOAP_writeIBot_setObj(value) {
	this._obj = value;
}
...
//
function SAWSOAP_writeIBot_getPath() {
	return this._path;
}

SAWSOAP_writeIBot.prototype.getPath = SAWSOAP_writeIBot_getPath;

function SAWSOAP_writeIBot_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_writeIBot_getResolveLinks() {
	return this._resolveLinks;
}

SAWSOAP_writeIBot.prototype.getResolveLinks = SAWSOAP_writeIBot_getResolveLinks;

function SAWSOAP_writeIBot_setResolveLinks(value) {
	this._resolveLinks = value;
}
...
//
function SAWSOAP_writeIBot_getSessionID() {
	return this._sessionID;
}

SAWSOAP_writeIBot.prototype.getSessionID = SAWSOAP_writeIBot_getSessionID;

function SAWSOAP_writeIBot_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}maintenanceMode
//
...
//
function SAWSOAP_maintenanceMode_getFlag() {
	return this._flag;
}

SAWSOAP_maintenanceMode.prototype.getFlag = SAWSOAP_maintenanceMode_getFlag;

function SAWSOAP_maintenanceMode_setFlag(value) {
	this._flag = value;
}
...
//
function SAWSOAP_maintenanceMode_getSessionID() {
	return this._sessionID;
}

SAWSOAP_maintenanceMode.prototype.getSessionID = SAWSOAP_maintenanceMode_getSessionID;

function SAWSOAP_maintenanceMode_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_maintenanceMode_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_endPage_getPageID() {
	return this._pageID;
}

SAWSOAP_endPage.prototype.getPageID = SAWSOAP_endPage_getPageID;

function SAWSOAP_endPage_setPageID(value) {
	this._pageID = value;
}
...
//
function SAWSOAP_endPage_getSessionID() {
	return this._sessionID;
}

SAWSOAP_endPage.prototype.getSessionID = SAWSOAP_endPage_getSessionID;

function SAWSOAP_endPage_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}addReportToPageResult
//
...
//
function SAWSOAP_addReportToPageResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}clearQueryCacheResult
//
...
//
function SAWSOAP_clearQueryCacheResult_getResult() {
	return this._result;
}

SAWSOAP_clearQueryCacheResult.prototype.getResult = SAWSOAP_clearQueryCacheResult_getResult;

function SAWSOAP_clearQueryCacheResult_setResult(value) {
	this._result = value;
}
...
//
function SAWSOAP_clearQueryCacheResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_logonResult_getSessionID() {
	return this._sessionID;
}

SAWSOAP_logonResult.prototype.getSessionID = SAWSOAP_logonResult_getSessionID;

function SAWSOAP_logonResult_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}updateGlobalPrivilegeACLResult
//
...
//
function SAWSOAP_updateGlobalPrivilegeACLResult_serialize(cxfjsutils,
		elementName, extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getPermissionsResult
//
...
//
function SAWSOAP_getPermissionsResult_getReturn() {
	return this._return;
}

SAWSOAP_getPermissionsResult.prototype.getReturn = SAWSOAP_getPermissionsResult_getReturn;

function SAWSOAP_getPermissionsResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_getPermissionsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
function SAWSOAP_getPermissionsResult_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'return')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}describeSubjectArea
//
...
// element set for subjectAreaName
// setter function is is
// SAWSOAP_describeSubjectArea.prototype.setSubjectAreaName
//
function SAWSOAP_describeSubjectArea_getSubjectAreaName() {
	return this._subjectAreaName;
}

SAWSOAP_describeSubjectArea.prototype.getSubjectAreaName = SAWSOAP_describeSubjectArea_getSubjectAreaName;

function SAWSOAP_describeSubjectArea_setSubjectAreaName(value) {
	this._subjectAreaName = value;
}
...
//
function SAWSOAP_describeSubjectArea_getDetailsLevel() {
	return this._detailsLevel;
}

SAWSOAP_describeSubjectArea.prototype.getDetailsLevel = SAWSOAP_describeSubjectArea_getDetailsLevel;

function SAWSOAP_describeSubjectArea_setDetailsLevel(value) {
	this._detailsLevel = value;
}
...
//
function SAWSOAP_describeSubjectArea_getSessionID() {
	return this._sessionID;
}

SAWSOAP_describeSubjectArea.prototype.getSessionID = SAWSOAP_describeSubjectArea_getSessionID;

function SAWSOAP_describeSubjectArea_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_describeSubjectArea_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getPermissions
//
...
//
function SAWSOAP_getPermissions_getAcls() {
	return this._acls;
}

SAWSOAP_getPermissions.prototype.getAcls = SAWSOAP_getPermissions_getAcls;

function SAWSOAP_getPermissions_setAcls(value) {
	this._acls = value;
}
...
//
function SAWSOAP_getPermissions_getAccount() {
	return this._account;
}

SAWSOAP_getPermissions.prototype.getAccount = SAWSOAP_getPermissions_getAccount;

function SAWSOAP_getPermissions_setAccount(value) {
	this._account = value;
}
...
//
function SAWSOAP_getPermissions_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getPermissions.prototype.getSessionID = SAWSOAP_getPermissions_getSessionID;

function SAWSOAP_getPermissions_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getPermissions_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._acls != null) {
			for (var ax = 0; ax < this._acls.length; ax++) {
				if (this._acls[ax] == null) {
					...
					xml = xml
							+ this._acls[ax].serialize(cxfjsutils, 'jns0:acls',
									null);
				}
			}
		}
	...
	// block for local variables
	{
		if (this._account == null) {
			...
			xml = xml
					+ this._account.serialize(cxfjsutils, 'jns0:account', null);
		}
	}
	// block for local variables
	{
...
function SAWSOAP_getPermissions_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'acls')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getItemInfoResult
//
...
//
function SAWSOAP_getItemInfoResult_getReturn() {
	return this._return;
}

SAWSOAP_getItemInfoResult.prototype.getReturn = SAWSOAP_getItemInfoResult_getReturn;

function SAWSOAP_getItemInfoResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_getItemInfoResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}addReportToPage
//
...
//
function SAWSOAP_addReportToPage_getPageID() {
	return this._pageID;
}

SAWSOAP_addReportToPage.prototype.getPageID = SAWSOAP_addReportToPage_getPageID;

function SAWSOAP_addReportToPage_setPageID(value) {
	this._pageID = value;
}
...
//
function SAWSOAP_addReportToPage_getReportID() {
	return this._reportID;
}

SAWSOAP_addReportToPage.prototype.getReportID = SAWSOAP_addReportToPage_getReportID;

function SAWSOAP_addReportToPage_setReportID(value) {
...
//
function SAWSOAP_addReportToPage_getReport() {
	return this._report;
}

SAWSOAP_addReportToPage.prototype.getReport = SAWSOAP_addReportToPage_getReport;

function SAWSOAP_addReportToPage_setReport(value) {
	this._report = value;
}
...
//
function SAWSOAP_addReportToPage_getReportParams() {
	return this._reportParams;
}

SAWSOAP_addReportToPage.prototype.getReportParams = SAWSOAP_addReportToPage_getReportParams;

function SAWSOAP_addReportToPage_setReportParams(value) {
	this._reportParams = value;
}
...
//
function SAWSOAP_addReportToPage_getOptions() {
	return this._options;
}

SAWSOAP_addReportToPage.prototype.getOptions = SAWSOAP_addReportToPage_getOptions;

function SAWSOAP_addReportToPage_setOptions(value) {
	this._options = value;
}
...
//
function SAWSOAP_addReportToPage_getSessionID() {
	return this._sessionID;
}

SAWSOAP_addReportToPage.prototype.getSessionID = SAWSOAP_addReportToPage_getSessionID;

function SAWSOAP_addReportToPage_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_addReportToPage_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_getAccounts_getAccount() {
	return this._account;
}

SAWSOAP_getAccounts.prototype.getAccount = SAWSOAP_getAccounts_getAccount;

function SAWSOAP_getAccounts_setAccount(value) {
	this._account = value;
}
...
//
function SAWSOAP_getAccounts_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getAccounts.prototype.getSessionID = SAWSOAP_getAccounts_getSessionID;

function SAWSOAP_getAccounts_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}applyReportParams
//
...
//
function SAWSOAP_applyReportParams_getReportRef() {
	return this._reportRef;
}

SAWSOAP_applyReportParams.prototype.getReportRef = SAWSOAP_applyReportParams_getReportRef;

function SAWSOAP_applyReportParams_setReportRef(value) {
	this._reportRef = value;
}
...
//
function SAWSOAP_applyReportParams_getReportParams() {
	return this._reportParams;
}

SAWSOAP_applyReportParams.prototype.getReportParams = SAWSOAP_applyReportParams_getReportParams;

function SAWSOAP_applyReportParams_setReportParams(value) {
	this._reportParams = value;
}
...
//
function SAWSOAP_applyReportParams_getEncodeInString() {
	return this._encodeInString;
}

SAWSOAP_applyReportParams.prototype.getEncodeInString = SAWSOAP_applyReportParams_getEncodeInString;

function SAWSOAP_applyReportParams_setEncodeInString(value) {
	this._encodeInString = value;
}
...
//
function SAWSOAP_applyReportParams_getSessionID() {
	return this._sessionID;
}

SAWSOAP_applyReportParams.prototype.getSessionID = SAWSOAP_applyReportParams_getSessionID;

function SAWSOAP_applyReportParams_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_applyReportParams_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
	...
	{
		xml = xml
				+ this._reportParams.serialize(cxfjsutils, 'jns0:reportParams',
						null);
	}
	// block for local variables
	{
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}deleteItemResult
//
...
//
function SAWSOAP_deleteItemResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_purgeCache_getSegmentPath() {
	return this._segmentPath;
}

SAWSOAP_purgeCache.prototype.getSegmentPath = SAWSOAP_purgeCache_getSegmentPath;

function SAWSOAP_purgeCache_setSegmentPath(value) {
	this._segmentPath = value;
}
...
//
function SAWSOAP_purgeCache_getTreePath() {
	return this._treePath;
}

SAWSOAP_purgeCache.prototype.getTreePath = SAWSOAP_purgeCache_getTreePath;

function SAWSOAP_purgeCache_setTreePath(value) {
	this._treePath = value;
}
...
//
function SAWSOAP_purgeCache_getIgnoreCacheRef() {
	return this._ignoreCacheRef;
}

SAWSOAP_purgeCache.prototype.getIgnoreCacheRef = SAWSOAP_purgeCache_getIgnoreCacheRef;

function SAWSOAP_purgeCache_setIgnoreCacheRef(value) {
	this._ignoreCacheRef = value;
}
...
//
function SAWSOAP_purgeCache_getSessionID() {
	return this._sessionID;
}

SAWSOAP_purgeCache.prototype.getSessionID = SAWSOAP_purgeCache_getSessionID;

function SAWSOAP_purgeCache_setSessionID(value) {
	this._sessionID = value;
}
...
function SAWSOAP_purgeCache_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'ignoreCacheRef')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = (value == 'true');
...
//
function SAWSOAP_unsubscribe_getPath() {
	return this._path;
}

SAWSOAP_unsubscribe.prototype.getPath = SAWSOAP_unsubscribe_getPath;

function SAWSOAP_unsubscribe_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_unsubscribe_getSessionID() {
	return this._sessionID;
}

SAWSOAP_unsubscribe.prototype.getSessionID = SAWSOAP_unsubscribe_getSessionID;

function SAWSOAP_unsubscribe_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getCountsResult
//
...
//
function SAWSOAP_getCountsResult_getJobInfo() {
	return this._jobInfo;
}

SAWSOAP_getCountsResult.prototype.getJobInfo = SAWSOAP_getCountsResult_getJobInfo;

function SAWSOAP_getCountsResult_setJobInfo(value) {
	this._jobInfo = value;
}
...
//
function SAWSOAP_getCountsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}prepareCacheResult
//
...
//
function SAWSOAP_prepareCacheResult_getJobInfo() {
	return this._jobInfo;
}

SAWSOAP_prepareCacheResult.prototype.getJobInfo = SAWSOAP_prepareCacheResult_getJobInfo;

function SAWSOAP_prepareCacheResult_setJobInfo(value) {
	this._jobInfo = value;
}
...
//
function SAWSOAP_prepareCacheResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_getCurUser_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getCurUser.prototype.getSessionID = SAWSOAP_getCurUser_getSessionID;

function SAWSOAP_getCurUser_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}moveItemResult
//
...
//
function SAWSOAP_moveItemResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}applyReportDefaultsResult
//
...
// element set for reportXml
// setter function is is
// SAWSOAP_applyReportDefaultsResult.prototype.setReportXml
//
function SAWSOAP_applyReportDefaultsResult_getReportXml() {
	return this._reportXml;
}

SAWSOAP_applyReportDefaultsResult.prototype.getReportXml = SAWSOAP_applyReportDefaultsResult_getReportXml;

function SAWSOAP_applyReportDefaultsResult_setReportXml(value) {
	this._reportXml = value;
}
...
//
function SAWSOAP_applyReportDefaultsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_startPage_getOptions() {
	return this._options;
}

SAWSOAP_startPage.prototype.getOptions = SAWSOAP_startPage_getOptions;

function SAWSOAP_startPage_setOptions(value) {
	this._options = value;
}
...
//
function SAWSOAP_startPage_getSessionID() {
	return this._sessionID;
}

SAWSOAP_startPage.prototype.getSessionID = SAWSOAP_startPage_getSessionID;

function SAWSOAP_startPage_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}describeColumn
//
...
//
function SAWSOAP_describeColumn_getSubjectAreaName() {
	return this._subjectAreaName;
}

SAWSOAP_describeColumn.prototype.getSubjectAreaName = SAWSOAP_describeColumn_getSubjectAreaName;

function SAWSOAP_describeColumn_setSubjectAreaName(value) {
	this._subjectAreaName = value;
}
...
//
function SAWSOAP_describeColumn_getTableName() {
	return this._tableName;
}

SAWSOAP_describeColumn.prototype.getTableName = SAWSOAP_describeColumn_getTableName;

function SAWSOAP_describeColumn_setTableName(value) {
	this._tableName = value;
}
...
//
function SAWSOAP_describeColumn_getColumnName() {
	return this._columnName;
}

SAWSOAP_describeColumn.prototype.getColumnName = SAWSOAP_describeColumn_getColumnName;

function SAWSOAP_describeColumn_setColumnName(value) {
...
//
function SAWSOAP_describeColumn_getSessionID() {
	return this._sessionID;
}

SAWSOAP_describeColumn.prototype.getSessionID = SAWSOAP_describeColumn_getSessionID;

function SAWSOAP_describeColumn_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_describeColumn_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_logon_getName() {
	return this._name;
}

SAWSOAP_logon.prototype.getName = SAWSOAP_logon_getName;

function SAWSOAP_logon_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_logon_getPassword() {
	return this._password;
}

SAWSOAP_logon.prototype.getPassword = SAWSOAP_logon_getPassword;

function SAWSOAP_logon_setPassword(value) {
	this._password = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}saveResultSetResult
//
...
//
function SAWSOAP_saveResultSetResult_getJobInfo() {
	return this._jobInfo;
}

SAWSOAP_saveResultSetResult.prototype.getJobInfo = SAWSOAP_saveResultSetResult_getJobInfo;

function SAWSOAP_saveResultSetResult_setJobInfo(value) {
	this._jobInfo = value;
}
...
//
function SAWSOAP_saveResultSetResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getSubItemsResult
//
...
//
function SAWSOAP_getSubItemsResult_getItemInfo() {
	return this._itemInfo;
}

SAWSOAP_getSubItemsResult.prototype.getItemInfo = SAWSOAP_getSubItemsResult_getItemInfo;

function SAWSOAP_getSubItemsResult_setItemInfo(value) {
	this._itemInfo = value;
}
...
//
function SAWSOAP_getSubItemsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._itemInfo != null) {
			for (var ax = 0; ax < this._itemInfo.length; ax++) {
				if (this._itemInfo[ax] == null) {
					...
					xml = xml
							+ this._itemInfo[ax].serialize(cxfjsutils,
									'jns0:itemInfo', null);
				}
			}
		}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getConditionCustomizableReportElementsResult
//
...
//
// accessor is
// SAWSOAP_getConditionCustomizableReportElementsResult.prototype.getCustomizableElement
...
// setter function is is
// SAWSOAP_getConditionCustomizableReportElementsResult.prototype.setCustomizableElement
//
function SAWSOAP_getConditionCustomizableReportElementsResult_getCustomizableElement() {
	return this._customizableElement;
}
...
function SAWSOAP_getConditionCustomizableReportElementsResult_setCustomizableElement(
		value) {
	this._customizableElement = value;
}
...
// {urn://oracle.bi.webservices/v6}getConditionCustomizableReportElementsResult
//
function SAWSOAP_getConditionCustomizableReportElementsResult_serialize(
		...
		if (this._customizableElement != null) {
			for (var ax = 0; ax < this._customizableElement.length; ax++) {
				if (this._customizableElement[ax] == null) {
					...
					xml = xml
							+ cxfjsutils
									.escapeXmlEntities(this._customizableElement[ax]);
					xml = xml + '</jns0:customizableElement>';
				}
			}
		}
...
function SAWSOAP_getConditionCustomizableReportElementsResult_deserialize(
		cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'customizableElement')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}applyReportParamsResult
//
...
//
function SAWSOAP_applyReportParamsResult_getReturn() {
	return this._return;
}

SAWSOAP_applyReportParamsResult.prototype.getReturn = SAWSOAP_applyReportParamsResult_getReturn;

function SAWSOAP_applyReportParamsResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_applyReportParamsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
	...
	// block for local variables
	{
		...
		if (anyHolder != null) {
			...
			if (anySerializer) {
				xml = xml
						+ this._return.serialize(cxfjsutils, 'jns0:return',
								typeAttr);
			} else {
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}joinGroupsResult
//
...
//
function SAWSOAP_joinGroupsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_setOwnership_getPath() {
	return this._path;
}

SAWSOAP_setOwnership.prototype.getPath = SAWSOAP_setOwnership_getPath;

function SAWSOAP_setOwnership_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_setOwnership_getOwner() {
	return this._owner;
}

SAWSOAP_setOwnership.prototype.getOwner = SAWSOAP_setOwnership_getOwner;

function SAWSOAP_setOwnership_setOwner(value) {
	this._owner = value;
}
...
//
function SAWSOAP_setOwnership_getRecursive() {
	return this._recursive;
}

SAWSOAP_setOwnership.prototype.getRecursive = SAWSOAP_setOwnership_getRecursive;

function SAWSOAP_setOwnership_setRecursive(value) {
	this._recursive = value;
}
...
//
function SAWSOAP_setOwnership_getSessionID() {
	return this._sessionID;
}

SAWSOAP_setOwnership.prototype.getSessionID = SAWSOAP_setOwnership_getSessionID;

function SAWSOAP_setOwnership_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_setOwnership_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
function SAWSOAP_setOwnership_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'path')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_fetchNext_getQueryID() {
	return this._queryID;
}

SAWSOAP_fetchNext.prototype.getQueryID = SAWSOAP_fetchNext_getQueryID;

function SAWSOAP_fetchNext_setQueryID(value) {
	this._queryID = value;
}
...
//
function SAWSOAP_fetchNext_getSessionID() {
	return this._sessionID;
}

SAWSOAP_fetchNext.prototype.getSessionID = SAWSOAP_fetchNext_getSessionID;

function SAWSOAP_fetchNext_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_impersonateex_getName() {
	return this._name;
}

SAWSOAP_impersonateex.prototype.getName = SAWSOAP_impersonateex_getName;

function SAWSOAP_impersonateex_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_impersonateex_getPassword() {
	return this._password;
}

SAWSOAP_impersonateex.prototype.getPassword = SAWSOAP_impersonateex_getPassword;

function SAWSOAP_impersonateex_setPassword(value) {
	this._password = value;
}
...
//
function SAWSOAP_impersonateex_getImpersonateID() {
	return this._impersonateID;
}

SAWSOAP_impersonateex.prototype.getImpersonateID = SAWSOAP_impersonateex_getImpersonateID;

function SAWSOAP_impersonateex_setImpersonateID(value) {
	this._impersonateID = value;
}
...
//
function SAWSOAP_impersonateex_getSessionparams() {
	return this._sessionparams;
}

SAWSOAP_impersonateex.prototype.getSessionparams = SAWSOAP_impersonateex_getSessionparams;

function SAWSOAP_impersonateex_setSessionparams(value) {
	this._sessionparams = value;
}
...
//
function SAWSOAP_impersonateex_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}evaluateConditionResult
//
...
// element set for conditionIsTrue
// setter function is is
// SAWSOAP_evaluateConditionResult.prototype.setConditionIsTrue
//
function SAWSOAP_evaluateConditionResult_getConditionIsTrue() {
	return this._conditionIsTrue;
}

SAWSOAP_evaluateConditionResult.prototype.getConditionIsTrue = SAWSOAP_evaluateConditionResult_getConditionIsTrue;

function SAWSOAP_evaluateConditionResult_setConditionIsTrue(value) {
	this._conditionIsTrue = value;
}
...
//
function SAWSOAP_evaluateConditionResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}setItemProperty
//
...
//
function SAWSOAP_setItemProperty_getPath() {
	return this._path;
}

SAWSOAP_setItemProperty.prototype.getPath = SAWSOAP_setItemProperty_getPath;

function SAWSOAP_setItemProperty_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_setItemProperty_getName() {
	return this._name;
}

SAWSOAP_setItemProperty.prototype.getName = SAWSOAP_setItemProperty_getName;

function SAWSOAP_setItemProperty_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_setItemProperty_getValue() {
	return this._value;
}

SAWSOAP_setItemProperty.prototype.getValue = SAWSOAP_setItemProperty_getValue;

function SAWSOAP_setItemProperty_setValue(value) {
	this._value = value;
}
...
//
function SAWSOAP_setItemProperty_getRecursive() {
	return this._recursive;
}

SAWSOAP_setItemProperty.prototype.getRecursive = SAWSOAP_setItemProperty_getRecursive;

function SAWSOAP_setItemProperty_setRecursive(value) {
	this._recursive = value;
}
...
//
function SAWSOAP_setItemProperty_getSessionID() {
	return this._sessionID;
}

SAWSOAP_setItemProperty.prototype.getSessionID = SAWSOAP_setItemProperty_getSessionID;

function SAWSOAP_setItemProperty_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_setItemProperty_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
function SAWSOAP_setItemProperty_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'value')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getHtmlForPageWithOneReportResult
//
...
// element set for return
// setter function is is
// SAWSOAP_getHtmlForPageWithOneReportResult.prototype.setReturn
//
function SAWSOAP_getHtmlForPageWithOneReportResult_getReturn() {
	return this._return;
}

SAWSOAP_getHtmlForPageWithOneReportResult.prototype.getReturn = SAWSOAP_getHtmlForPageWithOneReportResult_getReturn;

function SAWSOAP_getHtmlForPageWithOneReportResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_getHtmlForPageWithOneReportResult_serialize(cxfjsutils,
		elementName, extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
function SAWSOAP_getHtmlForPageWithOneReportResult_deserialize(cxfjsutils,
		element) {
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}describeSubjectAreaResult
//
...
// element set for subjectArea
// setter function is is
// SAWSOAP_describeSubjectAreaResult.prototype.setSubjectArea
//
function SAWSOAP_describeSubjectAreaResult_getSubjectArea() {
	return this._subjectArea;
}

SAWSOAP_describeSubjectAreaResult.prototype.getSubjectArea = SAWSOAP_describeSubjectAreaResult_getSubjectArea;

function SAWSOAP_describeSubjectAreaResult_setSubjectArea(value) {
	this._subjectArea = value;
}
...
//
function SAWSOAP_describeSubjectAreaResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
	...
	{
		xml = xml
				+ this._subjectArea.serialize(cxfjsutils, 'jns0:subjectArea',
						null);
	}
	if (elementName !== null) {
		xml = xml + '</';
...
//
function SAWSOAP_copyItem_getPathSrc() {
	return this._pathSrc;
}

SAWSOAP_copyItem.prototype.getPathSrc = SAWSOAP_copyItem_getPathSrc;

function SAWSOAP_copyItem_setPathSrc(value) {
	this._pathSrc = value;
}
...
//
function SAWSOAP_copyItem_getPathDest() {
	return this._pathDest;
}

SAWSOAP_copyItem.prototype.getPathDest = SAWSOAP_copyItem_getPathDest;

function SAWSOAP_copyItem_setPathDest(value) {
	this._pathDest = value;
}
...
//
function SAWSOAP_copyItem_getFlagACL() {
	return this._flagACL;
}

SAWSOAP_copyItem.prototype.getFlagACL = SAWSOAP_copyItem_getFlagACL;

function SAWSOAP_copyItem_setFlagACL(value) {
	this._flagACL = value;
}
...
//
function SAWSOAP_copyItem_getSessionID() {
	return this._sessionID;
}

SAWSOAP_copyItem.prototype.getSessionID = SAWSOAP_copyItem_getSessionID;

function SAWSOAP_copyItem_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}pasteItem2Result
//
...
//
function SAWSOAP_pasteItem2Result_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}startPageResult
//
...
//
function SAWSOAP_startPageResult_getReturn() {
	return this._return;
}

SAWSOAP_startPageResult.prototype.getReturn = SAWSOAP_startPageResult_getReturn;

function SAWSOAP_startPageResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_startPageResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getSessionEnvironment
//
...
//
function SAWSOAP_getSessionEnvironment_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getSessionEnvironment.prototype.getSessionID = SAWSOAP_getSessionEnvironment_getSessionID;

function SAWSOAP_getSessionEnvironment_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getSessionEnvironment_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_cancelQuery_getQueryID() {
	return this._queryID;
}

SAWSOAP_cancelQuery.prototype.getQueryID = SAWSOAP_cancelQuery_getQueryID;

function SAWSOAP_cancelQuery_setQueryID(value) {
	this._queryID = value;
}
...
//
function SAWSOAP_cancelQuery_getSessionID() {
	return this._sessionID;
}

SAWSOAP_cancelQuery.prototype.getSessionID = SAWSOAP_cancelQuery_getSessionID;

function SAWSOAP_cancelQuery_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getPromptedFiltersResult
//
...
// setter function is is
// SAWSOAP_getPromptedFiltersResult.prototype.setPromptedFilter
//
function SAWSOAP_getPromptedFiltersResult_getPromptedFilter() {
...
function SAWSOAP_getPromptedFiltersResult_setPromptedFilter(value) {
	this._promptedFilter = value;
}
...
//
function SAWSOAP_getPromptedFiltersResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._promptedFilter != null) {
			for (var ax = 0; ax < this._promptedFilter.length; ax++) {
				if (this._promptedFilter[ax] == null) {
					...
					xml = xml
							+ cxfjsutils
									.escapeXmlEntities(this._promptedFilter[ax]);
					xml = xml + '</jns0:promptedFilter>';
				}
			}
		}
...
function SAWSOAP_getPromptedFiltersResult_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'promptedFilter')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_subscribe_getPath() {
	return this._path;
}

SAWSOAP_subscribe.prototype.getPath = SAWSOAP_subscribe_getPath;

function SAWSOAP_subscribe_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_subscribe_getCustomizationXml() {
	return this._customizationXml;
}

SAWSOAP_subscribe.prototype.getCustomizationXml = SAWSOAP_subscribe_getCustomizationXml;

function SAWSOAP_subscribe_setCustomizationXml(value) {
	this._customizationXml = value;
}
...
//
function SAWSOAP_subscribe_getSessionID() {
	return this._sessionID;
}

SAWSOAP_subscribe.prototype.getSessionID = SAWSOAP_subscribe_getSessionID;

function SAWSOAP_subscribe_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getPrivilegesStatus
//
...
//
function SAWSOAP_getPrivilegesStatus_getPrivileges() {
	return this._privileges;
}

SAWSOAP_getPrivilegesStatus.prototype.getPrivileges = SAWSOAP_getPrivilegesStatus_getPrivileges;

function SAWSOAP_getPrivilegesStatus_setPrivileges(value) {
...
//
function SAWSOAP_getPrivilegesStatus_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getPrivilegesStatus.prototype.getSessionID = SAWSOAP_getPrivilegesStatus_getSessionID;

function SAWSOAP_getPrivilegesStatus_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getPrivilegesStatus_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._privileges != null) {
			for (var ax = 0; ax < this._privileges.length; ax++) {
				if (this._privileges[ax] == null) {
					...
					xml = xml
							+ cxfjsutils
									.escapeXmlEntities(this._privileges[ax]);
					xml = xml + '</jns0:privileges>';
				}
			}
		}
...
function SAWSOAP_getPrivilegesStatus_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'privileges')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}readObjectsResult
//
...
//
function SAWSOAP_readObjectsResult_getCatalogObject() {
	return this._catalogObject;
}

SAWSOAP_readObjectsResult.prototype.getCatalogObject = SAWSOAP_readObjectsResult_getCatalogObject;

function SAWSOAP_readObjectsResult_setCatalogObject(value) {
	this._catalogObject = value;
}
...
//
function SAWSOAP_readObjectsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._catalogObject != null) {
			for (var ax = 0; ax < this._catalogObject.length; ax++) {
				if (this._catalogObject[ax] == null) {
					...
					xml = xml
							+ this._catalogObject[ax].serialize(cxfjsutils,
									'jns0:catalogObject', null);
				}
			}
		}
	}
...
function SAWSOAP_readObjectsResult_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
		...
		do {
			...
			var value = null;
			if (!cxfjsutils.isElementNil(curElement)) {
				arrayItem = SAWSOAP_CatalogObject_deserialize(cxfjsutils,
						curElement);
			}
			item.push(arrayItem);
			curElement = cxfjsutils.getNextElementSibling(curElement);
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}setOwnershipResult
//
...
//
function SAWSOAP_setOwnershipResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}markForReplicationResult
//
...
//
function SAWSOAP_markForReplicationResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}writeIBotResult
//
...
//
function SAWSOAP_writeIBotResult_getJobID() {
	return this._jobID;
}

SAWSOAP_writeIBotResult.prototype.getJobID = SAWSOAP_writeIBotResult_getJobID;

function SAWSOAP_writeIBotResult_setJobID(value) {
	this._jobID = value;
}
...
//
function SAWSOAP_writeIBotResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getAccountsResult
//
...
//
function SAWSOAP_getAccountsResult_getAccountDetails() {
...
function SAWSOAP_getAccountsResult_setAccountDetails(value) {
...
//
function SAWSOAP_getAccountsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._accountDetails != null) {
			for (var ax = 0; ax < this._accountDetails.length; ax++) {
				if (this._accountDetails[ax] == null) {
					...
					xml = xml
							+ this._accountDetails[ax].serialize(cxfjsutils,
									'jns0:accountDetails', null);
				}
			}
		}
	}
...
function SAWSOAP_getAccountsResult_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'accountDetails')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_logoffResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}subscribeResult
//
...
//
function SAWSOAP_subscribeResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_getItemInfo_getPath() {
	return this._path;
}

SAWSOAP_getItemInfo.prototype.getPath = SAWSOAP_getItemInfo_getPath;

function SAWSOAP_getItemInfo_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_getItemInfo_getResolveLinks() {
	return this._resolveLinks;
}

SAWSOAP_getItemInfo.prototype.getResolveLinks = SAWSOAP_getItemInfo_getResolveLinks;

function SAWSOAP_getItemInfo_setResolveLinks(value) {
	this._resolveLinks = value;
}
...
//
function SAWSOAP_getItemInfo_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getItemInfo.prototype.getSessionID = SAWSOAP_getItemInfo_getSessionID;

function SAWSOAP_getItemInfo_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_logonexResult_getReturn() {
	return this._return;
}

SAWSOAP_logonexResult.prototype.getReturn = SAWSOAP_logonexResult_getReturn;

function SAWSOAP_logonexResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_logonexResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}executeSQLQueryResult
//
...
//
function SAWSOAP_executeSQLQueryResult_getReturn() {
	return this._return;
}

SAWSOAP_executeSQLQueryResult.prototype.getReturn = SAWSOAP_executeSQLQueryResult_getReturn;

function SAWSOAP_executeSQLQueryResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_executeSQLQueryResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getSessionEnvironmentResult
//
...
//
function SAWSOAP_getSessionEnvironmentResult_getReturn() {
	return this._return;
}

SAWSOAP_getSessionEnvironmentResult.prototype.getReturn = SAWSOAP_getSessionEnvironmentResult_getReturn;

function SAWSOAP_getSessionEnvironmentResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_getSessionEnvironmentResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}setItemAttributesResult
//
...
//
function SAWSOAP_setItemAttributesResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}describeColumnResult
//
...
//
function SAWSOAP_describeColumnResult_getColumn() {
	return this._column;
}

SAWSOAP_describeColumnResult.prototype.getColumn = SAWSOAP_describeColumnResult_getColumn;

function SAWSOAP_describeColumnResult_setColumn(value) {
	this._column = value;
}
...
//
function SAWSOAP_describeColumnResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}evaluateInlineCondition
//
...
// setter function is is
// SAWSOAP_evaluateInlineCondition.prototype.setConditionXML
//
function SAWSOAP_evaluateInlineCondition_getConditionXML() {
	return this._conditionXML;
}

SAWSOAP_evaluateInlineCondition.prototype.getConditionXML = SAWSOAP_evaluateInlineCondition_getConditionXML;

function SAWSOAP_evaluateInlineCondition_setConditionXML(value) {
	this._conditionXML = value;
}

SAWSOAP_evaluateInlineCondition.prototype.setConditionXML = SAWSOAP_evaluateInlineCondition_setConditionXML;
//
// accessor is
// SAWSOAP_evaluateInlineCondition.prototype.getReportCustomizationParameters
// element get for reportCustomizationParameters
// - element type is {http://www.w3.org/2001/XMLSchema}string
// - required element
// - array
...
// element set for reportCustomizationParameters
// setter function is is
// SAWSOAP_evaluateInlineCondition.prototype.setReportCustomizationParameters
//
function SAWSOAP_evaluateInlineCondition_getReportCustomizationParameters() {
	return this._reportCustomizationParameters;
}
...
function SAWSOAP_evaluateInlineCondition_setReportCustomizationParameters(value) {
	this._reportCustomizationParameters = value;
}
...
//
function SAWSOAP_evaluateInlineCondition_getSessionID() {
	return this._sessionID;
}

SAWSOAP_evaluateInlineCondition.prototype.getSessionID = SAWSOAP_evaluateInlineCondition_getSessionID;

function SAWSOAP_evaluateInlineCondition_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_evaluateInlineCondition_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}executeSQLQuery
//
...
//
function SAWSOAP_executeSQLQuery_getSql() {
	return this._sql;
}

SAWSOAP_executeSQLQuery.prototype.getSql = SAWSOAP_executeSQLQuery_getSql;

function SAWSOAP_executeSQLQuery_setSql(value) {
	this._sql = value;
}
...
//
function SAWSOAP_executeSQLQuery_getOutputFormat() {
	return this._outputFormat;
}

SAWSOAP_executeSQLQuery.prototype.getOutputFormat = SAWSOAP_executeSQLQuery_getOutputFormat;

function SAWSOAP_executeSQLQuery_setOutputFormat(value) {
	this._outputFormat = value;
}
...
//
function SAWSOAP_executeSQLQuery_getExecutionOptions() {
	return this._executionOptions;
}

SAWSOAP_executeSQLQuery.prototype.getExecutionOptions = SAWSOAP_executeSQLQuery_getExecutionOptions;

function SAWSOAP_executeSQLQuery_setExecutionOptions(value) {
	this._executionOptions = value;
}
...
//
function SAWSOAP_executeSQLQuery_getSessionID() {
	return this._sessionID;
}

SAWSOAP_executeSQLQuery.prototype.getSessionID = SAWSOAP_executeSQLQuery_getSessionID;

function SAWSOAP_executeSQLQuery_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_executeSQLQuery_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getMembersResult
//
...
//
function SAWSOAP_getMembersResult_getAccount() {
	return this._account;
}

SAWSOAP_getMembersResult.prototype.getAccount = SAWSOAP_getMembersResult_getAccount;

function SAWSOAP_getMembersResult_setAccount(value) {
	this._account = value;
}
...
//
function SAWSOAP_getMembersResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getSessionVariablesResult
//
...
//
function SAWSOAP_getSessionVariablesResult_getReturn() {
	return this._return;
}

SAWSOAP_getSessionVariablesResult.prototype.getReturn = SAWSOAP_getSessionVariablesResult_getReturn;

function SAWSOAP_getSessionVariablesResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_getSessionVariablesResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getPromptedColumnsResult
//
...
// setter function is is
// SAWSOAP_getPromptedColumnsResult.prototype.setColumnInfo
//
function SAWSOAP_getPromptedColumnsResult_getColumnInfo() {
	return this._ColumnInfo;
}

SAWSOAP_getPromptedColumnsResult.prototype.getColumnInfo = SAWSOAP_getPromptedColumnsResult_getColumnInfo;

function SAWSOAP_getPromptedColumnsResult_setColumnInfo(value) {
...
//
function SAWSOAP_getPromptedColumnsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
	...
	{
		xml = xml
				+ this._ColumnInfo.serialize(cxfjsutils, 'jns0:ColumnInfo',
						null);
	}
	if (elementName !== null) {
		xml = xml + '</';
...
//
function SAWSOAP_import_getFilename() {
	return this._filename;
}

SAWSOAP_import.prototype.getFilename = SAWSOAP_import_getFilename;

function SAWSOAP_import_setFilename(value) {
...
//
function SAWSOAP_import_getFlag() {
	return this._flag;
}

SAWSOAP_import.prototype.getFlag = SAWSOAP_import_getFlag;

function SAWSOAP_import_setFlag(value) {
	this._flag = value;
}
...
//
function SAWSOAP_import_getLastPurgedLog() {
	return this._lastPurgedLog;
}

SAWSOAP_import.prototype.getLastPurgedLog = SAWSOAP_import_getLastPurgedLog;

function SAWSOAP_import_setLastPurgedLog(value) {
	this._lastPurgedLog = value;
}
...
//
function SAWSOAP_import_getUpdateReplicationLog() {
	return this._updateReplicationLog;
}

SAWSOAP_import.prototype.getUpdateReplicationLog = SAWSOAP_import_getUpdateReplicationLog;

function SAWSOAP_import_setUpdateReplicationLog(value) {
	this._updateReplicationLog = value;
}
...
//
function SAWSOAP_import_getReturnErrors() {
	return this._returnErrors;
}

SAWSOAP_import.prototype.getReturnErrors = SAWSOAP_import_getReturnErrors;

function SAWSOAP_import_setReturnErrors(value) {
	this._returnErrors = value;
}
...
//
function SAWSOAP_import_getFilter() {
	return this._filter;
}

SAWSOAP_import.prototype.getFilter = SAWSOAP_import_getFilter;

function SAWSOAP_import_setFilter(value) {
	this._filter = value;
}
...
//
function SAWSOAP_import_getSessionID() {
	return this._sessionID;
}

SAWSOAP_import.prototype.getSessionID = SAWSOAP_import_getSessionID;

function SAWSOAP_import_setSessionID(value) {
	this._sessionID = value;
}
...
function SAWSOAP_import_serialize(cxfjsutils, elementName, extraNamespaces) {
	...
	// block for local variables
	{
		if (this._pathMap == null) {
			...
			xml = xml
					+ this._pathMap.serialize(cxfjsutils, 'jns0:pathMap', null);
		}
	}
	// block for local variables
	{
...
//
function SAWSOAP_getJobInfo_getJobID() {
	return this._jobID;
}

SAWSOAP_getJobInfo.prototype.getJobID = SAWSOAP_getJobInfo_getJobID;

function SAWSOAP_getJobInfo_setJobID(value) {
	this._jobID = value;
}
...
//
function SAWSOAP_getJobInfo_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getJobInfo.prototype.getSessionID = SAWSOAP_getJobInfo_getSessionID;

function SAWSOAP_getJobInfo_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_leaveGroups_getGroup() {
	return this._group;
}

SAWSOAP_leaveGroups.prototype.getGroup = SAWSOAP_leaveGroups_getGroup;

function SAWSOAP_leaveGroups_setGroup(value) {
	this._group = value;
}
...
//
function SAWSOAP_leaveGroups_getMember() {
	return this._member;
}

SAWSOAP_leaveGroups.prototype.getMember = SAWSOAP_leaveGroups_getMember;

function SAWSOAP_leaveGroups_setMember(value) {
	this._member = value;
}
...
//
function SAWSOAP_leaveGroups_getSessionID() {
	return this._sessionID;
}

SAWSOAP_leaveGroups.prototype.getSessionID = SAWSOAP_leaveGroups_getSessionID;

function SAWSOAP_leaveGroups_setSessionID(value) {
	this._sessionID = value;
}
		...
		if (this._group != null) {
			for (var ax = 0; ax < this._group.length; ax++) {
				if (this._group[ax] == null) {
					...
					xml = xml
							+ this._group[ax].serialize(cxfjsutils,
									'jns0:group', null);
				}
			}
		}
		...
		if (this._member != null) {
			for (var ax = 0; ax < this._member.length; ax++) {
				if (this._member[ax] == null) {
					...
					xml = xml
							+ this._member[ax].serialize(cxfjsutils,
									'jns0:member', null);
				}
			}
		}
...
function SAWSOAP_leaveGroups_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'member')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_moveIBot_getToPath() {
	return this._toPath;
}

SAWSOAP_moveIBot.prototype.getToPath = SAWSOAP_moveIBot_getToPath;

function SAWSOAP_moveIBot_setToPath(value) {
	this._toPath = value;
}
...
//
function SAWSOAP_moveIBot_getResolveLinks() {
	return this._resolveLinks;
}

SAWSOAP_moveIBot.prototype.getResolveLinks = SAWSOAP_moveIBot_getResolveLinks;

function SAWSOAP_moveIBot_setResolveLinks(value) {
	this._resolveLinks = value;
}
...
//
function SAWSOAP_moveIBot_getAllowOverwrite() {
	return this._allowOverwrite;
}

SAWSOAP_moveIBot.prototype.getAllowOverwrite = SAWSOAP_moveIBot_getAllowOverwrite;

function SAWSOAP_moveIBot_setAllowOverwrite(value) {
	this._allowOverwrite = value;
}
...
//
function SAWSOAP_moveIBot_getSessionID() {
	return this._sessionID;
}

SAWSOAP_moveIBot.prototype.getSessionID = SAWSOAP_moveIBot_getSessionID;

function SAWSOAP_moveIBot_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_deleteIBot_getPath() {
	return this._path;
}

SAWSOAP_deleteIBot.prototype.getPath = SAWSOAP_deleteIBot_getPath;

function SAWSOAP_deleteIBot_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_deleteIBot_getSessionID() {
	return this._sessionID;
}

SAWSOAP_deleteIBot.prototype.getSessionID = SAWSOAP_deleteIBot_getSessionID;

function SAWSOAP_deleteIBot_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_pasteItem2_getArchive() {
	return this._archive;
}

SAWSOAP_pasteItem2.prototype.getArchive = SAWSOAP_pasteItem2_getArchive;

function SAWSOAP_pasteItem2_setArchive(value) {
	this._archive = value;
}
...
//
function SAWSOAP_pasteItem2_getFlagACL() {
	return this._flagACL;
}

SAWSOAP_pasteItem2.prototype.getFlagACL = SAWSOAP_pasteItem2_getFlagACL;

function SAWSOAP_pasteItem2_setFlagACL(value) {
	this._flagACL = value;
}
...
//
function SAWSOAP_pasteItem2_getFlagOverwrite() {
	return this._flagOverwrite;
}

SAWSOAP_pasteItem2.prototype.getFlagOverwrite = SAWSOAP_pasteItem2_getFlagOverwrite;

function SAWSOAP_pasteItem2_setFlagOverwrite(value) {
	this._flagOverwrite = value;
}
...
//
function SAWSOAP_pasteItem2_getSessionID() {
	return this._sessionID;
}

SAWSOAP_pasteItem2.prototype.getSessionID = SAWSOAP_pasteItem2_getSessionID;

function SAWSOAP_pasteItem2_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}deleteResultSet
//
...
//
function SAWSOAP_deleteResultSet_getGUIDs() {
	return this._GUIDs;
}

SAWSOAP_deleteResultSet.prototype.getGUIDs = SAWSOAP_deleteResultSet_getGUIDs;

function SAWSOAP_deleteResultSet_setGUIDs(value) {
	this._GUIDs = value;
}
...
//
function SAWSOAP_deleteResultSet_getSegmentPath() {
	return this._segmentPath;
}

SAWSOAP_deleteResultSet.prototype.getSegmentPath = SAWSOAP_deleteResultSet_getSegmentPath;

function SAWSOAP_deleteResultSet_setSegmentPath(value) {
	this._segmentPath = value;
}
...
//
function SAWSOAP_deleteResultSet_getSessionID() {
	return this._sessionID;
}

SAWSOAP_deleteResultSet.prototype.getSessionID = SAWSOAP_deleteResultSet_getSessionID;

function SAWSOAP_deleteResultSet_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_deleteResultSet_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}cancelJobResult
//
...
//
function SAWSOAP_cancelJobResult_getJobInfo() {
	return this._jobInfo;
}

SAWSOAP_cancelJobResult.prototype.getJobInfo = SAWSOAP_cancelJobResult_getJobInfo;

function SAWSOAP_cancelJobResult_setJobInfo(value) {
	this._jobInfo = value;
}
...
//
function SAWSOAP_cancelJobResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}markForReplication
//
...
//
function SAWSOAP_markForReplication_getItem() {
	return this._item;
}

SAWSOAP_markForReplication.prototype.getItem = SAWSOAP_markForReplication_getItem;

function SAWSOAP_markForReplication_setItem(value) {
	this._item = value;
}
...
//
function SAWSOAP_markForReplication_getSessionID() {
	return this._sessionID;
}

SAWSOAP_markForReplication.prototype.getSessionID = SAWSOAP_markForReplication_getSessionID;

function SAWSOAP_markForReplication_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_markForReplication_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_removeFolder_getPath() {
	return this._path;
}

SAWSOAP_removeFolder.prototype.getPath = SAWSOAP_removeFolder_getPath;

function SAWSOAP_removeFolder_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_removeFolder_getRecursive() {
	return this._recursive;
}

SAWSOAP_removeFolder.prototype.getRecursive = SAWSOAP_removeFolder_getRecursive;

function SAWSOAP_removeFolder_setRecursive(value) {
	this._recursive = value;
}
...
//
function SAWSOAP_removeFolder_getSessionID() {
	return this._sessionID;
}

SAWSOAP_removeFolder.prototype.getSessionID = SAWSOAP_removeFolder_getSessionID;

function SAWSOAP_removeFolder_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_removeFolder_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}clearQueryCache
//
...
//
function SAWSOAP_clearQueryCache_getSessionID() {
	return this._sessionID;
}

SAWSOAP_clearQueryCache.prototype.getSessionID = SAWSOAP_clearQueryCache_getSessionID;

function SAWSOAP_clearQueryCache_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_clearQueryCache_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}updateCatalogItemACL
//
...
//
function SAWSOAP_updateCatalogItemACL_getPath() {
	return this._path;
}

SAWSOAP_updateCatalogItemACL.prototype.getPath = SAWSOAP_updateCatalogItemACL_getPath;

function SAWSOAP_updateCatalogItemACL_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_updateCatalogItemACL_getAcl() {
	return this._acl;
}

SAWSOAP_updateCatalogItemACL.prototype.getAcl = SAWSOAP_updateCatalogItemACL_getAcl;

function SAWSOAP_updateCatalogItemACL_setAcl(value) {
	this._acl = value;
}
...
//
function SAWSOAP_updateCatalogItemACL_getOptions() {
	return this._options;
}

SAWSOAP_updateCatalogItemACL.prototype.getOptions = SAWSOAP_updateCatalogItemACL_getOptions;

function SAWSOAP_updateCatalogItemACL_setOptions(value) {
	this._options = value;
}
...
//
function SAWSOAP_updateCatalogItemACL_getSessionID() {
	return this._sessionID;
}

SAWSOAP_updateCatalogItemACL.prototype.getSessionID = SAWSOAP_updateCatalogItemACL_getSessionID;

function SAWSOAP_updateCatalogItemACL_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_updateCatalogItemACL_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
function SAWSOAP_updateCatalogItemACL_deserialize(cxfjsutils, element) {
	...
	var value = null;
	if (!cxfjsutils.isElementNil(curElement)) {
		item = SAWSOAP_UpdateCatalogItemACLParams_deserialize(cxfjsutils,
				curElement);
	}
	newobject.setOptions(item);
	var item = null;
...
//
function SAWSOAP_getMembers_getGroup() {
	return this._group;
}

SAWSOAP_getMembers.prototype.getGroup = SAWSOAP_getMembers_getGroup;

function SAWSOAP_getMembers_setGroup(value) {
	this._group = value;
}
...
//
function SAWSOAP_getMembers_getExpandGroups() {
	return this._expandGroups;
}

SAWSOAP_getMembers.prototype.getExpandGroups = SAWSOAP_getMembers_getExpandGroups;

function SAWSOAP_getMembers_setExpandGroups(value) {
	this._expandGroups = value;
}
...
//
function SAWSOAP_getMembers_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getMembers.prototype.getSessionID = SAWSOAP_getMembers_getSessionID;

function SAWSOAP_getMembers_setSessionID(value) {
	this._sessionID = value;
}
...
function SAWSOAP_getMembers_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'expandGroups')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = (value == 'true');
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}deleteIBotResult
//
...
//
function SAWSOAP_deleteIBotResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}isMemberResult
//
...
//
function SAWSOAP_isMemberResult_getResult() {
	return this._result;
}

SAWSOAP_isMemberResult.prototype.getResult = SAWSOAP_isMemberResult_getResult;

function SAWSOAP_isMemberResult_setResult(value) {
	this._result = value;
}
...
//
function SAWSOAP_isMemberResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}writeListFiles
//
...
//
function SAWSOAP_writeListFiles_getReport() {
	return this._report;
}

SAWSOAP_writeListFiles.prototype.getReport = SAWSOAP_writeListFiles_getReport;

function SAWSOAP_writeListFiles_setReport(value) {
	this._report = value;
}
...
//
function SAWSOAP_writeListFiles_getReportParams() {
	return this._reportParams;
}

SAWSOAP_writeListFiles.prototype.getReportParams = SAWSOAP_writeListFiles_getReportParams;

function SAWSOAP_writeListFiles_setReportParams(value) {
	this._reportParams = value;
}
...
//
function SAWSOAP_writeListFiles_getSegmentPath() {
	return this._segmentPath;
}

SAWSOAP_writeListFiles.prototype.getSegmentPath = SAWSOAP_writeListFiles_getSegmentPath;

function SAWSOAP_writeListFiles_setSegmentPath(value) {
	this._segmentPath = value;
}
...
//
function SAWSOAP_writeListFiles_getTreeNodePath() {
	return this._treeNodePath;
}

SAWSOAP_writeListFiles.prototype.getTreeNodePath = SAWSOAP_writeListFiles_getTreeNodePath;

function SAWSOAP_writeListFiles_setTreeNodePath(value) {
	this._treeNodePath = value;
}
...
//
function SAWSOAP_writeListFiles_getSegmentationOptions() {
	return this._segmentationOptions;
}

SAWSOAP_writeListFiles.prototype.getSegmentationOptions = SAWSOAP_writeListFiles_getSegmentationOptions;

function SAWSOAP_writeListFiles_setSegmentationOptions(value) {
	this._segmentationOptions = value;
}
...
//
function SAWSOAP_writeListFiles_getFilesystem() {
	return this._filesystem;
}

SAWSOAP_writeListFiles.prototype.getFilesystem = SAWSOAP_writeListFiles_getFilesystem;

function SAWSOAP_writeListFiles_setFilesystem(value) {
...
//
function SAWSOAP_writeListFiles_getTimeout() {
	return this._timeout;
}

SAWSOAP_writeListFiles.prototype.getTimeout = SAWSOAP_writeListFiles_getTimeout;

function SAWSOAP_writeListFiles_setTimeout(value) {
	this._timeout = value;
}
...
//
function SAWSOAP_writeListFiles_getSessionID() {
	return this._sessionID;
}

SAWSOAP_writeListFiles.prototype.getSessionID = SAWSOAP_writeListFiles_getSessionID;

function SAWSOAP_writeListFiles_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_writeListFiles_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
	...
	// block for local variables
	{
		if (this._treeNodePath != null) {
			xml = xml
					+ this._treeNodePath.serialize(cxfjsutils,
							'jns0:treeNodePath', null);
		}
	}
	// block for local variables
	{
...
function SAWSOAP_writeListFiles_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'report')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			item = SAWSOAP_ReportRef_deserialize(cxfjsutils, curElement);
		}
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'reportParams')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			item = SAWSOAP_ReportParams_deserialize(cxfjsutils, curElement);
		}
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'treeNodePath')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getHtmlForPageWithOneReport
//
...
// element set for reportID
// setter function is is
// SAWSOAP_getHtmlForPageWithOneReport.prototype.setReportID
//
function SAWSOAP_getHtmlForPageWithOneReport_getReportID() {
	return this._reportID;
}

SAWSOAP_getHtmlForPageWithOneReport.prototype.getReportID = SAWSOAP_getHtmlForPageWithOneReport_getReportID;

function SAWSOAP_getHtmlForPageWithOneReport_setReportID(value) {
	this._reportID = value;
}
...
//
function SAWSOAP_getHtmlForPageWithOneReport_getReport() {
	return this._report;
}

SAWSOAP_getHtmlForPageWithOneReport.prototype.getReport = SAWSOAP_getHtmlForPageWithOneReport_getReport;

function SAWSOAP_getHtmlForPageWithOneReport_setReport(value) {
	this._report = value;
}
...
// element set for reportViewName
// setter function is is
// SAWSOAP_getHtmlForPageWithOneReport.prototype.setReportViewName
//
function SAWSOAP_getHtmlForPageWithOneReport_getReportViewName() {
	return this._reportViewName;
}

SAWSOAP_getHtmlForPageWithOneReport.prototype.getReportViewName = SAWSOAP_getHtmlForPageWithOneReport_getReportViewName;

function SAWSOAP_getHtmlForPageWithOneReport_setReportViewName(value) {
	this._reportViewName = value;
}
...
// element set for reportParams
// setter function is is
// SAWSOAP_getHtmlForPageWithOneReport.prototype.setReportParams
//
function SAWSOAP_getHtmlForPageWithOneReport_getReportParams() {
	return this._reportParams;
}

SAWSOAP_getHtmlForPageWithOneReport.prototype.getReportParams = SAWSOAP_getHtmlForPageWithOneReport_getReportParams;

function SAWSOAP_getHtmlForPageWithOneReport_setReportParams(value) {
	this._reportParams = value;
}
...
// setter function is is
// SAWSOAP_getHtmlForPageWithOneReport.prototype.setReportOptions
//
function SAWSOAP_getHtmlForPageWithOneReport_getReportOptions() {
...
function SAWSOAP_getHtmlForPageWithOneReport_setReportOptions(value) {
...
// setter function is is
// SAWSOAP_getHtmlForPageWithOneReport.prototype.setPageParams
//
function SAWSOAP_getHtmlForPageWithOneReport_getPageParams() {
...
function SAWSOAP_getHtmlForPageWithOneReport_setPageParams(value) {
...
// element set for sessionID
// setter function is is
// SAWSOAP_getHtmlForPageWithOneReport.prototype.setSessionID
//
function SAWSOAP_getHtmlForPageWithOneReport_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getHtmlForPageWithOneReport.prototype.getSessionID = SAWSOAP_getHtmlForPageWithOneReport_getSessionID;

function SAWSOAP_getHtmlForPageWithOneReport_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getHtmlForPageWithOneReport_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
	...
	// block for local variables
	{
		if (this._reportOptions == null) {
			...
			xml = xml
					+ this._reportOptions.serialize(cxfjsutils,
							'jns0:reportOptions', null);
		}
	}
	// block for local variables
	{
		if (this._pageParams == null) {
			...
			xml = xml
					+ this._pageParams.serialize(cxfjsutils, 'jns0:pageParams',
							null);
		}
	}
	// block for local variables
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getGlobalPrivilegesResult
//
...
// setter function is is
// SAWSOAP_getGlobalPrivilegesResult.prototype.setSawPrivileges
//
function SAWSOAP_getGlobalPrivilegesResult_getSawPrivileges() {
	return this._sawPrivileges;
}

SAWSOAP_getGlobalPrivilegesResult.prototype.getSawPrivileges = SAWSOAP_getGlobalPrivilegesResult_getSawPrivileges;

function SAWSOAP_getGlobalPrivilegesResult_setSawPrivileges(value) {
	this._sawPrivileges = value;
}
...
//
function SAWSOAP_getGlobalPrivilegesResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._sawPrivileges != null) {
			for (var ax = 0; ax < this._sawPrivileges.length; ax++) {
				if (this._sawPrivileges[ax] == null) {
					...
					xml = xml
							+ this._sawPrivileges[ax].serialize(cxfjsutils,
									'jns0:sawPrivileges', null);
				}
			}
		}
	}
...
function SAWSOAP_getGlobalPrivilegesResult_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'sawPrivileges')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
			if (!cxfjsutils.isElementNil(curElement)) {
				arrayItem = SAWSOAP_Privilege_deserialize(cxfjsutils,
						curElement);
			}
			item.push(arrayItem);
			curElement = cxfjsutils.getNextElementSibling(curElement);
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getGlobalPrivilegeACL
//
...
// setter function is is
// SAWSOAP_getGlobalPrivilegeACL.prototype.setPrivilegeName
//
function SAWSOAP_getGlobalPrivilegeACL_getPrivilegeName() {
...
function SAWSOAP_getGlobalPrivilegeACL_setPrivilegeName(value) {
...
//
function SAWSOAP_getGlobalPrivilegeACL_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getGlobalPrivilegeACL.prototype.getSessionID = SAWSOAP_getGlobalPrivilegeACL_getSessionID;

function SAWSOAP_getGlobalPrivilegeACL_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getGlobalPrivilegeACL_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getCommonBodyHtml
//
...
//
function SAWSOAP_getCommonBodyHtml_getPageID() {
	return this._pageID;
}

SAWSOAP_getCommonBodyHtml.prototype.getPageID = SAWSOAP_getCommonBodyHtml_getPageID;

function SAWSOAP_getCommonBodyHtml_setPageID(value) {
	this._pageID = value;
}
...
//
function SAWSOAP_getCommonBodyHtml_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getCommonBodyHtml.prototype.getSessionID = SAWSOAP_getCommonBodyHtml_getSessionID;

function SAWSOAP_getCommonBodyHtml_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getCommonBodyHtml_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}fetchNextResult
//
...
//
function SAWSOAP_fetchNextResult_getReturn() {
	return this._return;
}

SAWSOAP_fetchNextResult.prototype.getReturn = SAWSOAP_fetchNextResult_getReturn;

function SAWSOAP_fetchNextResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_fetchNextResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}copyItem2Result
//
...
//
function SAWSOAP_copyItem2Result_getArchive() {
	return this._archive;
}

SAWSOAP_copyItem2Result.prototype.getArchive = SAWSOAP_copyItem2Result_getArchive;

function SAWSOAP_copyItem2Result_setArchive(value) {
	this._archive = value;
}
...
//
function SAWSOAP_copyItem2Result_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getPromptedColumns
//
...
//
function SAWSOAP_getPromptedColumns_getSegmentPath() {
	return this._segmentPath;
}

SAWSOAP_getPromptedColumns.prototype.getSegmentPath = SAWSOAP_getPromptedColumns_getSegmentPath;

function SAWSOAP_getPromptedColumns_setSegmentPath(value) {
	this._segmentPath = value;
}
...
//
function SAWSOAP_getPromptedColumns_getTreePath() {
	return this._treePath;
}

SAWSOAP_getPromptedColumns.prototype.getTreePath = SAWSOAP_getPromptedColumns_getTreePath;

function SAWSOAP_getPromptedColumns_setTreePath(value) {
	this._treePath = value;
}
...
//
function SAWSOAP_getPromptedColumns_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getPromptedColumns.prototype.getSessionID = SAWSOAP_getPromptedColumns_getSessionID;

function SAWSOAP_getPromptedColumns_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getPromptedColumns_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_exportResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}keepAliveResult
//
...
//
function SAWSOAP_keepAliveResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_impersonate_getName() {
	return this._name;
}

SAWSOAP_impersonate.prototype.getName = SAWSOAP_impersonate_getName;

function SAWSOAP_impersonate_setName(value) {
	this._name = value;
}
...
//
function SAWSOAP_impersonate_getPassword() {
	return this._password;
}

SAWSOAP_impersonate.prototype.getPassword = SAWSOAP_impersonate_getPassword;

function SAWSOAP_impersonate_setPassword(value) {
	this._password = value;
}
...
//
function SAWSOAP_impersonate_getImpersonateID() {
	return this._impersonateID;
}

SAWSOAP_impersonate.prototype.getImpersonateID = SAWSOAP_impersonate_getImpersonateID;

function SAWSOAP_impersonate_setImpersonateID(value) {
	this._impersonateID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}impersonateexResult
//
...
//
function SAWSOAP_impersonateexResult_getReturn() {
	return this._return;
}

SAWSOAP_impersonateexResult.prototype.getReturn = SAWSOAP_impersonateexResult_getReturn;

function SAWSOAP_impersonateexResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_impersonateexResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}moveIBotResult
//
...
//
function SAWSOAP_moveIBotResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}setItemAttributes
//
...
//
function SAWSOAP_setItemAttributes_getPath() {
	return this._path;
}

SAWSOAP_setItemAttributes.prototype.getPath = SAWSOAP_setItemAttributes_getPath;

function SAWSOAP_setItemAttributes_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_setItemAttributes_getValue() {
	return this._value;
}

SAWSOAP_setItemAttributes.prototype.getValue = SAWSOAP_setItemAttributes_getValue;

function SAWSOAP_setItemAttributes_setValue(value) {
	this._value = value;
}
...
//
function SAWSOAP_setItemAttributes_getRecursive() {
	return this._recursive;
}

SAWSOAP_setItemAttributes.prototype.getRecursive = SAWSOAP_setItemAttributes_getRecursive;

function SAWSOAP_setItemAttributes_setRecursive(value) {
	this._recursive = value;
}
...
//
function SAWSOAP_setItemAttributes_getSessionID() {
	return this._sessionID;
}

SAWSOAP_setItemAttributes.prototype.getSessionID = SAWSOAP_setItemAttributes_getSessionID;

function SAWSOAP_setItemAttributes_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_setItemAttributes_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}describeTableResult
//
...
//
function SAWSOAP_describeTableResult_getTable() {
	return this._table;
}

SAWSOAP_describeTableResult.prototype.getTable = SAWSOAP_describeTableResult_getTable;

function SAWSOAP_describeTableResult_setTable(value) {
	this._table = value;
}
...
//
function SAWSOAP_describeTableResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}setBridgeResult
//
...
//
function SAWSOAP_setBridgeResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getJobInfoResult
//
...
//
function SAWSOAP_getJobInfoResult_getJobInfo() {
	return this._jobInfo;
}

SAWSOAP_getJobInfoResult.prototype.getJobInfo = SAWSOAP_getJobInfoResult_getJobInfo;

function SAWSOAP_getJobInfoResult_setJobInfo(value) {
	this._jobInfo = value;
}
...
//
function SAWSOAP_getJobInfoResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_endPageResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_createFolder_getPath() {
	return this._path;
}

SAWSOAP_createFolder.prototype.getPath = SAWSOAP_createFolder_getPath;

function SAWSOAP_createFolder_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_createFolder_getCreateIfNotExists() {
...
function SAWSOAP_createFolder_setCreateIfNotExists(value) {
...
// setter function is is
// SAWSOAP_createFolder.prototype.setCreateIntermediateDirs
//
function SAWSOAP_createFolder_getCreateIntermediateDirs() {
	return this._createIntermediateDirs;
}

SAWSOAP_createFolder.prototype.getCreateIntermediateDirs = SAWSOAP_createFolder_getCreateIntermediateDirs;

function SAWSOAP_createFolder_setCreateIntermediateDirs(value) {
	this._createIntermediateDirs = value;
}
...
//
function SAWSOAP_createFolder_getSessionID() {
	return this._sessionID;
}

SAWSOAP_createFolder.prototype.getSessionID = SAWSOAP_createFolder_getSessionID;

function SAWSOAP_createFolder_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_createFolder_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_export_getFilename() {
	return this._filename;
}

SAWSOAP_export.prototype.getFilename = SAWSOAP_export_getFilename;

function SAWSOAP_export_setFilename(value) {
	this._filename = value;
}
...
//
function SAWSOAP_export_getFilter() {
	return this._filter;
}

SAWSOAP_export.prototype.getFilter = SAWSOAP_export_getFilter;

function SAWSOAP_export_setFilter(value) {
	this._filter = value;
}
...
//
function SAWSOAP_export_getFlag() {
	return this._flag;
}

SAWSOAP_export.prototype.getFlag = SAWSOAP_export_getFlag;

function SAWSOAP_export_setFlag(value) {
	this._flag = value;
}
...
//
function SAWSOAP_export_getExportSecurity() {
	return this._exportSecurity;
}

SAWSOAP_export.prototype.getExportSecurity = SAWSOAP_export_getExportSecurity;

function SAWSOAP_export_setExportSecurity(value) {
	this._exportSecurity = value;
}
...
//
function SAWSOAP_export_getSessionID() {
	return this._sessionID;
}

SAWSOAP_export.prototype.getSessionID = SAWSOAP_export_getSessionID;

function SAWSOAP_export_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_joinGroups_getGroup() {
	return this._group;
}

SAWSOAP_joinGroups.prototype.getGroup = SAWSOAP_joinGroups_getGroup;

function SAWSOAP_joinGroups_setGroup(value) {
	this._group = value;
}
...
//
function SAWSOAP_joinGroups_getMember() {
	return this._member;
}

SAWSOAP_joinGroups.prototype.getMember = SAWSOAP_joinGroups_getMember;

function SAWSOAP_joinGroups_setMember(value) {
	this._member = value;
}
...
//
function SAWSOAP_joinGroups_getSessionID() {
	return this._sessionID;
}

SAWSOAP_joinGroups.prototype.getSessionID = SAWSOAP_joinGroups_getSessionID;

function SAWSOAP_joinGroups_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_getGroups_getMember() {
	return this._member;
}

SAWSOAP_getGroups.prototype.getMember = SAWSOAP_getGroups_getMember;

function SAWSOAP_getGroups_setMember(value) {
	this._member = value;
}
...
//
function SAWSOAP_getGroups_getExpandGroups() {
	return this._expandGroups;
}

SAWSOAP_getGroups.prototype.getExpandGroups = SAWSOAP_getGroups_getExpandGroups;

function SAWSOAP_getGroups_setExpandGroups(value) {
	this._expandGroups = value;
}
...
//
function SAWSOAP_getGroups_getSessionID() {
	return this._sessionID;
}

SAWSOAP_getGroups.prototype.getSessionID = SAWSOAP_getGroups_getSessionID;

function SAWSOAP_getGroups_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_readObjects_getPaths() {
	return this._paths;
}

SAWSOAP_readObjects.prototype.getPaths = SAWSOAP_readObjects_getPaths;

function SAWSOAP_readObjects_setPaths(value) {
	this._paths = value;
}
...
//
function SAWSOAP_readObjects_getResolveLinks() {
	return this._resolveLinks;
}

SAWSOAP_readObjects.prototype.getResolveLinks = SAWSOAP_readObjects_getResolveLinks;

function SAWSOAP_readObjects_setResolveLinks(value) {
	this._resolveLinks = value;
}
...
//
function SAWSOAP_readObjects_getSessionID() {
	return this._sessionID;
}

SAWSOAP_readObjects.prototype.getSessionID = SAWSOAP_readObjects_getSessionID;

function SAWSOAP_readObjects_setSessionID(value) {
	this._sessionID = value;
}
...
function SAWSOAP_readObjects_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'paths')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_copyItem2_getPath() {
	return this._path;
}

SAWSOAP_copyItem2.prototype.getPath = SAWSOAP_copyItem2_getPath;

function SAWSOAP_copyItem2_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_copyItem2_getRecursive() {
	return this._recursive;
}

SAWSOAP_copyItem2.prototype.getRecursive = SAWSOAP_copyItem2_getRecursive;

function SAWSOAP_copyItem2_setRecursive(value) {
	this._recursive = value;
}
...
//
function SAWSOAP_copyItem2_getPermissions() {
	return this._permissions;
}

SAWSOAP_copyItem2.prototype.getPermissions = SAWSOAP_copyItem2_getPermissions;

function SAWSOAP_copyItem2_setPermissions(value) {
...
//
function SAWSOAP_copyItem2_getTimestamps() {
	return this._timestamps;
}

SAWSOAP_copyItem2.prototype.getTimestamps = SAWSOAP_copyItem2_getTimestamps;

function SAWSOAP_copyItem2_setTimestamps(value) {
...
//
function SAWSOAP_copyItem2_getUseMtom() {
	return this._useMtom;
}

SAWSOAP_copyItem2.prototype.getUseMtom = SAWSOAP_copyItem2_getUseMtom;

function SAWSOAP_copyItem2_setUseMtom(value) {
	this._useMtom = value;
}
...
//
function SAWSOAP_copyItem2_getSessionID() {
	return this._sessionID;
}

SAWSOAP_copyItem2.prototype.getSessionID = SAWSOAP_copyItem2_getSessionID;

function SAWSOAP_copyItem2_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getGroupsResult
//
...
//
function SAWSOAP_getGroupsResult_getAccount() {
	return this._account;
}

SAWSOAP_getGroupsResult.prototype.getAccount = SAWSOAP_getGroupsResult_getAccount;

function SAWSOAP_getGroupsResult_setAccount(value) {
	this._account = value;
}
...
//
function SAWSOAP_getGroupsResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_cancelJob_getJobID() {
	return this._jobID;
}

SAWSOAP_cancelJob.prototype.getJobID = SAWSOAP_cancelJob_getJobID;

function SAWSOAP_cancelJob_setJobID(value) {
	this._jobID = value;
}
...
//
function SAWSOAP_cancelJob_getSessionID() {
	return this._sessionID;
}

SAWSOAP_cancelJob.prototype.getSessionID = SAWSOAP_cancelJob_getSessionID;

function SAWSOAP_cancelJob_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_writeObjects_getCatalogObjects() {
	return this._catalogObjects;
}

SAWSOAP_writeObjects.prototype.getCatalogObjects = SAWSOAP_writeObjects_getCatalogObjects;

function SAWSOAP_writeObjects_setCatalogObjects(value) {
	this._catalogObjects = value;
}
...
//
function SAWSOAP_writeObjects_getAllowOverwrite() {
	return this._allowOverwrite;
}

SAWSOAP_writeObjects.prototype.getAllowOverwrite = SAWSOAP_writeObjects_getAllowOverwrite;

function SAWSOAP_writeObjects_setAllowOverwrite(value) {
	this._allowOverwrite = value;
}
...
// element set for createIntermediateDirs
// setter function is is
// SAWSOAP_writeObjects.prototype.setCreateIntermediateDirs
//
function SAWSOAP_writeObjects_getCreateIntermediateDirs() {
	return this._createIntermediateDirs;
}

SAWSOAP_writeObjects.prototype.getCreateIntermediateDirs = SAWSOAP_writeObjects_getCreateIntermediateDirs;

function SAWSOAP_writeObjects_setCreateIntermediateDirs(value) {
	this._createIntermediateDirs = value;
}
...
//
function SAWSOAP_writeObjects_getErrorMode() {
	return this._errorMode;
}

SAWSOAP_writeObjects.prototype.getErrorMode = SAWSOAP_writeObjects_getErrorMode;

function SAWSOAP_writeObjects_setErrorMode(value) {
	this._errorMode = value;
}
...
//
function SAWSOAP_writeObjects_getSessionID() {
	return this._sessionID;
}

SAWSOAP_writeObjects.prototype.getSessionID = SAWSOAP_writeObjects_getSessionID;

function SAWSOAP_writeObjects_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_writeObjects_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
		...
		if (this._catalogObjects != null) {
			for (var ax = 0; ax < this._catalogObjects.length; ax++) {
				if (this._catalogObjects[ax] == null) {
					...
					xml = xml
							+ this._catalogObjects[ax].serialize(cxfjsutils,
									'jns0:catalogObjects', null);
				}
			}
		}
	}
...
function SAWSOAP_writeObjects_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'catalogObjects')) {
		item = [];
		do {
			var arrayItem = null;
			var value = null;
...
//
function SAWSOAP_saveResultSet_getSegmentPath() {
	return this._segmentPath;
}

SAWSOAP_saveResultSet.prototype.getSegmentPath = SAWSOAP_saveResultSet_getSegmentPath;

function SAWSOAP_saveResultSet_setSegmentPath(value) {
	this._segmentPath = value;
}
...
//
function SAWSOAP_saveResultSet_getTreeNodePath() {
	return this._treeNodePath;
}

SAWSOAP_saveResultSet.prototype.getTreeNodePath = SAWSOAP_saveResultSet_getTreeNodePath;

function SAWSOAP_saveResultSet_setTreeNodePath(value) {
	this._treeNodePath = value;
}
...
//
function SAWSOAP_saveResultSet_getSavedSegmentPath() {
	return this._savedSegmentPath;
}

SAWSOAP_saveResultSet.prototype.getSavedSegmentPath = SAWSOAP_saveResultSet_getSavedSegmentPath;

function SAWSOAP_saveResultSet_setSavedSegmentPath(value) {
	this._savedSegmentPath = value;
}
...
//
function SAWSOAP_saveResultSet_getSegmentationOptions() {
	return this._segmentationOptions;
}

SAWSOAP_saveResultSet.prototype.getSegmentationOptions = SAWSOAP_saveResultSet_getSegmentationOptions;

function SAWSOAP_saveResultSet_setSegmentationOptions(value) {
	this._segmentationOptions = value;
}
...
//
function SAWSOAP_saveResultSet_getSRCustomLabel() {
	return this._SRCustomLabel;
}

SAWSOAP_saveResultSet.prototype.getSRCustomLabel = SAWSOAP_saveResultSet_getSRCustomLabel;

function SAWSOAP_saveResultSet_setSRCustomLabel(value) {
	this._SRCustomLabel = value;
}
...
//
function SAWSOAP_saveResultSet_getAppendStaticSegment() {
	return this._appendStaticSegment;
}

SAWSOAP_saveResultSet.prototype.getAppendStaticSegment = SAWSOAP_saveResultSet_getAppendStaticSegment;

function SAWSOAP_saveResultSet_setAppendStaticSegment(value) {
	this._appendStaticSegment = value;
}
...
//
function SAWSOAP_saveResultSet_getSessionID() {
	return this._sessionID;
}

SAWSOAP_saveResultSet.prototype.getSessionID = SAWSOAP_saveResultSet_getSessionID;

function SAWSOAP_saveResultSet_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_saveResultSet_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
function SAWSOAP_saveResultSet_deserialize(cxfjsutils, element) {
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'savedSegmentPath')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'SRCustomLabel')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = value;
	...
	if (curElement != null
			&& cxfjsutils.isNodeNamedNS(curElement,
					'urn://oracle.bi.webservices/v6', 'appendStaticSegment')) {
		var value = null;
		if (!cxfjsutils.isElementNil(curElement)) {
			value = cxfjsutils.getNodeText(curElement);
			item = (value == 'true');
...
//
function SAWSOAP_purgeLog_getItems() {
	return this._items;
}

SAWSOAP_purgeLog.prototype.getItems = SAWSOAP_purgeLog_getItems;

function SAWSOAP_purgeLog_setItems(value) {
	this._items = value;
}
...
//
function SAWSOAP_purgeLog_getTimestamp() {
	return this._timestamp;
}

SAWSOAP_purgeLog.prototype.getTimestamp = SAWSOAP_purgeLog_getTimestamp;

function SAWSOAP_purgeLog_setTimestamp(value) {
...
//
function SAWSOAP_purgeLog_getSessionID() {
	return this._sessionID;
}

SAWSOAP_purgeLog.prototype.getSessionID = SAWSOAP_purgeLog_getSessionID;

function SAWSOAP_purgeLog_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}getPrivilegesStatusResult
//
...
//
function SAWSOAP_getPrivilegesStatusResult_getReturn() {
	return this._return;
}

SAWSOAP_getPrivilegesStatusResult.prototype.getReturn = SAWSOAP_getPrivilegesStatusResult_getReturn;

function SAWSOAP_getPrivilegesStatusResult_setReturn(value) {
	this._return = value;
}
...
//
function SAWSOAP_getPrivilegesStatusResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}updateGlobalPrivilegeACL
//
...
// element set for privilegeName
// setter function is is
// SAWSOAP_updateGlobalPrivilegeACL.prototype.setPrivilegeName
//
function SAWSOAP_updateGlobalPrivilegeACL_getPrivilegeName() {
	return this._privilegeName;
}

SAWSOAP_updateGlobalPrivilegeACL.prototype.getPrivilegeName = SAWSOAP_updateGlobalPrivilegeACL_getPrivilegeName;

function SAWSOAP_updateGlobalPrivilegeACL_setPrivilegeName(value) {
	this._privilegeName = value;
}
...
//
function SAWSOAP_updateGlobalPrivilegeACL_getAcl() {
	return this._acl;
}

SAWSOAP_updateGlobalPrivilegeACL.prototype.getAcl = SAWSOAP_updateGlobalPrivilegeACL_getAcl;

function SAWSOAP_updateGlobalPrivilegeACL_setAcl(value) {
	this._acl = value;
}
...
// setter function is is
// SAWSOAP_updateGlobalPrivilegeACL.prototype.setUpdateACLParams
//
function SAWSOAP_updateGlobalPrivilegeACL_getUpdateACLParams() {
	return this._updateACLParams;
}

SAWSOAP_updateGlobalPrivilegeACL.prototype.getUpdateACLParams = SAWSOAP_updateGlobalPrivilegeACL_getUpdateACLParams;

function SAWSOAP_updateGlobalPrivilegeACL_setUpdateACLParams(value) {
	this._updateACLParams = value;
}
...
//
function SAWSOAP_updateGlobalPrivilegeACL_getSessionID() {
	return this._sessionID;
}

SAWSOAP_updateGlobalPrivilegeACL.prototype.getSessionID = SAWSOAP_updateGlobalPrivilegeACL_getSessionID;

function SAWSOAP_updateGlobalPrivilegeACL_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_updateGlobalPrivilegeACL_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
	...
	// block for local variables
	{
		if (this._updateACLParams == null) {
			...
			xml = xml
					+ this._updateACLParams.serialize(cxfjsutils,
							'jns0:updateACLParams', null);
		}
	}
	// block for local variables
	{
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}updateCatalogItemACLResult
//
...
//
function SAWSOAP_updateCatalogItemACLResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_isMember_getGroup() {
	return this._group;
}

SAWSOAP_isMember.prototype.getGroup = SAWSOAP_isMember_getGroup;

function SAWSOAP_isMember_setGroup(value) {
	this._group = value;
}
...
//
function SAWSOAP_isMember_getMember() {
	return this._member;
}

SAWSOAP_isMember.prototype.getMember = SAWSOAP_isMember_getMember;

function SAWSOAP_isMember_setMember(value) {
	this._member = value;
}
...
//
function SAWSOAP_isMember_getExpandGroups() {
	return this._expandGroups;
}

SAWSOAP_isMember.prototype.getExpandGroups = SAWSOAP_isMember_getExpandGroups;

function SAWSOAP_isMember_setExpandGroups(value) {
	this._expandGroups = value;
}
...
//
function SAWSOAP_isMember_getSessionID() {
	return this._sessionID;
}

SAWSOAP_isMember.prototype.getSessionID = SAWSOAP_isMember_getSessionID;

function SAWSOAP_isMember_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Constructor for XML Schema item
// {urn://oracle.bi.webservices/v6}copyItemResult
//
...
//
function SAWSOAP_copyItemResult_serialize(cxfjsutils, elementName,
		extraNamespaces) {
	var xml = '';
	if (elementName !== null) {
		xml = xml + '<';
...
//
function SAWSOAP_upgradeXML_getXml() {
	return this._xml;
}

SAWSOAP_upgradeXML.prototype.getXml = SAWSOAP_upgradeXML_getXml;

function SAWSOAP_upgradeXML_setXml(value) {
	this._xml = value;
}
...
//
function SAWSOAP_upgradeXML_getSessionID() {
	return this._sessionID;
}

SAWSOAP_upgradeXML.prototype.getSessionID = SAWSOAP_upgradeXML_getSessionID;

function SAWSOAP_upgradeXML_setSessionID(value) {
	this._sessionID = value;
}
...
//
function SAWSOAP_createLink_getPath() {
	return this._path;
}

SAWSOAP_createLink.prototype.getPath = SAWSOAP_createLink_getPath;

function SAWSOAP_createLink_setPath(value) {
	this._path = value;
}
...
//
function SAWSOAP_createLink_getPathTarget() {
	return this._pathTarget;
}

SAWSOAP_createLink.prototype.getPathTarget = SAWSOAP_createLink_getPathTarget;

function SAWSOAP_createLink_setPathTarget(value) {
	this._pathTarget = value;
}
...
//
function SAWSOAP_createLink_getSessionID() {
	return this._sessionID;
}

SAWSOAP_createLink.prototype.getSessionID = SAWSOAP_createLink_getSessionID;

function SAWSOAP_createLink_setSessionID(value) {
	this._sessionID = value;
}
...
//
// Definitions for service: {urn://oracle.bi.webservices/v6}SAWSessionService
//

// Javascript for {urn://oracle.bi.webservices/v6}SAWSessionServiceSoap

function SAWSOAP_SAWSessionServiceSoap() {
...
function SAWSOAP_keepAlive_op_onsuccess(client, responseXml) {
	if (client.user_onsuccess) {
		...
		this.jsutils.trace('part element: '
				+ this.jsutils.traceElementName(element));
		this.jsutils.trace('calling SAWSOAP_keepAliveOut_deserializeResponse');
		responseObject = SAWSOAP_keepAliveOut_deserializeResponse(this.jsutils,
				element);
		client.user_onsuccess(responseObject);
	}
}

SAWSOAP_SAWSessionServiceSoap.prototype.keepAlive_onsuccess = SAWSOAP_keepAlive_op_onsuccess;

function SAWSOAP_keepAlive_op_onerror(client) {
	if (client.user_onerror) {
		...
		if (client.parseErrorDetails) {
			client.user_onerror(httpStatus, httpStatusText, client
					.parseErrorDetails(this));
		} else {
...
SAWSOAP_SAWSessionServiceSoap.prototype.keepAlive_onerror = SAWSOAP_keepAlive_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}keepAlive
// Wrapped operation.
// parameter sessionID
// - array
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_keepAlive_op(successCallback, errorCallback, sessionID) {
	this.client = new CxfApacheOrgClient(this.jsutils);
	var xml = null;
	var args = new Array(1);
	args[0] = sessionID;
	xml = this.keepAliveIn_serializeInput(this.jsutils, args);
	this.client.user_onsuccess = successCallback;
	this.client.user_onerror = errorCallback;
	var closureThis = this;
	this.client.onsuccess = function(client, responseXml) {
		closureThis.keepAlive_onsuccess(client, responseXml);
	};
	this.client.onerror = function(client) {
		closureThis.keepAlive_onerror(client);
	};
	var requestHeaders = [];
	requestHeaders['SOAPAction'] = '#keepAlive';
	this.jsutils.trace('synchronous = ' + this.synchronous);
	this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SAWSessionServiceSoap.prototype.keepAlive = SAWSOAP_keepAlive_op;

function SAWSOAP_keepAliveIn_serializeInput(cxfjsutils, args) {
	var wrapperObj = new SAWSOAP_keepAlive();
	wrapperObj.setSessionID(args[0]);
	var xml;
	xml = cxfjsutils
			.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
	// block for local variables
	{
		xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:keepAlive', null);
	}
	xml = xml + cxfjsutils.endSoap11Message();
	return xml;
}

SAWSOAP_SAWSessionServiceSoap.prototype.keepAliveIn_serializeInput = SAWSOAP_keepAliveIn_serializeInput;

function SAWSOAP_keepAliveOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_logoff_op_onsuccess(client, responseXml) {
	var xmlDoc;

	if (window.DOMParser) {
		xmlDoc = (new window.DOMParser()).parseFromString(responseXml,
				"text/xml");
	...
	if (client.user_onsuccess) {
		...
		this.jsutils.trace('part element: '
				+ this.jsutils.traceElementName(element));
		this.jsutils.trace('calling SAWSOAP_logoffOut_deserializeResponse');
		responseObject = SAWSOAP_logoffOut_deserializeResponse(this.jsutils,
				element);
		client.user_onsuccess(responseObject);
	}
}

SAWSOAP_SAWSessionServiceSoap.prototype.logoff_onsuccess = SAWSOAP_logoff_op_onsuccess;

function SAWSOAP_logoff_op_onerror(client) {
	if (client.user_onerror) {
		var httpStatus;
		var httpStatusText;
		try {
...
SAWSOAP_SAWSessionServiceSoap.prototype.logoff_onerror = SAWSOAP_logoff_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}logoff
// Wrapped operation.
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_logoff_op(successCallback, errorCallback, sessionID) {
	this.client = new CxfApacheOrgClient(this.jsutils);
	var xml = null;
	var args = new Array(1);
	args[0] = sessionID;
	xml = this.logoffIn_serializeInput(this.jsutils, args);
	this.client.user_onsuccess = successCallback;
	this.client.user_onerror = errorCallback;
	var closureThis = this;
	this.client.onsuccess = function(client, responseXml) {
		closureThis.logoff_onsuccess(client, responseXml);
	};
	this.client.onerror = function(client) {
		closureThis.logoff_onerror(client);
	};
	var requestHeaders = [];
	requestHeaders['SOAPAction'] = '#logoff';
	this.jsutils.trace('synchronous = ' + this.synchronous);
	this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SAWSessionServiceSoap.prototype.logoff = SAWSOAP_logoff_op;

function SAWSOAP_logoffIn_serializeInput(cxfjsutils, args) {
	var wrapperObj = new SAWSOAP_logoff();
	wrapperObj.setSessionID(args[0]);
	var xml;
	xml = cxfjsutils
			.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
	// block for local variables
	{
		xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:logoff', null);
	}
	xml = xml + cxfjsutils.endSoap11Message();
	return xml;
}

SAWSOAP_SAWSessionServiceSoap.prototype.logoffIn_serializeInput = SAWSOAP_logoffIn_serializeInput;

function SAWSOAP_logoffOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_impersonateex_op_onsuccess(client, responseXml) {
	if (client.user_onsuccess) {
		var responseObject = null;
		var element = responseXml.documentElement;
		this.jsutils.trace('responseXml: '
		...
		this.jsutils.trace('part element: '
				+ this.jsutils.traceElementName(element));
		this.jsutils
				.trace('calling SAWSOAP_impersonateexOut_deserializeResponse');
		responseObject = SAWSOAP_impersonateexOut_deserializeResponse(
				this.jsutils, element);
		client.user_onsuccess(responseObject);
	}
}

SAWSOAP_SAWSessionServiceSoap.prototype.impersonateex_onsuccess = SAWSOAP_impersonateex_op_onsuccess;

function SAWSOAP_impersonateex_op_onerror(client) {
	if (client.user_onerror) {
		var httpStatus;
		var httpStatusText;
		try {
...
SAWSOAP_SAWSessionServiceSoap.prototype.impersonateex_onerror = SAWSOAP_impersonateex_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}impersonateex
// Wrapped operation.
// parameter name
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter password
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter
// impersonateID
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter
// sessionparams
// - Object constructor is SAWSOAP_SAWSessionParameters
//
function SAWSOAP_impersonateex_op(successCallback, errorCallback, name,
		password, impersonateID, sessionparams) {
	this.client = new CxfApacheOrgClient(this.jsutils);
	var xml = null;
	var args = new Array(4);
	args[0] = name;
	args[1] = password;
	args[2] = impersonateID;
	args[3] = sessionparams;
	xml = this.impersonateexIn_serializeInput(this.jsutils, args);
	this.client.user_onsuccess = successCallback;
	this.client.user_onerror = errorCallback;
	var closureThis = this;
	this.client.onsuccess = function(client, responseXml) {
		closureThis.impersonateex_onsuccess(client, responseXml);
	};
	this.client.onerror = function(client) {
		closureThis.impersonateex_onerror(client);
	};
	var requestHeaders = [];
	requestHeaders['SOAPAction'] = '#impersonateex';
	this.jsutils.trace('synchronous = ' + this.synchronous);
	this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SAWSessionServiceSoap.prototype.impersonateex = SAWSOAP_impersonateex_op;

function SAWSOAP_impersonateexIn_serializeInput(cxfjsutils, args) {
	var wrapperObj = new SAWSOAP_impersonateex();
	wrapperObj.setName(args[0]);
	wrapperObj.setPassword(args[1]);
	wrapperObj.setImpersonateID(args[2]);
	wrapperObj.setSessionparams(args[3]);
	var xml;
	xml = cxfjsutils
			.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
	// block for local variables
	{
		xml = xml
				+ wrapperObj.serialize(cxfjsutils, 'jns0:impersonateex', null);
	}
	xml = xml + cxfjsutils.endSoap11Message();
	return xml;
}

SAWSOAP_SAWSessionServiceSoap.prototype.impersonateexIn_serializeInput = SAWSOAP_impersonateexIn_serializeInput;

function SAWSOAP_impersonateexOut_deserializeResponse(cxfjsutils, partElement) {
	var returnObject = SAWSOAP_impersonateexResult_deserialize(cxfjsutils,
			partElement);

	return returnObject;
}
function SAWSOAP_impersonate_op_onsuccess(client, responseXml) {
	if (client.user_onsuccess) {
		var responseObject = null;
		var element = responseXml.documentElement;
		this.jsutils.trace('responseXml: '
		...
		this.jsutils.trace('part element: '
				+ this.jsutils.traceElementName(element));
		this.jsutils
				.trace('calling SAWSOAP_impersonateOut_deserializeResponse');
		responseObject = SAWSOAP_impersonateOut_deserializeResponse(
				this.jsutils, element);
		client.user_onsuccess(responseObject);
	}
}

SAWSOAP_SAWSessionServiceSoap.prototype.impersonate_onsuccess = SAWSOAP_impersonate_op_onsuccess;

function SAWSOAP_impersonate_op_onerror(client) {
	if (client.user_onerror) {
		var httpStatus;
		var httpStatusText;
		try {
...
SAWSOAP_SAWSessionServiceSoap.prototype.impersonate_onerror = SAWSOAP_impersonate_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}impersonate
// Wrapped operation.
// parameter name
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter password
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter
// impersonateID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_impersonate_op(successCallback, errorCallback, name, password,
		impersonateID) {
	this.client = new CxfApacheOrgClient(this.jsutils);
	var xml = null;
	...
	args[1] = password;
	args[2] = impersonateID;
	xml = this.impersonateIn_serializeInput(this.jsutils, args);
	this.client.user_onsuccess = successCallback;
	this.client.user_onerror = errorCallback;
	var closureThis = this;
	this.client.onsuccess = function(client, responseXml) {
		closureThis.impersonate_onsuccess(client, responseXml);
	};
	this.client.onerror = function(client) {
		closureThis.impersonate_onerror(client);
	};
	var requestHeaders = [];
	requestHeaders['SOAPAction'] = '#impersonate';
	this.jsutils.trace('synchronous = ' + this.synchronous);
	this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SAWSessionServiceSoap.prototype.impersonate = SAWSOAP_impersonate_op;

function SAWSOAP_impersonateIn_serializeInput(cxfjsutils, args) {
	var wrapperObj = new SAWSOAP_impersonate();
	wrapperObj.setName(args[0]);
	wrapperObj.setPassword(args[1]);
	wrapperObj.setImpersonateID(args[2]);
	var xml;
	...
	// block for local variables
	{
		xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:impersonate', null);
	}
	xml = xml + cxfjsutils.endSoap11Message();
	return xml;
}

SAWSOAP_SAWSessionServiceSoap.prototype.impersonateIn_serializeInput = SAWSOAP_impersonateIn_serializeInput;

function SAWSOAP_impersonateOut_deserializeResponse(cxfjsutils, partElement) {
	var returnObject = SAWSOAP_impersonateResult_deserialize(cxfjsutils,
			partElement);

	return returnObject;
}
function SAWSOAP_logon_op_onsuccess(client, responseXml) {
	/* responseXml is text we need to convert it into xml. */
	var xmlDoc;
	...
	if (client.user_onsuccess) {
		...
		this.jsutils.trace('part element: '
				+ this.jsutils.traceElementName(element));
		this.jsutils.trace('calling SAWSOAP_logonOut_deserializeResponse');
	 //check whether the part is 'soap:Fault'.
	 if(element.nodeName == 'soap:Fault')
	 {
		 //create Fault object and populate fault code and fault string and return as responseObject.
		 var fault = new Fault();
		if(element.hasChildNodes())
		{
			var faultArray = element.childNodes;
			var faultCode = faultArray[0].childNodes[0].nodeValue;
			var faultMsg = faultArray[2].childNodes[0].nodeValue;
			fault.setFaultCode(faultCode);
			fault.setFaultString(faultMsg);
		}
		 responseObject = fault ;
		 client.user_onsuccess(responseObject);
	 }
	 else{
     responseObject = SAWSOAP_logonOut_deserializeResponse(this.jsutils,
				element);
     client.user_onsuccess(responseObject);
	 }
    }
...
SAWSOAP_SAWSessionServiceSoap.prototype.logon_onsuccess = SAWSOAP_logon_op_onsuccess;

function SAWSOAP_logon_op_onerror(client) {
	document.write("<br>logon error function called<br>");
	if (client.user_onerror) {
		var httpStatus;
		var httpStatusText;
		try {
...
SAWSOAP_SAWSessionServiceSoap.prototype.logon_onerror = SAWSOAP_logon_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}logon
// Wrapped operation.
// parameter name
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter password
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_logon_op(successCallback, errorCallback, name, password) {
	this.client = new CxfApacheOrgClient(this.jsutils);
	...
	xml = this.logonIn_serializeInput(this.jsutils, args);

	this.client.user_onsuccess = successCallback;
	this.client.user_onerror = errorCallback;
	var closureThis = this;
	this.client.onsuccess = function(client, responseXml) {
		closureThis.logon_onsuccess(client, responseXml);
	};
	this.client.onerror = function(client) {
		closureThis.logon_onerror(client);
	};
	var requestHeaders = [];
	requestHeaders['SOAPAction'] = '#logon';
	this.jsutils.trace('synchronous = ' + this.synchronous);
	
	this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SAWSessionServiceSoap.prototype.logon = SAWSOAP_logon_op;

function SAWSOAP_logonIn_serializeInput(cxfjsutils, args) {
	var wrapperObj = new SAWSOAP_logon();
	wrapperObj.setName(args[0]);
	wrapperObj.setPassword(args[1]);
	var xml;
	xml = '<?xml version="1.0" encoding="UTF-8"?>'
			...
			+ '><soap-env:Body '
			+ "xmlns:jns0='urn://oracle.bi.webservices/v6'" + '>';

	{
		xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:logon', null);
	}
	xml = xml + cxfjsutils.endSoap11Message();
	return xml;
}

SAWSOAP_SAWSessionServiceSoap.prototype.logonIn_serializeInput = SAWSOAP_logonIn_serializeInput;

function SAWSOAP_logonOut_deserializeResponse(cxfjsutils, element) {
	var newobject = new SAWSOAP_logonResult();
	cxfjsutils.trace('element: ' + cxfjsutils.traceElementName(element));
	var curElement = cxfjsutils.getFirstElementChild(element);
	var item;
...
function SAWSOAP_getSessionEnvironment_op_onsuccess(client, responseXml) {
	if (client.user_onsuccess) {
		var responseObject = null;
		var element = responseXml.documentElement;
		this.jsutils.trace('responseXml: '
		...
		this.jsutils.trace('part element: '
				+ this.jsutils.traceElementName(element));
		this.jsutils
				.trace('calling SAWSOAP_getSessionEnvironmentOut_deserializeResponse');
		responseObject = SAWSOAP_getSessionEnvironmentOut_deserializeResponse(
				this.jsutils, element);
		client.user_onsuccess(responseObject);
	}
}

SAWSOAP_SAWSessionServiceSoap.prototype.getSessionEnvironment_onsuccess = SAWSOAP_getSessionEnvironment_op_onsuccess;

function SAWSOAP_getSessionEnvironment_op_onerror(client) {
	if (client.user_onerror) {
		var httpStatus;
		var httpStatusText;
		try {
...
SAWSOAP_SAWSessionServiceSoap.prototype.getSessionEnvironment_onerror = SAWSOAP_getSessionEnvironment_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getSessionEnvironment
// Wrapped operation.
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getSessionEnvironment_op(successCallback, errorCallback,
		sessionID) {
	this.client = new CxfApacheOrgClient(this.jsutils);
	var xml = null;
	var args = new Array(1);
	args[0] = sessionID;
	xml = this.getSessionEnvironmentIn_serializeInput(this.jsutils, args);
	this.client.user_onsuccess = successCallback;
	this.client.user_onerror = errorCallback;
	var closureThis = this;
	this.client.onsuccess = function(client, responseXml) {
		closureThis.getSessionEnvironment_onsuccess(client, responseXml);
	};
	this.client.onerror = function(client) {
		closureThis.getSessionEnvironment_onerror(client);
	};
	var requestHeaders = [];
	requestHeaders['SOAPAction'] = '#getSessionEnvironment';
	this.jsutils.trace('synchronous = ' + this.synchronous);
	this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SAWSessionServiceSoap.prototype.getSessionEnvironment = SAWSOAP_getSessionEnvironment_op;

function SAWSOAP_getSessionEnvironmentIn_serializeInput(cxfjsutils, args) {
	var wrapperObj = new SAWSOAP_getSessionEnvironment();
	wrapperObj.setSessionID(args[0]);
	var xml;
	xml = cxfjsutils
			.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
	...
	{
		xml = xml
				+ wrapperObj.serialize(cxfjsutils,
						'jns0:getSessionEnvironment', null);
	}
	xml = xml + cxfjsutils.endSoap11Message();
	return xml;
}

SAWSOAP_SAWSessionServiceSoap.prototype.getSessionEnvironmentIn_serializeInput = SAWSOAP_getSessionEnvironmentIn_serializeInput;

function SAWSOAP_getSessionEnvironmentOut_deserializeResponse(cxfjsutils,
		partElement) {
	var returnObject = SAWSOAP_getSessionEnvironmentResult_deserialize(
			cxfjsutils, partElement);

	return returnObject;
}
function SAWSOAP_logonex_op_onsuccess(client, responseXml) {
	if (client.user_onsuccess) {
		var responseObject = null;
		var element = responseXml.documentElement;
		this.jsutils.trace('responseXml: '
		...
		this.jsutils.trace('part element: '
				+ this.jsutils.traceElementName(element));
		this.jsutils.trace('calling SAWSOAP_logonexOut_deserializeResponse');
		responseObject = SAWSOAP_logonexOut_deserializeResponse(this.jsutils,
				element);
		client.user_onsuccess(responseObject);
	}
}

SAWSOAP_SAWSessionServiceSoap.prototype.logonex_onsuccess = SAWSOAP_logonex_op_onsuccess;

function SAWSOAP_logonex_op_onerror(client) {
	if (client.user_onerror) {
		var httpStatus;
		var httpStatusText;
		try {
...
SAWSOAP_SAWSessionServiceSoap.prototype.logonex_onerror = SAWSOAP_logonex_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}logonex
// Wrapped operation.
// parameter name
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter password
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter
...
// - Object constructor is SAWSOAP_SAWSessionParameters
//
function SAWSOAP_logonex_op(successCallback, errorCallback, name, password,
		sessionparams) {
	this.client = new CxfApacheOrgClient(this.jsutils);
	var xml = null;
	var args = new Array(3);
	args[0] = name;
	args[1] = password;
	args[2] = sessionparams;
	xml = this.logonexIn_serializeInput(this.jsutils, args);
	this.client.user_onsuccess = successCallback;
	this.client.user_onerror = errorCallback;
	var closureThis = this;
	this.client.onsuccess = function(client, responseXml) {
		closureThis.logonex_onsuccess(client, responseXml);
	};
	this.client.onerror = function(client) {
		closureThis.logonex_onerror(client);
	};
	var requestHeaders = [];
	requestHeaders['SOAPAction'] = '#logonex';
	this.jsutils.trace('synchronous = ' + this.synchronous);
	this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SAWSessionServiceSoap.prototype.logonex = SAWSOAP_logonex_op;

function SAWSOAP_logonexIn_serializeInput(cxfjsutils, args) {
	var wrapperObj = new SAWSOAP_logonex();
	wrapperObj.setName(args[0]);
	wrapperObj.setPassword(args[1]);
	wrapperObj.setSessionparams(args[2]);
	var xml;
	xml = cxfjsutils
			.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
	// block for local variables
	{
		xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:logonex', null);
	}
	xml = xml + cxfjsutils.endSoap11Message();
	return xml;
}

SAWSOAP_SAWSessionServiceSoap.prototype.logonexIn_serializeInput = SAWSOAP_logonexIn_serializeInput;

function SAWSOAP_logonexOut_deserializeResponse(cxfjsutils, partElement) {
	var returnObject = SAWSOAP_logonexResult_deserialize(cxfjsutils,
			partElement);

	return returnObject;
}
function SAWSOAP_getSessionVariables_op_onsuccess(client, responseXml) {
	if (client.user_onsuccess) {
		var responseObject = null;
		var element = responseXml.documentElement;
		this.jsutils.trace('responseXml: '
		...
		this.jsutils.trace('part element: '
				+ this.jsutils.traceElementName(element));
		this.jsutils
				.trace('calling SAWSOAP_getSessionVariablesOut_deserializeResponse');
		responseObject = SAWSOAP_getSessionVariablesOut_deserializeResponse(
				this.jsutils, element);
		client.user_onsuccess(responseObject);
	}
}

SAWSOAP_SAWSessionServiceSoap.prototype.getSessionVariables_onsuccess = SAWSOAP_getSessionVariables_op_onsuccess;

function SAWSOAP_getSessionVariables_op_onerror(client) {
	if (client.user_onerror) {
		var httpStatus;
		var httpStatusText;
		try {
...
SAWSOAP_SAWSessionServiceSoap.prototype.getSessionVariables_onerror = SAWSOAP_getSessionVariables_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getSessionVariables
// Wrapped operation.
// parameter names
// - array
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getSessionVariables_op(successCallback, errorCallback, names,
		sessionID) {
	this.client = new CxfApacheOrgClient(this.jsutils);
	var xml = null;
	var args = new Array(2);
	args[0] = names;
	args[1] = sessionID;
	xml = this.getSessionVariablesIn_serializeInput(this.jsutils, args);
	this.client.user_onsuccess = successCallback;
	this.client.user_onerror = errorCallback;
	var closureThis = this;
	this.client.onsuccess = function(client, responseXml) {
		closureThis.getSessionVariables_onsuccess(client, responseXml);
	};
	this.client.onerror = function(client) {
		closureThis.getSessionVariables_onerror(client);
	};
	var requestHeaders = [];
	requestHeaders['SOAPAction'] = '#getSessionVariables';
	this.jsutils.trace('synchronous = ' + this.synchronous);
	this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SAWSessionServiceSoap.prototype.getSessionVariables = SAWSOAP_getSessionVariables_op;

function SAWSOAP_getSessionVariablesIn_serializeInput(cxfjsutils, args) {
	var wrapperObj = new SAWSOAP_getSessionVariables();
	wrapperObj.setNames(args[0]);
	...
	{
		xml = xml
				+ wrapperObj.serialize(cxfjsutils, 'jns0:getSessionVariables',
						null);
	}
	xml = xml + cxfjsutils.endSoap11Message();
	return xml;
...
SAWSOAP_SAWSessionServiceSoap.prototype.getSessionVariablesIn_serializeInput = SAWSOAP_getSessionVariablesIn_serializeInput;

function SAWSOAP_getSessionVariablesOut_deserializeResponse(cxfjsutils,
		partElement) {
	var returnObject = SAWSOAP_getSessionVariablesResult_deserialize(
			cxfjsutils, partElement);

	return returnObject;
}
function SAWSOAP_getCurUser_op_onsuccess(client, responseXml) {
	var xmlDoc;
	...
	if (client.user_onsuccess) {
		...
		this.jsutils.trace('part element: '
				+ this.jsutils.traceElementName(element));
		this.jsutils.trace('calling SAWSOAP_getCurUserOut_deserializeResponse');
		responseObject = SAWSOAP_getCurUserOut_deserializeResponse(
				this.jsutils, element);
		client.user_onsuccess(responseObject);
	}
}

SAWSOAP_SAWSessionServiceSoap.prototype.getCurUser_onsuccess = SAWSOAP_getCurUser_op_onsuccess;

function SAWSOAP_getCurUser_op_onerror(client) {
	if (client.user_onerror) {
		var httpStatus;
		var httpStatusText;
		try {
...
SAWSOAP_SAWSessionServiceSoap.prototype.getCurUser_onerror = SAWSOAP_getCurUser_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getCurUser
// Wrapped operation.
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getCurUser_op(successCallback, errorCallback, sessionID) {
	this.client = new CxfApacheOrgClient(this.jsutils);
	var xml = null;
	var args = new Array(1);
	args[0] = sessionID;
	xml = this.getCurUserIn_serializeInput(this.jsutils, args);
	this.client.user_onsuccess = successCallback;
	this.client.user_onerror = errorCallback;
	var closureThis = this;
	this.client.onsuccess = function(client, responseXml) {
		closureThis.getCurUser_onsuccess(client, responseXml);
	};
	this.client.onerror = function(client) {
		closureThis.getCurUser_onerror(client);
	};
	var requestHeaders = [];
	requestHeaders['SOAPAction'] = '#getCurUser';
	this.jsutils.trace('synchronous = ' + this.synchronous);
	this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SAWSessionServiceSoap.prototype.getCurUser = SAWSOAP_getCurUser_op;

function SAWSOAP_getCurUserIn_serializeInput(cxfjsutils, args) {
	var wrapperObj = new SAWSOAP_getCurUser();
	wrapperObj.setSessionID(args[0]);
	var xml;
	xml = cxfjsutils
			.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
	// block for local variables
	{
		xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getCurUser', null);
	}
	xml = xml + cxfjsutils.endSoap11Message();
	return xml;
}

SAWSOAP_SAWSessionServiceSoap.prototype.getCurUserIn_serializeInput = SAWSOAP_getCurUserIn_serializeInput;

function SAWSOAP_getCurUserOut_deserializeResponse(cxfjsutils, partElement) {
	var returnObject = SAWSOAP_getCurUserResult_deserialize(cxfjsutils,
			partElement);

	return returnObject;
}
function SAWSOAP_SAWSessionServiceSoap_SAWSOAP_SAWSessionServiceSoap() {
	this.url = 'http://166.78.244.8:9522/analytics/saw.dll?SoapImpl=nQSessionService';
}
SAWSOAP_SAWSessionServiceSoap_SAWSOAP_SAWSessionServiceSoap.prototype = new SAWSOAP_SAWSessionServiceSoap;
