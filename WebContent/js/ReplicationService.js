...
//
// Definitions for service: {urn://oracle.bi.webservices/v6}ReplicationService
//

// Javascript for {urn://oracle.bi.webservices/v6}ReplicationServiceSoap

function SAWSOAP_ReplicationServiceSoap () {
...
function SAWSOAP_markForReplication_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     ...
     this.jsutils.trace('calling SAWSOAP_markForReplicationOut_deserializeResponse');
     responseObject = SAWSOAP_markForReplicationOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_ReplicationServiceSoap.prototype.markForReplication_onsuccess = SAWSOAP_markForReplication_op_onsuccess;

function SAWSOAP_markForReplication_op_onerror(client) {
...
SAWSOAP_ReplicationServiceSoap.prototype.markForReplication_onerror = SAWSOAP_markForReplication_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}markForReplication
// Wrapped operation.
// parameter item
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter replicate
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_markForReplication_op(successCallback, errorCallback, item, replicate, sessionID) {
    ...
    args[1] = replicate;
    args[2] = sessionID;
    xml = this.markForReplicationIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.markForReplication_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.markForReplication_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#markForReplication';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_ReplicationServiceSoap.prototype.markForReplication = SAWSOAP_markForReplication_op;

function SAWSOAP_markForReplicationIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_markForReplication();
    wrapperObj.setItem(args[0]);
    wrapperObj.setReplicate(args[1]);
    wrapperObj.setSessionID(args[2]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:markForReplication', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_ReplicationServiceSoap.prototype.markForReplicationIn_serializeInput = SAWSOAP_markForReplicationIn_serializeInput;

function SAWSOAP_markForReplicationOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_import_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_importOut_deserializeResponse');
     responseObject = SAWSOAP_importOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_ReplicationServiceSoap.prototype.import_onsuccess = SAWSOAP_import_op_onsuccess;

function SAWSOAP_import_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_ReplicationServiceSoap.prototype.import_onerror = SAWSOAP_import_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}import
// Wrapped operation.
// parameter filename
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter flag
// - simple type {urn://oracle.bi.webservices/v6}ImportFlags// parameter lastPurgedLog
// - simple type {http://www.w3.org/2001/XMLSchema}dateTime// parameter updateReplicationLog
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter returnErrors
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter filter
// - Object constructor is SAWSOAP_CatalogItemsFilter
// parameter pathMap
// - Object constructor is SAWSOAP_PathMap
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_import_op(successCallback, errorCallback, filename, flag, lastPurgedLog, updateReplicationLog, returnErrors, filter, pathMap, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(8);
    args[0] = filename;
    args[1] = flag;
    args[2] = lastPurgedLog;
    args[3] = updateReplicationLog;
    args[4] = returnErrors;
    args[5] = filter;
    args[6] = pathMap;
    args[7] = sessionID;
    xml = this.importIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.import_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.import_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#import';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_ReplicationServiceSoap.prototype.import = SAWSOAP_import_op;

function SAWSOAP_importIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_import();
    wrapperObj.setFilename(args[0]);
    wrapperObj.setFlag(args[1]);
    wrapperObj.setLastPurgedLog(args[2]);
    wrapperObj.setUpdateReplicationLog(args[3]);
    wrapperObj.setReturnErrors(args[4]);
    wrapperObj.setFilter(args[5]);
    wrapperObj.setPathMap(args[6]);
    wrapperObj.setSessionID(args[7]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:import', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_ReplicationServiceSoap.prototype.importIn_serializeInput = SAWSOAP_importIn_serializeInput;

function SAWSOAP_importOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_importResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_export_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_exportOut_deserializeResponse');
     responseObject = SAWSOAP_exportOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_ReplicationServiceSoap.prototype.export_onsuccess = SAWSOAP_export_op_onsuccess;

function SAWSOAP_export_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_ReplicationServiceSoap.prototype.export_onerror = SAWSOAP_export_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}export
// Wrapped operation.
// parameter filename
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter filter
// - Object constructor is SAWSOAP_CatalogItemsFilter
// parameter flag
// - simple type {urn://oracle.bi.webservices/v6}ExportFlags// parameter exportSecurity
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_export_op(successCallback, errorCallback, filename, filter, flag, exportSecurity, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    ...
    args[1] = filter;
    args[2] = flag;
    args[3] = exportSecurity;
    args[4] = sessionID;
    xml = this.exportIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.export_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.export_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#export';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_ReplicationServiceSoap.prototype.export = SAWSOAP_export_op;

function SAWSOAP_exportIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_export();
    wrapperObj.setFilename(args[0]);
    wrapperObj.setFilter(args[1]);
    wrapperObj.setFlag(args[2]);
    wrapperObj.setExportSecurity(args[3]);
    wrapperObj.setSessionID(args[4]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:export', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_ReplicationServiceSoap.prototype.exportIn_serializeInput = SAWSOAP_exportIn_serializeInput;

function SAWSOAP_exportOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_purgeLog_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_purgeLogOut_deserializeResponse');
     responseObject = SAWSOAP_purgeLogOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_ReplicationServiceSoap.prototype.purgeLog_onsuccess = SAWSOAP_purgeLog_op_onsuccess;

function SAWSOAP_purgeLog_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_ReplicationServiceSoap.prototype.purgeLog_onerror = SAWSOAP_purgeLog_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}purgeLog
// Wrapped operation.
// parameter items
// - array
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter timestamp
// - simple type {http://www.w3.org/2001/XMLSchema}dateTime// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_purgeLog_op(successCallback, errorCallback, items, timestamp, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(3);
    args[0] = items;
    args[1] = timestamp;
    args[2] = sessionID;
    xml = this.purgeLogIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.purgeLog_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.purgeLog_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#purgeLog';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_ReplicationServiceSoap.prototype.purgeLog = SAWSOAP_purgeLog_op;

function SAWSOAP_purgeLogIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_purgeLog();
    wrapperObj.setItems(args[0]);
    wrapperObj.setTimestamp(args[1]);
    wrapperObj.setSessionID(args[2]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:purgeLog', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_ReplicationServiceSoap.prototype.purgeLogIn_serializeInput = SAWSOAP_purgeLogIn_serializeInput;

function SAWSOAP_purgeLogOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_ReplicationServiceSoap_SAWSOAP_ReplicationServiceSoap () {
  this.url = 'http://166.78.244.8:9522/analytics/saw.dll?SoapImpl=replicationService';
}
SAWSOAP_ReplicationServiceSoap_SAWSOAP_ReplicationServiceSoap.prototype = new SAWSOAP_ReplicationServiceSoap;
