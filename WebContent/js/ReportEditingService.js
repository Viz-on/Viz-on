...
//
// Definitions for service: {urn://oracle.bi.webservices/v6}ReportEditingService
//

// Javascript for {urn://oracle.bi.webservices/v6}ReportEditingServiceSoap

function SAWSOAP_ReportEditingServiceSoap () {
...
function SAWSOAP_applyReportParams_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     ...
     this.jsutils.trace('calling SAWSOAP_applyReportParamsOut_deserializeResponse');
     responseObject = SAWSOAP_applyReportParamsOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_ReportEditingServiceSoap.prototype.applyReportParams_onsuccess = SAWSOAP_applyReportParams_op_onsuccess;

function SAWSOAP_applyReportParams_op_onerror(client) {
...
SAWSOAP_ReportEditingServiceSoap.prototype.applyReportParams_onerror = SAWSOAP_applyReportParams_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}applyReportParams
// Wrapped operation.
// parameter reportRef
// - Object constructor is SAWSOAP_ReportRef
// parameter reportParams
// - Object constructor is SAWSOAP_ReportParams
// parameter encodeInString
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_applyReportParams_op(successCallback, errorCallback, reportRef, reportParams, encodeInString, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(4);
    args[0] = reportRef;
    args[1] = reportParams;
    args[2] = encodeInString;
    args[3] = sessionID;
    xml = this.applyReportParamsIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.applyReportParams_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.applyReportParams_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#applyReportParams';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_ReportEditingServiceSoap.prototype.applyReportParams = SAWSOAP_applyReportParams_op;

function SAWSOAP_applyReportParamsIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_applyReportParams();
    wrapperObj.setReportRef(args[0]);
    wrapperObj.setReportParams(args[1]);
    wrapperObj.setEncodeInString(args[2]);
    wrapperObj.setSessionID(args[3]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:applyReportParams', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_ReportEditingServiceSoap.prototype.applyReportParamsIn_serializeInput = SAWSOAP_applyReportParamsIn_serializeInput;

function SAWSOAP_applyReportParamsOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_applyReportParamsResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_applyReportDefaults_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_applyReportDefaultsOut_deserializeResponse');
     responseObject = SAWSOAP_applyReportDefaultsOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_ReportEditingServiceSoap.prototype.applyReportDefaults_onsuccess = SAWSOAP_applyReportDefaults_op_onsuccess;

function SAWSOAP_applyReportDefaults_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_ReportEditingServiceSoap.prototype.applyReportDefaults_onerror = SAWSOAP_applyReportDefaults_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}applyReportDefaults
// Wrapped operation.
// parameter reportRefs
// - Object constructor is SAWSOAP_ReportRef
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_applyReportDefaults_op(successCallback, errorCallback, reportRefs, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = reportRefs;
    args[1] = sessionID;
    xml = this.applyReportDefaultsIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.applyReportDefaults_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.applyReportDefaults_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#applyReportDefaults';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_ReportEditingServiceSoap.prototype.applyReportDefaults = SAWSOAP_applyReportDefaults_op;

function SAWSOAP_applyReportDefaultsIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_applyReportDefaults();
    wrapperObj.setReportRefs(args[0]);
    wrapperObj.setSessionID(args[1]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:applyReportDefaults', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_ReportEditingServiceSoap.prototype.applyReportDefaultsIn_serializeInput = SAWSOAP_applyReportDefaultsIn_serializeInput;

function SAWSOAP_applyReportDefaultsOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_applyReportDefaultsResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_generateReportSQL_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_generateReportSQLOut_deserializeResponse');
     responseObject = SAWSOAP_generateReportSQLOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_ReportEditingServiceSoap.prototype.generateReportSQL_onsuccess = SAWSOAP_generateReportSQL_op_onsuccess;

function SAWSOAP_generateReportSQL_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_ReportEditingServiceSoap.prototype.generateReportSQL_onerror = SAWSOAP_generateReportSQL_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}generateReportSQL
// Wrapped operation.
// parameter reportRef
// - Object constructor is SAWSOAP_ReportRef
// parameter reportParams
...
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_generateReportSQL_op(successCallback, errorCallback, reportRef, reportParams, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    ...
    args[1] = reportParams;
    args[2] = sessionID;
    xml = this.generateReportSQLIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.generateReportSQL_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.generateReportSQL_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#generateReportSQL';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_ReportEditingServiceSoap.prototype.generateReportSQL = SAWSOAP_generateReportSQL_op;

function SAWSOAP_generateReportSQLIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_generateReportSQL();
    wrapperObj.setReportRef(args[0]);
    wrapperObj.setReportParams(args[1]);
    ...
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:generateReportSQL', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_ReportEditingServiceSoap.prototype.generateReportSQLIn_serializeInput = SAWSOAP_generateReportSQLIn_serializeInput;

function SAWSOAP_generateReportSQLOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_generateReportSQLResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_ReportEditingServiceSoap_SAWSOAP_ReportEditingServiceSoap () {
  this.url = 'http://166.78.244.8:9522/analytics/saw.dll?SoapImpl=reportService';
}
SAWSOAP_ReportEditingServiceSoap_SAWSOAP_ReportEditingServiceSoap.prototype = new SAWSOAP_ReportEditingServiceSoap;
