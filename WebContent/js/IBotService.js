...
//
// Definitions for service: {urn://oracle.bi.webservices/v6}IBotService
//

// Javascript for {urn://oracle.bi.webservices/v6}IBotServiceSoap

function SAWSOAP_IBotServiceSoap () {
...
function SAWSOAP_subscribe_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     ...
     this.jsutils.trace('calling SAWSOAP_subscribeIBotOut_deserializeResponse');
     responseObject = SAWSOAP_subscribeIBotOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_IBotServiceSoap.prototype.subscribe_onsuccess = SAWSOAP_subscribe_op_onsuccess;

function SAWSOAP_subscribe_op_onerror(client) {
...
SAWSOAP_IBotServiceSoap.prototype.subscribe_onerror = SAWSOAP_subscribe_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}subscribe
// Wrapped operation.
// parameter path
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter customizationXml
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_subscribe_op(successCallback, errorCallback, path, customizationXml, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(3);
    args[0] = path;
    args[1] = customizationXml;
    args[2] = sessionID;
    xml = this.subscribeIBotIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.subscribe_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.subscribe_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#subscribe';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_IBotServiceSoap.prototype.subscribe = SAWSOAP_subscribe_op;

function SAWSOAP_subscribeIBotIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_subscribe();
    wrapperObj.setPath(args[0]);
    wrapperObj.setCustomizationXml(args[1]);
    wrapperObj.setSessionID(args[2]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:subscribe', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_IBotServiceSoap.prototype.subscribeIBotIn_serializeInput = SAWSOAP_subscribeIBotIn_serializeInput;

function SAWSOAP_subscribeIBotOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_unsubscribe_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_unsubscribeIBotOut_deserializeResponse');
     responseObject = SAWSOAP_unsubscribeIBotOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_IBotServiceSoap.prototype.unsubscribe_onsuccess = SAWSOAP_unsubscribe_op_onsuccess;

function SAWSOAP_unsubscribe_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_IBotServiceSoap.prototype.unsubscribe_onerror = SAWSOAP_unsubscribe_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}unsubscribe
// Wrapped operation.
// parameter path
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_unsubscribe_op(successCallback, errorCallback, path, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = path;
    args[1] = sessionID;
    xml = this.unsubscribeIBotIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.unsubscribe_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.unsubscribe_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#unsubscribe';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_IBotServiceSoap.prototype.unsubscribe = SAWSOAP_unsubscribe_op;

function SAWSOAP_unsubscribeIBotIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_unsubscribe();
    wrapperObj.setPath(args[0]);
    ...
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:unsubscribe', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_IBotServiceSoap.prototype.unsubscribeIBotIn_serializeInput = SAWSOAP_unsubscribeIBotIn_serializeInput;

function SAWSOAP_unsubscribeIBotOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_executeIBotNow_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_executeIBotNowOut_deserializeResponse');
     responseObject = SAWSOAP_executeIBotNowOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_IBotServiceSoap.prototype.executeIBotNow_onsuccess = SAWSOAP_executeIBotNow_op_onsuccess;

function SAWSOAP_executeIBotNow_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_IBotServiceSoap.prototype.executeIBotNow_onerror = SAWSOAP_executeIBotNow_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}executeIBotNow
// Wrapped operation.
// parameter path
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_executeIBotNow_op(successCallback, errorCallback, path, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = path;
    args[1] = sessionID;
    xml = this.executeIBotNowIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.executeIBotNow_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.executeIBotNow_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#executeIBotNow';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_IBotServiceSoap.prototype.executeIBotNow = SAWSOAP_executeIBotNow_op;

function SAWSOAP_executeIBotNowIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_executeIBotNow();
    wrapperObj.setPath(args[0]);
    wrapperObj.setSessionID(args[1]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:executeIBotNow', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_IBotServiceSoap.prototype.executeIBotNowIn_serializeInput = SAWSOAP_executeIBotNowIn_serializeInput;

function SAWSOAP_executeIBotNowOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_sendMessage_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_sendMessageOut_deserializeResponse');
     responseObject = SAWSOAP_sendMessageOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_IBotServiceSoap.prototype.sendMessage_onsuccess = SAWSOAP_sendMessage_op_onsuccess;

function SAWSOAP_sendMessage_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_IBotServiceSoap.prototype.sendMessage_onerror = SAWSOAP_sendMessage_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}sendMessage
// Wrapped operation.
// parameter recipient
// - array
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter group
// - array
...
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter priority
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_sendMessage_op(successCallback, errorCallback, recipient, group, subject, body, priority, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    ...
    args[4] = priority;
    args[5] = sessionID;
    xml = this.sendMessageIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.sendMessage_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.sendMessage_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#sendMessage';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_IBotServiceSoap.prototype.sendMessage = SAWSOAP_sendMessage_op;

function SAWSOAP_sendMessageIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_sendMessage();
    wrapperObj.setRecipient(args[0]);
    wrapperObj.setGroup(args[1]);
    wrapperObj.setSubject(args[2]);
    wrapperObj.setBody(args[3]);
    wrapperObj.setPriority(args[4]);
    wrapperObj.setSessionID(args[5]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:sendMessage', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_IBotServiceSoap.prototype.sendMessageIn_serializeInput = SAWSOAP_sendMessageIn_serializeInput;

function SAWSOAP_sendMessageOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_sendMessageResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_writeIBot_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_writeIBotOut_deserializeResponse');
     responseObject = SAWSOAP_writeIBotOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_IBotServiceSoap.prototype.writeIBot_onsuccess = SAWSOAP_writeIBot_op_onsuccess;

function SAWSOAP_writeIBot_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_IBotServiceSoap.prototype.writeIBot_onerror = SAWSOAP_writeIBot_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}writeIBot
// Wrapped operation.
// parameter obj
// - Object constructor is SAWSOAP_CatalogObject
// parameter path
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter resolveLinks
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter allowOverwrite
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_writeIBot_op(successCallback, errorCallback, obj, path, resolveLinks, allowOverwrite, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    ...
    args[1] = path;
    args[2] = resolveLinks;
    args[3] = allowOverwrite;
    args[4] = sessionID;
    xml = this.writeIBotIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.writeIBot_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.writeIBot_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#writeIBot';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_IBotServiceSoap.prototype.writeIBot = SAWSOAP_writeIBot_op;

function SAWSOAP_writeIBotIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_writeIBot();
    wrapperObj.setObj(args[0]);
    wrapperObj.setPath(args[1]);
    wrapperObj.setResolveLinks(args[2]);
    wrapperObj.setAllowOverwrite(args[3]);
    wrapperObj.setSessionID(args[4]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:writeIBot', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_IBotServiceSoap.prototype.writeIBotIn_serializeInput = SAWSOAP_writeIBotIn_serializeInput;

function SAWSOAP_writeIBotOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_writeIBotResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_moveIBot_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_moveIBotOut_deserializeResponse');
     responseObject = SAWSOAP_moveIBotOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_IBotServiceSoap.prototype.moveIBot_onsuccess = SAWSOAP_moveIBot_op_onsuccess;

function SAWSOAP_moveIBot_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_IBotServiceSoap.prototype.moveIBot_onerror = SAWSOAP_moveIBot_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}moveIBot
// Wrapped operation.
// parameter fromPath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter toPath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter resolveLinks
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter allowOverwrite
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_moveIBot_op(successCallback, errorCallback, fromPath, toPath, resolveLinks, allowOverwrite, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(5);
    args[0] = fromPath;
    ...
    args[3] = allowOverwrite;
    args[4] = sessionID;
    xml = this.moveIBotIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.moveIBot_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.moveIBot_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#moveIBot';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_IBotServiceSoap.prototype.moveIBot = SAWSOAP_moveIBot_op;

function SAWSOAP_moveIBotIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_moveIBot();
    wrapperObj.setFromPath(args[0]);
    wrapperObj.setToPath(args[1]);
    wrapperObj.setResolveLinks(args[2]);
    wrapperObj.setAllowOverwrite(args[3]);
    wrapperObj.setSessionID(args[4]);
    var xml;
    ...
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:moveIBot', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_IBotServiceSoap.prototype.moveIBotIn_serializeInput = SAWSOAP_moveIBotIn_serializeInput;

function SAWSOAP_moveIBotOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_deleteIBot_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_deleteIBotOut_deserializeResponse');
     responseObject = SAWSOAP_deleteIBotOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_IBotServiceSoap.prototype.deleteIBot_onsuccess = SAWSOAP_deleteIBot_op_onsuccess;

function SAWSOAP_deleteIBot_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_IBotServiceSoap.prototype.deleteIBot_onerror = SAWSOAP_deleteIBot_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}deleteIBot
// Wrapped operation.
// parameter path
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_deleteIBot_op(successCallback, errorCallback, path, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = path;
    args[1] = sessionID;
    xml = this.deleteIBotIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.deleteIBot_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.deleteIBot_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#deleteIBot';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_IBotServiceSoap.prototype.deleteIBot = SAWSOAP_deleteIBot_op;

function SAWSOAP_deleteIBotIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_deleteIBot();
    wrapperObj.setPath(args[0]);
    wrapperObj.setSessionID(args[1]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:deleteIBot', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_IBotServiceSoap.prototype.deleteIBotIn_serializeInput = SAWSOAP_deleteIBotIn_serializeInput;

function SAWSOAP_deleteIBotOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_IBotServiceSoap_SAWSOAP_IBotServiceSoap () {
  this.url = 'http://166.78.244.8:9522/analytics/saw.dll?SoapImpl=ibotService';
}
SAWSOAP_IBotServiceSoap_SAWSOAP_IBotServiceSoap.prototype = new SAWSOAP_IBotServiceSoap;
