...
//
// Definitions for service: {urn://oracle.bi.webservices/v6}SecurityService
//

// Javascript for {urn://oracle.bi.webservices/v6}SecurityServiceSoap

function SAWSOAP_SecurityServiceSoap () {
...
function SAWSOAP_forgetAccounts_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     ...
     this.jsutils.trace('calling SAWSOAP_forgetAccountsOut_deserializeResponse');
     responseObject = SAWSOAP_forgetAccountsOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_SecurityServiceSoap.prototype.forgetAccounts_onsuccess = SAWSOAP_forgetAccounts_op_onsuccess;

function SAWSOAP_forgetAccounts_op_onerror(client) {
...
SAWSOAP_SecurityServiceSoap.prototype.forgetAccounts_onerror = SAWSOAP_forgetAccounts_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}forgetAccounts
// Wrapped operation.
// parameter account
// - array
// - Object constructor is SAWSOAP_Account
// parameter cleanuplevel
// - simple type {http://www.w3.org/2001/XMLSchema}int// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_forgetAccounts_op(successCallback, errorCallback, account, cleanuplevel, sessionID) {
    ...
    args[1] = cleanuplevel;
    args[2] = sessionID;
    xml = this.forgetAccountsIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.forgetAccounts_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.forgetAccounts_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#forgetAccounts';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SecurityServiceSoap.prototype.forgetAccounts = SAWSOAP_forgetAccounts_op;

function SAWSOAP_forgetAccountsIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_forgetAccounts();
    wrapperObj.setAccount(args[0]);
    wrapperObj.setCleanuplevel(args[1]);
    wrapperObj.setSessionID(args[2]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:forgetAccounts', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_SecurityServiceSoap.prototype.forgetAccountsIn_serializeInput = SAWSOAP_forgetAccountsIn_serializeInput;

function SAWSOAP_forgetAccountsOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_getGlobalPrivileges_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_getGlobalPrivilegesOut_deserializeResponse');
     responseObject = SAWSOAP_getGlobalPrivilegesOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_SecurityServiceSoap.prototype.getGlobalPrivileges_onsuccess = SAWSOAP_getGlobalPrivileges_op_onsuccess;

function SAWSOAP_getGlobalPrivileges_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_SecurityServiceSoap.prototype.getGlobalPrivileges_onerror = SAWSOAP_getGlobalPrivileges_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getGlobalPrivileges
// Wrapped operation.
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getGlobalPrivileges_op(successCallback, errorCallback, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(1);
    args[0] = sessionID;
    xml = this.getGlobalPrivilegesIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.getGlobalPrivileges_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.getGlobalPrivileges_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#getGlobalPrivileges';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SecurityServiceSoap.prototype.getGlobalPrivileges = SAWSOAP_getGlobalPrivileges_op;

function SAWSOAP_getGlobalPrivilegesIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_getGlobalPrivileges();
    wrapperObj.setSessionID(args[0]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getGlobalPrivileges', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_SecurityServiceSoap.prototype.getGlobalPrivilegesIn_serializeInput = SAWSOAP_getGlobalPrivilegesIn_serializeInput;

function SAWSOAP_getGlobalPrivilegesOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_getGlobalPrivilegesResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_joinGroups_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_joinGroupsOut_deserializeResponse');
     responseObject = SAWSOAP_joinGroupsOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_SecurityServiceSoap.prototype.joinGroups_onsuccess = SAWSOAP_joinGroups_op_onsuccess;

function SAWSOAP_joinGroups_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_SecurityServiceSoap.prototype.joinGroups_onerror = SAWSOAP_joinGroups_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}joinGroups
// Wrapped operation.
// parameter group
// - array
// - Object constructor is SAWSOAP_Account
...
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_joinGroups_op(successCallback, errorCallback, group, member, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(3);
    args[0] = group;
    args[1] = member;
    args[2] = sessionID;
    xml = this.joinGroupsIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.joinGroups_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.joinGroups_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#joinGroups';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SecurityServiceSoap.prototype.joinGroups = SAWSOAP_joinGroups_op;

function SAWSOAP_joinGroupsIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_joinGroups();
    wrapperObj.setGroup(args[0]);
    wrapperObj.setMember(args[1]);
    wrapperObj.setSessionID(args[2]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:joinGroups', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_SecurityServiceSoap.prototype.joinGroupsIn_serializeInput = SAWSOAP_joinGroupsIn_serializeInput;

function SAWSOAP_joinGroupsOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_getGroups_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_getGroupsOut_deserializeResponse');
     responseObject = SAWSOAP_getGroupsOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_SecurityServiceSoap.prototype.getGroups_onsuccess = SAWSOAP_getGroups_op_onsuccess;

function SAWSOAP_getGroups_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_SecurityServiceSoap.prototype.getGroups_onerror = SAWSOAP_getGroups_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getGroups
// Wrapped operation.
// parameter member
// - array
// - Object constructor is SAWSOAP_Account
// parameter expandGroups
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getGroups_op(successCallback, errorCallback, member, expandGroups, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(3);
    args[0] = member;
    args[1] = expandGroups;
    args[2] = sessionID;
    xml = this.getGroupsIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.getGroups_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.getGroups_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#getGroups';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SecurityServiceSoap.prototype.getGroups = SAWSOAP_getGroups_op;

function SAWSOAP_getGroupsIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_getGroups();
    wrapperObj.setMember(args[0]);
    wrapperObj.setExpandGroups(args[1]);
    wrapperObj.setSessionID(args[2]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getGroups', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_SecurityServiceSoap.prototype.getGroupsIn_serializeInput = SAWSOAP_getGroupsIn_serializeInput;

function SAWSOAP_getGroupsOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_getGroupsResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_getMembers_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_getMembersOut_deserializeResponse');
     responseObject = SAWSOAP_getMembersOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_SecurityServiceSoap.prototype.getMembers_onsuccess = SAWSOAP_getMembers_op_onsuccess;

function SAWSOAP_getMembers_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_SecurityServiceSoap.prototype.getMembers_onerror = SAWSOAP_getMembers_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getMembers
// Wrapped operation.
// parameter group
// - array
// - Object constructor is SAWSOAP_Account
...
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getMembers_op(successCallback, errorCallback, group, expandGroups, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(3);
    args[0] = group;
    args[1] = expandGroups;
    args[2] = sessionID;
    xml = this.getMembersIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.getMembers_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.getMembers_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#getMembers';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SecurityServiceSoap.prototype.getMembers = SAWSOAP_getMembers_op;

function SAWSOAP_getMembersIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_getMembers();
    wrapperObj.setGroup(args[0]);
    wrapperObj.setExpandGroups(args[1]);
    wrapperObj.setSessionID(args[2]);
    var xml;
    ...
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getMembers', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_SecurityServiceSoap.prototype.getMembersIn_serializeInput = SAWSOAP_getMembersIn_serializeInput;

function SAWSOAP_getMembersOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_getMembersResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_getPrivilegesStatus_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_getPrivilegesStatusOut_deserializeResponse');
     responseObject = SAWSOAP_getPrivilegesStatusOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_SecurityServiceSoap.prototype.getPrivilegesStatus_onsuccess = SAWSOAP_getPrivilegesStatus_op_onsuccess;

function SAWSOAP_getPrivilegesStatus_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_SecurityServiceSoap.prototype.getPrivilegesStatus_onerror = SAWSOAP_getPrivilegesStatus_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getPrivilegesStatus
// Wrapped operation.
// parameter privileges
// - array
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getPrivilegesStatus_op(successCallback, errorCallback, privileges, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = privileges;
    args[1] = sessionID;
    xml = this.getPrivilegesStatusIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.getPrivilegesStatus_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.getPrivilegesStatus_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#getPrivilegesStatus';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SecurityServiceSoap.prototype.getPrivilegesStatus = SAWSOAP_getPrivilegesStatus_op;

function SAWSOAP_getPrivilegesStatusIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_getPrivilegesStatus();
    wrapperObj.setPrivileges(args[0]);
    wrapperObj.setSessionID(args[1]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getPrivilegesStatus', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_SecurityServiceSoap.prototype.getPrivilegesStatusIn_serializeInput = SAWSOAP_getPrivilegesStatusIn_serializeInput;

function SAWSOAP_getPrivilegesStatusOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_getPrivilegesStatusResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_getPermissions_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_getPermissionsOut_deserializeResponse');
     responseObject = SAWSOAP_getPermissionsOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_SecurityServiceSoap.prototype.getPermissions_onsuccess = SAWSOAP_getPermissions_op_onsuccess;

function SAWSOAP_getPermissions_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_SecurityServiceSoap.prototype.getPermissions_onerror = SAWSOAP_getPermissions_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getPermissions
// Wrapped operation.
// parameter acls
// - array
// - Object constructor is SAWSOAP_ACL
// parameter account
// - Object constructor is SAWSOAP_Account
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getPermissions_op(successCallback, errorCallback, acls, account, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(3);
    args[0] = acls;
    args[1] = account;
    args[2] = sessionID;
    xml = this.getPermissionsIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.getPermissions_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.getPermissions_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#getPermissions';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SecurityServiceSoap.prototype.getPermissions = SAWSOAP_getPermissions_op;

function SAWSOAP_getPermissionsIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_getPermissions();
    wrapperObj.setAcls(args[0]);
    wrapperObj.setAccount(args[1]);
    wrapperObj.setSessionID(args[2]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getPermissions', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_SecurityServiceSoap.prototype.getPermissionsIn_serializeInput = SAWSOAP_getPermissionsIn_serializeInput;

function SAWSOAP_getPermissionsOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_getPermissionsResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_updateGlobalPrivilegeACL_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_updateGlobalPrivilegeACLOut_deserializeResponse');
     responseObject = SAWSOAP_updateGlobalPrivilegeACLOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_SecurityServiceSoap.prototype.updateGlobalPrivilegeACL_onsuccess = SAWSOAP_updateGlobalPrivilegeACL_op_onsuccess;

function SAWSOAP_updateGlobalPrivilegeACL_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_SecurityServiceSoap.prototype.updateGlobalPrivilegeACL_onerror = SAWSOAP_updateGlobalPrivilegeACL_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}updateGlobalPrivilegeACL
// Wrapped operation.
// parameter privilegeName
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter acl
// - Object constructor is SAWSOAP_ACL
// parameter updateACLParams
// - Object constructor is SAWSOAP_UpdateACLParams
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_updateGlobalPrivilegeACL_op(successCallback, errorCallback, privilegeName, acl, updateACLParams, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(4);
    args[0] = privilegeName;
    args[1] = acl;
    args[2] = updateACLParams;
    args[3] = sessionID;
    xml = this.updateGlobalPrivilegeACLIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.updateGlobalPrivilegeACL_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.updateGlobalPrivilegeACL_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#updateGlobalPrivilegeACL';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SecurityServiceSoap.prototype.updateGlobalPrivilegeACL = SAWSOAP_updateGlobalPrivilegeACL_op;

function SAWSOAP_updateGlobalPrivilegeACLIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_updateGlobalPrivilegeACL();
    wrapperObj.setPrivilegeName(args[0]);
    wrapperObj.setAcl(args[1]);
    wrapperObj.setUpdateACLParams(args[2]);
    wrapperObj.setSessionID(args[3]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:updateGlobalPrivilegeACL', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_SecurityServiceSoap.prototype.updateGlobalPrivilegeACLIn_serializeInput = SAWSOAP_updateGlobalPrivilegeACLIn_serializeInput;

function SAWSOAP_updateGlobalPrivilegeACLOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_renameAccounts_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_renameAccountsOut_deserializeResponse');
     responseObject = SAWSOAP_renameAccountsOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_SecurityServiceSoap.prototype.renameAccounts_onsuccess = SAWSOAP_renameAccounts_op_onsuccess;

function SAWSOAP_renameAccounts_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_SecurityServiceSoap.prototype.renameAccounts_onerror = SAWSOAP_renameAccounts_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}renameAccounts
// Wrapped operation.
// parameter from
// - array
// - Object constructor is SAWSOAP_Account
...
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_renameAccounts_op(successCallback, errorCallback, from, to, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(3);
    args[0] = from;
    args[1] = to;
    args[2] = sessionID;
    xml = this.renameAccountsIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.renameAccounts_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.renameAccounts_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#renameAccounts';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SecurityServiceSoap.prototype.renameAccounts = SAWSOAP_renameAccounts_op;

function SAWSOAP_renameAccountsIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_renameAccounts();
    wrapperObj.setFrom(args[0]);
    wrapperObj.setTo(args[1]);
    wrapperObj.setSessionID(args[2]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:renameAccounts', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_SecurityServiceSoap.prototype.renameAccountsIn_serializeInput = SAWSOAP_renameAccountsIn_serializeInput;

function SAWSOAP_renameAccountsOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_isMember_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_isMemberOut_deserializeResponse');
     responseObject = SAWSOAP_isMemberOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_SecurityServiceSoap.prototype.isMember_onsuccess = SAWSOAP_isMember_op_onsuccess;

function SAWSOAP_isMember_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_SecurityServiceSoap.prototype.isMember_onerror = SAWSOAP_isMember_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}isMember
// Wrapped operation.
// parameter group
// - array
// - Object constructor is SAWSOAP_Account
...
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_isMember_op(successCallback, errorCallback, group, member, expandGroups, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(4);
    args[0] = group;
    ...
    args[2] = expandGroups;
    args[3] = sessionID;
    xml = this.isMemberIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.isMember_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.isMember_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#isMember';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SecurityServiceSoap.prototype.isMember = SAWSOAP_isMember_op;

function SAWSOAP_isMemberIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_isMember();
    wrapperObj.setGroup(args[0]);
    wrapperObj.setMember(args[1]);
    wrapperObj.setExpandGroups(args[2]);
    wrapperObj.setSessionID(args[3]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:isMember', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_SecurityServiceSoap.prototype.isMemberIn_serializeInput = SAWSOAP_isMemberIn_serializeInput;

function SAWSOAP_isMemberOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_isMemberResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_getAccounts_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_getAccountsOut_deserializeResponse');
     responseObject = SAWSOAP_getAccountsOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_SecurityServiceSoap.prototype.getAccounts_onsuccess = SAWSOAP_getAccounts_op_onsuccess;

function SAWSOAP_getAccounts_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_SecurityServiceSoap.prototype.getAccounts_onerror = SAWSOAP_getAccounts_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getAccounts
// Wrapped operation.
// parameter account
// - array
// - Object constructor is SAWSOAP_Account
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getAccounts_op(successCallback, errorCallback, account, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = account;
    args[1] = sessionID;
    xml = this.getAccountsIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.getAccounts_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.getAccounts_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#getAccounts';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SecurityServiceSoap.prototype.getAccounts = SAWSOAP_getAccounts_op;

function SAWSOAP_getAccountsIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_getAccounts();
    wrapperObj.setAccount(args[0]);
    wrapperObj.setSessionID(args[1]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getAccounts', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_SecurityServiceSoap.prototype.getAccountsIn_serializeInput = SAWSOAP_getAccountsIn_serializeInput;

function SAWSOAP_getAccountsOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_getAccountsResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_leaveGroups_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_leaveGroupsOut_deserializeResponse');
     responseObject = SAWSOAP_leaveGroupsOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_SecurityServiceSoap.prototype.leaveGroups_onsuccess = SAWSOAP_leaveGroups_op_onsuccess;

function SAWSOAP_leaveGroups_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_SecurityServiceSoap.prototype.leaveGroups_onerror = SAWSOAP_leaveGroups_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}leaveGroups
// Wrapped operation.
// parameter group
// - array
// - Object constructor is SAWSOAP_Account
...
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_leaveGroups_op(successCallback, errorCallback, group, member, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(3);
    args[0] = group;
    args[1] = member;
    args[2] = sessionID;
    xml = this.leaveGroupsIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.leaveGroups_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.leaveGroups_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#leaveGroups';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SecurityServiceSoap.prototype.leaveGroups = SAWSOAP_leaveGroups_op;

function SAWSOAP_leaveGroupsIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_leaveGroups();
    wrapperObj.setGroup(args[0]);
    wrapperObj.setMember(args[1]);
    wrapperObj.setSessionID(args[2]);
    var xml;
    ...
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:leaveGroups', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_SecurityServiceSoap.prototype.leaveGroupsIn_serializeInput = SAWSOAP_leaveGroupsIn_serializeInput;

function SAWSOAP_leaveGroupsOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_getGlobalPrivilegeACL_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_getGlobalPrivilegeACLOut_deserializeResponse');
     responseObject = SAWSOAP_getGlobalPrivilegeACLOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_SecurityServiceSoap.prototype.getGlobalPrivilegeACL_onsuccess = SAWSOAP_getGlobalPrivilegeACL_op_onsuccess;

function SAWSOAP_getGlobalPrivilegeACL_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_SecurityServiceSoap.prototype.getGlobalPrivilegeACL_onerror = SAWSOAP_getGlobalPrivilegeACL_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getGlobalPrivilegeACL
// Wrapped operation.
// parameter privilegeName
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getGlobalPrivilegeACL_op(successCallback, errorCallback, privilegeName, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = privilegeName;
    args[1] = sessionID;
    xml = this.getGlobalPrivilegeACLIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.getGlobalPrivilegeACL_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.getGlobalPrivilegeACL_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#getGlobalPrivilegeACL';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_SecurityServiceSoap.prototype.getGlobalPrivilegeACL = SAWSOAP_getGlobalPrivilegeACL_op;

function SAWSOAP_getGlobalPrivilegeACLIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_getGlobalPrivilegeACL();
    wrapperObj.setPrivilegeName(args[0]);
    wrapperObj.setSessionID(args[1]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getGlobalPrivilegeACL', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_SecurityServiceSoap.prototype.getGlobalPrivilegeACLIn_serializeInput = SAWSOAP_getGlobalPrivilegeACLIn_serializeInput;

function SAWSOAP_getGlobalPrivilegeACLOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_getGlobalPrivilegeACLResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_SecurityServiceSoap_SAWSOAP_SecurityServiceSoap () {
  this.url = 'http://166.78.244.8:9522/analytics/saw.dll?SoapImpl=securityService';
}
SAWSOAP_SecurityServiceSoap_SAWSOAP_SecurityServiceSoap.prototype = new SAWSOAP_SecurityServiceSoap;
