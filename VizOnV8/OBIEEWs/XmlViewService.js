//define the Fault constructor 
function Fault()
{
	this.typeMarker = 'Fault';
	this._faultCode = '';
	this._faultString = '';
}

//get and set methods for parameters.
function Fault_getFaultCode() { return this._faultCode;}

Fault.prototype.getFaultCode = Fault_getFaultCode;

function Fault_getFaultString() { return this._faultString;}

Fault.prototype.getFaultString = Fault_getFaultString;

function Fault_setFaultCode(value) { this._faultCode = value;}
Fault.prototype.setFaultCode = Fault_setFaultCode;

function Fault_setFaultString(value) { this._faultString = value;}
Fault.prototype.setFaultString = Fault_setFaultString;
...
function SAWSOAP_QueryResults_deserialize (cxfjsutils, element) {
    ...
    var value = null;
    if (!cxfjsutils.isElementNil(curElement)) {
		//Here we need to get the element value by element value.
		//We need to store it json.
		/*var r = "";
			for (var x = 0; x < node.childNodes.length; x++) {
		r = r + node.childNodes[x].nodeValue;
		//document.write("<br>column data : "+r+"<br>");
	}
	return r;*/
	//this code checks whether rowset child element.
	if(curElement.hasChildNodes())
	{
		var cnode = curElement.childNodes[0];
		//get the data from 'cnode' and set it as rowset.
		newobject.setRowset(cnode.data);
	}
    }
    var item = null;
    if (curElement != null) {
...
//
// Definitions for service: {urn://oracle.bi.webservices/v6}XmlViewService
//

// Javascript for {urn://oracle.bi.webservices/v6}XmlViewServiceSoap

function SAWSOAP_XmlViewServiceSoap () {
...
function SAWSOAP_executeSQLQuery_op_onsuccess(client, responseXml) {
	var xmlDoc;
	if (window.DOMParser) {
    ...
    if (client.user_onsuccess) {
     ...
     while (!this.jsutils.isNodeNamedNS(element, 'http://schemas.xmlsoap.org/soap/envelope/', 'Body')) {
      ...
      if (element == null) {
		  //body tag is not there in response xml.
       throw 'No env:Body in message.'
      }
     }
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_describeColumnOut_deserializeResponse');
     ...
     responseObject = SAWSOAP_executeSQLQueryOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
	 }
    }
}

SAWSOAP_XmlViewServiceSoap.prototype.executeSQLQuery_onsuccess = SAWSOAP_executeSQLQuery_op_onsuccess;

function SAWSOAP_executeSQLQuery_op_onerror(client) {
...
SAWSOAP_XmlViewServiceSoap.prototype.executeSQLQuery_onerror = SAWSOAP_executeSQLQuery_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}executeSQLQuery
// Wrapped operation.
// parameter sql
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter outputFormat
// - simple type {urn://oracle.bi.webservices/v6}XMLQueryOutputFormat// parameter executionOptions
// - Object constructor is SAWSOAP_XMLQueryExecutionOptions
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_executeSQLQuery_op(successCallback, errorCallback, sql, outputFormat, executionOptions, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(4);
    args[0] = sql;
    args[1] = outputFormat;
    args[2] = executionOptions;
    args[3] = sessionID;
    xml = this.executeSQLQueryIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.executeSQLQuery_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.executeSQLQuery_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#executeSQLQuery';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_XmlViewServiceSoap.prototype.executeSQLQuery = SAWSOAP_executeSQLQuery_op;

function SAWSOAP_executeSQLQueryIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_executeSQLQuery();
    wrapperObj.setSql(args[0]);
    wrapperObj.setOutputFormat(args[1]);
    wrapperObj.setExecutionOptions(args[2]);
    wrapperObj.setSessionID(args[3]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:executeSQLQuery', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_XmlViewServiceSoap.prototype.executeSQLQueryIn_serializeInput = SAWSOAP_executeSQLQueryIn_serializeInput;

function SAWSOAP_executeSQLQueryOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_executeSQLQueryResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_fetchNext_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_fetchNextOut_deserializeResponse');
     responseObject = SAWSOAP_fetchNextOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_XmlViewServiceSoap.prototype.fetchNext_onsuccess = SAWSOAP_fetchNext_op_onsuccess;

function SAWSOAP_fetchNext_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_XmlViewServiceSoap.prototype.fetchNext_onerror = SAWSOAP_fetchNext_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}fetchNext
// Wrapped operation.
// parameter queryID
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_fetchNext_op(successCallback, errorCallback, queryID, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = queryID;
    args[1] = sessionID;
    xml = this.fetchNextIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.fetchNext_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.fetchNext_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#fetchNext';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_XmlViewServiceSoap.prototype.fetchNext = SAWSOAP_fetchNext_op;

function SAWSOAP_fetchNextIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_fetchNext();
    wrapperObj.setQueryID(args[0]);
    wrapperObj.setSessionID(args[1]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:fetchNext', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_XmlViewServiceSoap.prototype.fetchNextIn_serializeInput = SAWSOAP_fetchNextIn_serializeInput;

function SAWSOAP_fetchNextOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_fetchNextResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_cancelQuery_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_cancelQueryOut_deserializeResponse');
     responseObject = SAWSOAP_cancelQueryOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_XmlViewServiceSoap.prototype.cancelQuery_onsuccess = SAWSOAP_cancelQuery_op_onsuccess;

function SAWSOAP_cancelQuery_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_XmlViewServiceSoap.prototype.cancelQuery_onerror = SAWSOAP_cancelQuery_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}cancelQuery
// Wrapped operation.
// parameter queryID
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_cancelQuery_op(successCallback, errorCallback, queryID, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = queryID;
    args[1] = sessionID;
    xml = this.cancelQueryIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.cancelQuery_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.cancelQuery_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#cancelQuery';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_XmlViewServiceSoap.prototype.cancelQuery = SAWSOAP_cancelQuery_op;

function SAWSOAP_cancelQueryIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_cancelQuery();
    wrapperObj.setQueryID(args[0]);
    wrapperObj.setSessionID(args[1]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:cancelQuery', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_XmlViewServiceSoap.prototype.cancelQueryIn_serializeInput = SAWSOAP_cancelQueryIn_serializeInput;

function SAWSOAP_cancelQueryOut_deserializeResponse(cxfjsutils, partElement) {
}
function SAWSOAP_getPromptedFilters_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_getPromptedFiltersOut_deserializeResponse');
     responseObject = SAWSOAP_getPromptedFiltersOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_XmlViewServiceSoap.prototype.getPromptedFilters_onsuccess = SAWSOAP_getPromptedFilters_op_onsuccess;

function SAWSOAP_getPromptedFilters_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_XmlViewServiceSoap.prototype.getPromptedFilters_onerror = SAWSOAP_getPromptedFilters_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getPromptedFilters
// Wrapped operation.
// parameter report
// - Object constructor is SAWSOAP_ReportRef
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getPromptedFilters_op(successCallback, errorCallback, report, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = report;
    args[1] = sessionID;
    xml = this.getPromptedFiltersIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.getPromptedFilters_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.getPromptedFilters_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#getPromptedFilters';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_XmlViewServiceSoap.prototype.getPromptedFilters = SAWSOAP_getPromptedFilters_op;

function SAWSOAP_getPromptedFiltersIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_getPromptedFilters();
    ...
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getPromptedFilters', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_XmlViewServiceSoap.prototype.getPromptedFiltersIn_serializeInput = SAWSOAP_getPromptedFiltersIn_serializeInput;

function SAWSOAP_getPromptedFiltersOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_getPromptedFiltersResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_executeXMLQuery_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_executeXMLQueryOut_deserializeResponse');
     responseObject = SAWSOAP_executeXMLQueryOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_XmlViewServiceSoap.prototype.executeXMLQuery_onsuccess = SAWSOAP_executeXMLQuery_op_onsuccess;

function SAWSOAP_executeXMLQuery_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_XmlViewServiceSoap.prototype.executeXMLQuery_onerror = SAWSOAP_executeXMLQuery_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}executeXMLQuery
// Wrapped operation.
// parameter report
// - Object constructor is SAWSOAP_ReportRef
...
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_executeXMLQuery_op(successCallback, errorCallback, report, outputFormat, executionOptions, reportParams, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    ...
    args[3] = reportParams;
    args[4] = sessionID;
    xml = this.executeXMLQueryIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.executeXMLQuery_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.executeXMLQuery_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#executeXMLQuery';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_XmlViewServiceSoap.prototype.executeXMLQuery = SAWSOAP_executeXMLQuery_op;

function SAWSOAP_executeXMLQueryIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_executeXMLQuery();
    wrapperObj.setReport(args[0]);
    wrapperObj.setOutputFormat(args[1]);
    wrapperObj.setExecutionOptions(args[2]);
    ...
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:executeXMLQuery', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_XmlViewServiceSoap.prototype.executeXMLQueryIn_serializeInput = SAWSOAP_executeXMLQueryIn_serializeInput;

function SAWSOAP_executeXMLQueryOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_executeXMLQueryResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_upgradeXML_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_upgradeXMLOut_deserializeResponse');
     responseObject = SAWSOAP_upgradeXMLOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_XmlViewServiceSoap.prototype.upgradeXML_onsuccess = SAWSOAP_upgradeXML_op_onsuccess;

function SAWSOAP_upgradeXML_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_XmlViewServiceSoap.prototype.upgradeXML_onerror = SAWSOAP_upgradeXML_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}upgradeXML
// Wrapped operation.
// parameter xml
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_upgradeXML_op(successCallback, errorCallback, xml, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = xml;
    args[1] = sessionID;
    xml = this.upgradeXMLIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.upgradeXML_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.upgradeXML_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#upgradeXML';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_XmlViewServiceSoap.prototype.upgradeXML = SAWSOAP_upgradeXML_op;

function SAWSOAP_upgradeXMLIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_upgradeXML();
    wrapperObj.setXml(args[0]);
    wrapperObj.setSessionID(args[1]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:upgradeXML', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_XmlViewServiceSoap.prototype.upgradeXMLIn_serializeInput = SAWSOAP_upgradeXMLIn_serializeInput;

function SAWSOAP_upgradeXMLOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_upgradeXMLResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_XmlViewServiceSoap_SAWSOAP_XmlViewServiceSoap () {
  this.url = 'http://166.78.244.8:9522/analytics/saw.dll?SoapImpl=xmlViewService';
}
SAWSOAP_XmlViewServiceSoap_SAWSOAP_XmlViewServiceSoap.prototype = new SAWSOAP_XmlViewServiceSoap;
