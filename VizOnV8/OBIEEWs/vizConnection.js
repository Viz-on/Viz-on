...
var sessionId;
var hostString = '';
var issessionIdCreated;

// 'isHostStringBuild' this global variable is for checking whether the 'hostString' is present or not.
 //This variable will be useful at 'buildURL()' function.
var isHostStringBuild = false;
// 'urlType' checks whether url is 'http:' or 'https:'.
//Which is used in 'buildURL()'.
var urlType ;
//'genericURL' is the build URL.
//Which is independent of serviceName.
//This is for transferring URL from interactive phase to getDataPhase.
var genericURL;
var faultCode;
var faultString;
var subjectAreas;
var selectedSubjectArea;
var tables;
var selectedTables = [];
var columns;
var dataRowset;
var interactionPhaseFlag = false;
var selectedColumns = [];
var numberOfcolumnsSelected;
var currentTable;
var ssArea;
var sareas ;
var tableName;
var vizLogoffMessage;
var logOffFlag;
var httpStatusCd;
var httpStatusTxt;
...
//			+ "</option>");
	...
	for (var i = 0; i < sareas.length; i++) {
		ssArea = ((sareas[i].getName()).replace('"', '')).replace('"', '');
...
function tablesRendarer() {
	...
	for (var i = 0; i < tables.length; i++) {
		tableName = ((tables[i].getName()).replace('"', '')).replace('"','');
...
httpStatusCd = httpStatusCode;
httpStatusTxt = httpStatusText;
}
...
function logoffSuccessCallback() {
	vizLogoffMessage = 'Logedoff Successfully';
	logOffFlag = true;
}
function logoffErrorCallback() {
	vizLogoffMessage = 'Logoff NOT Successful';
	logOffFlag = false;
}
