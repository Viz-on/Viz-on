...
//
// Definitions for service: {urn://oracle.bi.webservices/v6}JobManagementService
//

// Javascript for {urn://oracle.bi.webservices/v6}JobManagementServiceSoap

function SAWSOAP_JobManagementServiceSoap () {
...
function SAWSOAP_purgeCache_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     ...
     this.jsutils.trace('calling SAWSOAP_purgeCacheOut_deserializeResponse');
     responseObject = SAWSOAP_purgeCacheOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_JobManagementServiceSoap.prototype.purgeCache_onsuccess = SAWSOAP_purgeCache_op_onsuccess;

function SAWSOAP_purgeCache_op_onerror(client) {
...
SAWSOAP_JobManagementServiceSoap.prototype.purgeCache_onerror = SAWSOAP_purgeCache_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}purgeCache
// Wrapped operation.
// parameter segmentPath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter treePath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter ignoreCacheRef
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_purgeCache_op(successCallback, errorCallback, segmentPath, treePath, ignoreCacheRef, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(4);
    args[0] = segmentPath;
    args[1] = treePath;
    args[2] = ignoreCacheRef;
    args[3] = sessionID;
    xml = this.purgeCacheIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.purgeCache_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.purgeCache_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#purgeCache';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_JobManagementServiceSoap.prototype.purgeCache = SAWSOAP_purgeCache_op;

function SAWSOAP_purgeCacheIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_purgeCache();
    wrapperObj.setSegmentPath(args[0]);
    wrapperObj.setTreePath(args[1]);
    wrapperObj.setIgnoreCacheRef(args[2]);
    wrapperObj.setSessionID(args[3]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:purgeCache', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_JobManagementServiceSoap.prototype.purgeCacheIn_serializeInput = SAWSOAP_purgeCacheIn_serializeInput;

function SAWSOAP_purgeCacheOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_purgeCacheResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_deleteResultSet_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_deleteResultSetOut_deserializeResponse');
     responseObject = SAWSOAP_deleteResultSetOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_JobManagementServiceSoap.prototype.deleteResultSet_onsuccess = SAWSOAP_deleteResultSet_op_onsuccess;

function SAWSOAP_deleteResultSet_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_JobManagementServiceSoap.prototype.deleteResultSet_onerror = SAWSOAP_deleteResultSet_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}deleteResultSet
// Wrapped operation.
// parameter targetLevel
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter GUIDs
// - Object constructor is SAWSOAP_arrayOfGUIDs
// parameter segmentPath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_deleteResultSet_op(successCallback, errorCallback, targetLevel, GUIDs, segmentPath, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(4);
    args[0] = targetLevel;
    ...
    args[2] = segmentPath;
    args[3] = sessionID;
    xml = this.deleteResultSetIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.deleteResultSet_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.deleteResultSet_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#deleteResultSet';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_JobManagementServiceSoap.prototype.deleteResultSet = SAWSOAP_deleteResultSet_op;

function SAWSOAP_deleteResultSetIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_deleteResultSet();
    wrapperObj.setTargetLevel(args[0]);
    wrapperObj.setGUIDs(args[1]);
    wrapperObj.setSegmentPath(args[2]);
    wrapperObj.setSessionID(args[3]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:deleteResultSet', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_JobManagementServiceSoap.prototype.deleteResultSetIn_serializeInput = SAWSOAP_deleteResultSetIn_serializeInput;

function SAWSOAP_deleteResultSetOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_deleteResultSetResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_getPromptedColumns_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_getPromptedColumnsOut_deserializeResponse');
     responseObject = SAWSOAP_getPromptedColumnsOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_JobManagementServiceSoap.prototype.getPromptedColumns_onsuccess = SAWSOAP_getPromptedColumns_op_onsuccess;

function SAWSOAP_getPromptedColumns_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_JobManagementServiceSoap.prototype.getPromptedColumns_onerror = SAWSOAP_getPromptedColumns_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getPromptedColumns
// Wrapped operation.
// parameter segmentPath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter treePath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getPromptedColumns_op(successCallback, errorCallback, segmentPath, treePath, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    ...
    args[1] = treePath;
    args[2] = sessionID;
    xml = this.getPromptedColumnsIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.getPromptedColumns_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.getPromptedColumns_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#getPromptedColumns';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_JobManagementServiceSoap.prototype.getPromptedColumns = SAWSOAP_getPromptedColumns_op;

function SAWSOAP_getPromptedColumnsIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_getPromptedColumns();
    wrapperObj.setSegmentPath(args[0]);
    wrapperObj.setTreePath(args[1]);
    ...
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getPromptedColumns', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_JobManagementServiceSoap.prototype.getPromptedColumnsIn_serializeInput = SAWSOAP_getPromptedColumnsIn_serializeInput;

function SAWSOAP_getPromptedColumnsOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_getPromptedColumnsResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_prepareCache_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_prepareCacheOut_deserializeResponse');
     responseObject = SAWSOAP_prepareCacheOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_JobManagementServiceSoap.prototype.prepareCache_onsuccess = SAWSOAP_prepareCache_op_onsuccess;

function SAWSOAP_prepareCache_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_JobManagementServiceSoap.prototype.prepareCache_onerror = SAWSOAP_prepareCache_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}prepareCache
// Wrapped operation.
// parameter segmentPath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter treePath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter refresh
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_prepareCache_op(successCallback, errorCallback, segmentPath, treePath, refresh, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(4);
    args[0] = segmentPath;
    ...
    args[2] = refresh;
    args[3] = sessionID;
    xml = this.prepareCacheIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.prepareCache_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.prepareCache_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#prepareCache';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_JobManagementServiceSoap.prototype.prepareCache = SAWSOAP_prepareCache_op;

function SAWSOAP_prepareCacheIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_prepareCache();
    wrapperObj.setSegmentPath(args[0]);
    wrapperObj.setTreePath(args[1]);
    wrapperObj.setRefresh(args[2]);
    wrapperObj.setSessionID(args[3]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:prepareCache', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_JobManagementServiceSoap.prototype.prepareCacheIn_serializeInput = SAWSOAP_prepareCacheIn_serializeInput;

function SAWSOAP_prepareCacheOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_prepareCacheResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_getCounts_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_getCountsOut_deserializeResponse');
     responseObject = SAWSOAP_getCountsOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_JobManagementServiceSoap.prototype.getCounts_onsuccess = SAWSOAP_getCounts_op_onsuccess;

function SAWSOAP_getCounts_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_JobManagementServiceSoap.prototype.getCounts_onerror = SAWSOAP_getCounts_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getCounts
// Wrapped operation.
// parameter segmentPath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter treePath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter segmentationOptions
// - Object constructor is SAWSOAP_SegmentationOptions
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getCounts_op(successCallback, errorCallback, segmentPath, treePath, segmentationOptions, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(4);
    args[0] = segmentPath;
    args[1] = treePath;
    args[2] = segmentationOptions;
    args[3] = sessionID;
    xml = this.getCountsIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.getCounts_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.getCounts_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#getCounts';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_JobManagementServiceSoap.prototype.getCounts = SAWSOAP_getCounts_op;

function SAWSOAP_getCountsIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_getCounts();
    wrapperObj.setSegmentPath(args[0]);
    wrapperObj.setTreePath(args[1]);
    wrapperObj.setSegmentationOptions(args[2]);
    wrapperObj.setSessionID(args[3]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getCounts', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_JobManagementServiceSoap.prototype.getCountsIn_serializeInput = SAWSOAP_getCountsIn_serializeInput;

function SAWSOAP_getCountsOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_getCountsResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_cancelJob_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_cancelJobOut_deserializeResponse');
     responseObject = SAWSOAP_cancelJobOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_JobManagementServiceSoap.prototype.cancelJob_onsuccess = SAWSOAP_cancelJob_op_onsuccess;

function SAWSOAP_cancelJob_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_JobManagementServiceSoap.prototype.cancelJob_onerror = SAWSOAP_cancelJob_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}cancelJob
// Wrapped operation.
// parameter jobID
// - simple type {http://www.w3.org/2001/XMLSchema}integer// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_cancelJob_op(successCallback, errorCallback, jobID, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = jobID;
    args[1] = sessionID;
    xml = this.cancelJobIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.cancelJob_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.cancelJob_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#cancelJob';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_JobManagementServiceSoap.prototype.cancelJob = SAWSOAP_cancelJob_op;

function SAWSOAP_cancelJobIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_cancelJob();
    wrapperObj.setJobID(args[0]);
    wrapperObj.setSessionID(args[1]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:cancelJob', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_JobManagementServiceSoap.prototype.cancelJobIn_serializeInput = SAWSOAP_cancelJobIn_serializeInput;

function SAWSOAP_cancelJobOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_cancelJobResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_writeListFiles_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_writeListFilesOut_deserializeResponse');
     responseObject = SAWSOAP_writeListFilesOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_JobManagementServiceSoap.prototype.writeListFiles_onsuccess = SAWSOAP_writeListFiles_op_onsuccess;

function SAWSOAP_writeListFiles_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_JobManagementServiceSoap.prototype.writeListFiles_onerror = SAWSOAP_writeListFiles_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}writeListFiles
// Wrapped operation.
// parameter report
...
// parameter segmentPath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter treeNodePath
// - Object constructor is SAWSOAP_TreeNodePath
// parameter segmentationOptions
// - Object constructor is SAWSOAP_SegmentationOptions
// parameter filesystem
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter timeout
// - simple type {http://www.w3.org/2001/XMLSchema}integer// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_writeListFiles_op(successCallback, errorCallback, report, reportParams, segmentPath, treeNodePath, segmentationOptions, filesystem, timeout, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    ...
    args[2] = segmentPath;
    args[3] = treeNodePath;
    args[4] = segmentationOptions;
    args[5] = filesystem;
    args[6] = timeout;
    args[7] = sessionID;
    xml = this.writeListFilesIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.writeListFiles_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.writeListFiles_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#writeListFiles';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_JobManagementServiceSoap.prototype.writeListFiles = SAWSOAP_writeListFiles_op;

function SAWSOAP_writeListFilesIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_writeListFiles();
    wrapperObj.setReport(args[0]);
    wrapperObj.setReportParams(args[1]);
    wrapperObj.setSegmentPath(args[2]);
    wrapperObj.setTreeNodePath(args[3]);
    wrapperObj.setSegmentationOptions(args[4]);
    wrapperObj.setFilesystem(args[5]);
    wrapperObj.setTimeout(args[6]);
    wrapperObj.setSessionID(args[7]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:writeListFiles', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_JobManagementServiceSoap.prototype.writeListFilesIn_serializeInput = SAWSOAP_writeListFilesIn_serializeInput;

function SAWSOAP_writeListFilesOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_writeListFilesResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_saveResultSet_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_saveResultSetOut_deserializeResponse');
     responseObject = SAWSOAP_saveResultSetOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_JobManagementServiceSoap.prototype.saveResultSet_onsuccess = SAWSOAP_saveResultSet_op_onsuccess;

function SAWSOAP_saveResultSet_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_JobManagementServiceSoap.prototype.saveResultSet_onerror = SAWSOAP_saveResultSet_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}saveResultSet
// Wrapped operation.
// parameter segmentPath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter treeNodePath
// - Object constructor is SAWSOAP_TreeNodePath
// parameter savedSegmentPath
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter segmentationOptions
// - Object constructor is SAWSOAP_SegmentationOptions
// parameter SRCustomLabel
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter appendStaticSegment
// - simple type {http://www.w3.org/2001/XMLSchema}boolean// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_saveResultSet_op(successCallback, errorCallback, segmentPath, treeNodePath, savedSegmentPath, segmentationOptions, SRCustomLabel, appendStaticSegment, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(7);
    args[0] = segmentPath;
    args[1] = treeNodePath;
    args[2] = savedSegmentPath;
    args[3] = segmentationOptions;
    args[4] = SRCustomLabel;
    args[5] = appendStaticSegment;
    args[6] = sessionID;
    xml = this.saveResultSetIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.saveResultSet_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.saveResultSet_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#saveResultSet';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_JobManagementServiceSoap.prototype.saveResultSet = SAWSOAP_saveResultSet_op;

function SAWSOAP_saveResultSetIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_saveResultSet();
    wrapperObj.setSegmentPath(args[0]);
    wrapperObj.setTreeNodePath(args[1]);
    wrapperObj.setSavedSegmentPath(args[2]);
    wrapperObj.setSegmentationOptions(args[3]);
    wrapperObj.setSRCustomLabel(args[4]);
    wrapperObj.setAppendStaticSegment(args[5]);
    wrapperObj.setSessionID(args[6]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:saveResultSet', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_JobManagementServiceSoap.prototype.saveResultSetIn_serializeInput = SAWSOAP_saveResultSetIn_serializeInput;

function SAWSOAP_saveResultSetOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_saveResultSetResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_getJobInfo_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_getJobInfoOut_deserializeResponse');
     responseObject = SAWSOAP_getJobInfoOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_JobManagementServiceSoap.prototype.getJobInfo_onsuccess = SAWSOAP_getJobInfo_op_onsuccess;

function SAWSOAP_getJobInfo_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_JobManagementServiceSoap.prototype.getJobInfo_onerror = SAWSOAP_getJobInfo_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getJobInfo
// Wrapped operation.
// parameter jobID
// - simple type {http://www.w3.org/2001/XMLSchema}integer// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getJobInfo_op(successCallback, errorCallback, jobID, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = jobID;
    args[1] = sessionID;
    xml = this.getJobInfoIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.getJobInfo_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.getJobInfo_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#getJobInfo';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_JobManagementServiceSoap.prototype.getJobInfo = SAWSOAP_getJobInfo_op;

function SAWSOAP_getJobInfoIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_getJobInfo();
    wrapperObj.setJobID(args[0]);
    wrapperObj.setSessionID(args[1]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getJobInfo', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_JobManagementServiceSoap.prototype.getJobInfoIn_serializeInput = SAWSOAP_getJobInfoIn_serializeInput;

function SAWSOAP_getJobInfoOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_getJobInfoResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_JobManagementServiceSoap_SAWSOAP_JobManagementServiceSoap () {
  this.url = 'http://166.78.244.8:9522/analytics/saw.dll?SoapImpl=jobManagementService';
}
SAWSOAP_JobManagementServiceSoap_SAWSOAP_JobManagementServiceSoap.prototype = new SAWSOAP_JobManagementServiceSoap;
