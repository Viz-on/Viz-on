...
//
// Definitions for service: {urn://oracle.bi.webservices/v6}MetadataService
//

// Javascript for {urn://oracle.bi.webservices/v6}MetadataServiceSoap

function SAWSOAP_MetadataServiceSoap () {
...
function SAWSOAP_describeSubjectArea_op_onsuccess(client, responseXml) {
	////////////////////////////////////////////////////////////////////////
	var xmlDoc;
    ...
    if (client.user_onsuccess) {
     ...
     this.jsutils.trace('calling SAWSOAP_describeSubjectAreaOut_deserializeResponse');
     responseObject = SAWSOAP_describeSubjectAreaOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_MetadataServiceSoap.prototype.describeSubjectArea_onsuccess = SAWSOAP_describeSubjectArea_op_onsuccess;

function SAWSOAP_describeSubjectArea_op_onerror(client) {
...
SAWSOAP_MetadataServiceSoap.prototype.describeSubjectArea_onerror = SAWSOAP_describeSubjectArea_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}describeSubjectArea
// Wrapped operation.
// parameter subjectAreaName
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter detailsLevel
// - simple type {urn://oracle.bi.webservices/v6}SASubjectAreaDetails// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_describeSubjectArea_op(successCallback, errorCallback, subjectAreaName, detailsLevel, sessionID) {
    //document.write("<br>describeSubjectArea function called<br>");
	this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(3);
    args[0] = subjectAreaName;
    args[1] = detailsLevel;
    args[2] = sessionID;
    xml = this.describeSubjectAreaIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.describeSubjectArea_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.describeSubjectArea_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#describeSubjectArea';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_MetadataServiceSoap.prototype.describeSubjectArea = SAWSOAP_describeSubjectArea_op;

function SAWSOAP_describeSubjectAreaIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_describeSubjectArea();
    wrapperObj.setSubjectAreaName(args[0]);
    wrapperObj.setDetailsLevel(args[1]);
    wrapperObj.setSessionID(args[2]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:describeSubjectArea', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_MetadataServiceSoap.prototype.describeSubjectAreaIn_serializeInput = SAWSOAP_describeSubjectAreaIn_serializeInput;

function SAWSOAP_describeSubjectAreaOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_describeSubjectAreaResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_clearQueryCache_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_clearQueryCacheOut_deserializeResponse');
     responseObject = SAWSOAP_clearQueryCacheOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_MetadataServiceSoap.prototype.clearQueryCache_onsuccess = SAWSOAP_clearQueryCache_op_onsuccess;

function SAWSOAP_clearQueryCache_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_MetadataServiceSoap.prototype.clearQueryCache_onerror = SAWSOAP_clearQueryCache_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}clearQueryCache
// Wrapped operation.
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_clearQueryCache_op(successCallback, errorCallback, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(1);
    args[0] = sessionID;
    xml = this.clearQueryCacheIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.clearQueryCache_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.clearQueryCache_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#clearQueryCache';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_MetadataServiceSoap.prototype.clearQueryCache = SAWSOAP_clearQueryCache_op;

function SAWSOAP_clearQueryCacheIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_clearQueryCache();
    wrapperObj.setSessionID(args[0]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:clearQueryCache', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_MetadataServiceSoap.prototype.clearQueryCacheIn_serializeInput = SAWSOAP_clearQueryCacheIn_serializeInput;

function SAWSOAP_clearQueryCacheOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_clearQueryCacheResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_getSubjectAreas_op_onsuccess(client, responseXml) {
	var xmlDoc;
    ...
    if (client.user_onsuccess) {
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_getSubjectAreasOut_deserializeResponse');
     responseObject = SAWSOAP_getSubjectAreasOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_MetadataServiceSoap.prototype.getSubjectAreas_onsuccess = SAWSOAP_getSubjectAreas_op_onsuccess;

function SAWSOAP_getSubjectAreas_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_MetadataServiceSoap.prototype.getSubjectAreas_onerror = SAWSOAP_getSubjectAreas_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getSubjectAreas
// Wrapped operation.
// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getSubjectAreas_op(successCallback, errorCallback, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(1);
    args[0] = sessionID;
    xml = this.getSubjectAreasIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.getSubjectAreas_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.getSubjectAreas_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#getSubjectAreas';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_MetadataServiceSoap.prototype.getSubjectAreas = SAWSOAP_getSubjectAreas_op;

function SAWSOAP_getSubjectAreasIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_getSubjectAreas();
    wrapperObj.setSessionID(args[0]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getSubjectAreas', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_MetadataServiceSoap.prototype.getSubjectAreasIn_serializeInput = SAWSOAP_getSubjectAreasIn_serializeInput;

function SAWSOAP_getSubjectAreasOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_getSubjectAreasResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_describeTable_op_onsuccess(client, responseXml) {
	var xmlDoc;
	if (window.DOMParser) {
		xmlDoc = (new window.DOMParser()).parseFromString(responseXml,
				"text/xml");
	...
	if (client.user_onsuccess) {
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_describeTableOut_deserializeResponse');
     responseObject = SAWSOAP_describeTableOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_MetadataServiceSoap.prototype.describeTable_onsuccess = SAWSOAP_describeTable_op_onsuccess;

function SAWSOAP_describeTable_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_MetadataServiceSoap.prototype.describeTable_onerror = SAWSOAP_describeTable_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}describeTable
// Wrapped operation.
// parameter subjectAreaName
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter tableName
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter detailsLevel
// - simple type {urn://oracle.bi.webservices/v6}SATableDetails// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_describeTable_op(successCallback, errorCallback, subjectAreaName, tableName, detailsLevel, sessionID) {
	//document.write("<br>describeTable function called<br>");
   this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    ...
    args[2] = detailsLevel;
    args[3] = sessionID;
    xml = this.describeTableIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.describeTable_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.describeTable_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#describeTable';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_MetadataServiceSoap.prototype.describeTable = SAWSOAP_describeTable_op;

function SAWSOAP_describeTableIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_describeTable();
    wrapperObj.setSubjectAreaName(args[0]);
    wrapperObj.setTableName(args[1]);
    wrapperObj.setDetailsLevel(args[2]);
    wrapperObj.setSessionID(args[3]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:describeTable', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_MetadataServiceSoap.prototype.describeTableIn_serializeInput = SAWSOAP_describeTableIn_serializeInput;

function SAWSOAP_describeTableOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_describeTableResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_describeColumn_op_onsuccess(client, responseXml) {
	var xmlDoc;
	if (window.DOMParser) {
		xmlDoc = (new window.DOMParser()).parseFromString(responseXml,
				"text/xml");
    ...
    if (client.user_onsuccess) {
     ...
     responseObject = SAWSOAP_describeColumnOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
	 }
    }
}

SAWSOAP_MetadataServiceSoap.prototype.describeColumn_onsuccess = SAWSOAP_describeColumn_op_onsuccess;

function SAWSOAP_describeColumn_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_MetadataServiceSoap.prototype.describeColumn_onerror = SAWSOAP_describeColumn_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}describeColumn
// Wrapped operation.
// parameter subjectAreaName
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter tableName
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter columnName
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_describeColumn_op(successCallback, errorCallback, subjectAreaName, tableName, columnName, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(4);
    args[0] = subjectAreaName;
    ...
    args[2] = columnName;
    args[3] = sessionID;
    xml = this.describeColumnIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.describeColumn_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.describeColumn_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#describeColumn';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_MetadataServiceSoap.prototype.describeColumn = SAWSOAP_describeColumn_op;

function SAWSOAP_describeColumnIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_describeColumn();
    wrapperObj.setSubjectAreaName(args[0]);
    wrapperObj.setTableName(args[1]);
    wrapperObj.setColumnName(args[2]);
    wrapperObj.setSessionID(args[3]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:describeColumn', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_MetadataServiceSoap.prototype.describeColumnIn_serializeInput = SAWSOAP_describeColumnIn_serializeInput;

function SAWSOAP_describeColumnOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_describeColumnResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_MetadataServiceSoap_SAWSOAP_MetadataServiceSoap () {
  this.url = 'http://166.78.244.8:9522/analytics/saw.dll?SoapImpl=metadataService';
}
SAWSOAP_MetadataServiceSoap_SAWSOAP_MetadataServiceSoap.prototype = new SAWSOAP_MetadataServiceSoap;
