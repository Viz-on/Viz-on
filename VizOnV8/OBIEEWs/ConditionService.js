...
//
// Definitions for service: {urn://oracle.bi.webservices/v6}ConditionService
//

// Javascript for {urn://oracle.bi.webservices/v6}ConditionServiceSoap

function SAWSOAP_ConditionServiceSoap () {
...
function SAWSOAP_getConditionCustomizableReportElements_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     ...
     this.jsutils.trace('calling SAWSOAP_getConditionCustomizableReportElementsOut_deserializeResponse');
     responseObject = SAWSOAP_getConditionCustomizableReportElementsOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_ConditionServiceSoap.prototype.getConditionCustomizableReportElements_onsuccess = SAWSOAP_getConditionCustomizableReportElements_op_onsuccess;

function SAWSOAP_getConditionCustomizableReportElements_op_onerror(client) {
...
SAWSOAP_ConditionServiceSoap.prototype.getConditionCustomizableReportElements_onerror = SAWSOAP_getConditionCustomizableReportElements_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}getConditionCustomizableReportElements
// Wrapped operation.
// parameter path
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_getConditionCustomizableReportElements_op(successCallback, errorCallback, path, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(2);
    args[0] = path;
    args[1] = sessionID;
    xml = this.getConditionCustomizableReportElementsIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.getConditionCustomizableReportElements_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.getConditionCustomizableReportElements_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#getConditionCustomizableReportElements';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_ConditionServiceSoap.prototype.getConditionCustomizableReportElements = SAWSOAP_getConditionCustomizableReportElements_op;

function SAWSOAP_getConditionCustomizableReportElementsIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_getConditionCustomizableReportElements();
    ...
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:getConditionCustomizableReportElements', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_ConditionServiceSoap.prototype.getConditionCustomizableReportElementsIn_serializeInput = SAWSOAP_getConditionCustomizableReportElementsIn_serializeInput;

function SAWSOAP_getConditionCustomizableReportElementsOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_getConditionCustomizableReportElementsResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_evaluateCondition_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_evaluateConditionOut_deserializeResponse');
     responseObject = SAWSOAP_evaluateConditionOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_ConditionServiceSoap.prototype.evaluateCondition_onsuccess = SAWSOAP_evaluateCondition_op_onsuccess;

function SAWSOAP_evaluateCondition_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_ConditionServiceSoap.prototype.evaluateCondition_onerror = SAWSOAP_evaluateCondition_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}evaluateCondition
// Wrapped operation.
// parameter path
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter reportCustomizationParameters
// - array
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_evaluateCondition_op(successCallback, errorCallback, path, reportCustomizationParameters, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(3);
    args[0] = path;
    args[1] = reportCustomizationParameters;
    args[2] = sessionID;
    xml = this.evaluateConditionIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.evaluateCondition_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.evaluateCondition_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#evaluateCondition';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_ConditionServiceSoap.prototype.evaluateCondition = SAWSOAP_evaluateCondition_op;

function SAWSOAP_evaluateConditionIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_evaluateCondition();
    wrapperObj.setPath(args[0]);
    wrapperObj.setReportCustomizationParameters(args[1]);
    wrapperObj.setSessionID(args[2]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:evaluateCondition', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_ConditionServiceSoap.prototype.evaluateConditionIn_serializeInput = SAWSOAP_evaluateConditionIn_serializeInput;

function SAWSOAP_evaluateConditionOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_evaluateConditionResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_evaluateInlineCondition_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     var responseObject = null;
     var element = responseXml.documentElement;
     this.jsutils.trace('responseXml: ' + this.jsutils.traceElementName(element));
     ...
     element = this.jsutils.getFirstElementChild(element);
     this.jsutils.trace('part element: ' + this.jsutils.traceElementName(element));
     this.jsutils.trace('calling SAWSOAP_evaluateInlineConditionOut_deserializeResponse');
     responseObject = SAWSOAP_evaluateInlineConditionOut_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

SAWSOAP_ConditionServiceSoap.prototype.evaluateInlineCondition_onsuccess = SAWSOAP_evaluateInlineCondition_op_onsuccess;

function SAWSOAP_evaluateInlineCondition_op_onerror(client) {
    if (client.user_onerror) {
     var httpStatus;
     var httpStatusText;
     try {
...
SAWSOAP_ConditionServiceSoap.prototype.evaluateInlineCondition_onerror = SAWSOAP_evaluateInlineCondition_op_onerror;

//
// Operation {urn://oracle.bi.webservices/v6}evaluateInlineCondition
// Wrapped operation.
// parameter conditionXML
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter reportCustomizationParameters
// - array
// - simple type {http://www.w3.org/2001/XMLSchema}string// parameter sessionID
// - simple type {http://www.w3.org/2001/XMLSchema}string//
function SAWSOAP_evaluateInlineCondition_op(successCallback, errorCallback, conditionXML, reportCustomizationParameters, sessionID) {
    this.client = new CxfApacheOrgClient(this.jsutils);
    var xml = null;
    var args = new Array(3);
    args[0] = conditionXML;
    args[1] = reportCustomizationParameters;
    args[2] = sessionID;
    xml = this.evaluateInlineConditionIn_serializeInput(this.jsutils, args);
    this.client.user_onsuccess = successCallback;
    this.client.user_onerror = errorCallback;
    var closureThis = this;
    this.client.onsuccess = function(client, responseXml) { closureThis.evaluateInlineCondition_onsuccess(client, responseXml); };
    this.client.onerror = function(client) { closureThis.evaluateInlineCondition_onerror(client); };
    var requestHeaders = [];
    requestHeaders['SOAPAction'] = '#evaluateInlineCondition';
    this.jsutils.trace('synchronous = ' + this.synchronous);
    this.client.request(this.url, xml, null, this.synchronous, requestHeaders);
}

SAWSOAP_ConditionServiceSoap.prototype.evaluateInlineCondition = SAWSOAP_evaluateInlineCondition_op;

function SAWSOAP_evaluateInlineConditionIn_serializeInput(cxfjsutils, args) {
    var wrapperObj = new SAWSOAP_evaluateInlineCondition();
    wrapperObj.setConditionXML(args[0]);
    wrapperObj.setReportCustomizationParameters(args[1]);
    wrapperObj.setSessionID(args[2]);
    var xml;
    xml = cxfjsutils.beginSoap11Message("xmlns:jns0='urn://oracle.bi.webservices/v6' ");
    // block for local variables
    {
     xml = xml + wrapperObj.serialize(cxfjsutils, 'jns0:evaluateInlineCondition', null);
    }
    xml = xml + cxfjsutils.endSoap11Message();
    return xml;
}

SAWSOAP_ConditionServiceSoap.prototype.evaluateInlineConditionIn_serializeInput = SAWSOAP_evaluateInlineConditionIn_serializeInput;

function SAWSOAP_evaluateInlineConditionOut_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = SAWSOAP_evaluateInlineConditionResult_deserialize (cxfjsutils, partElement);

    return returnObject;
}
function SAWSOAP_ConditionServiceSoap_SAWSOAP_ConditionServiceSoap () {
  this.url = 'http://166.78.244.8:9522/analytics/saw.dll?SoapImpl=conditionService';
}
SAWSOAP_ConditionServiceSoap_SAWSOAP_ConditionServiceSoap.prototype = new SAWSOAP_ConditionServiceSoap;
